...
## Abbreviation: DR  |  Version: 1.0  |  Date: 2026-06-24
##
## Tab Structure (8 Tabs):
##  1. Patient Profile        — Patient characteristics input and risk visualization
##  2. Drug PK                — Intravitreal drug pharmacokinetics (vitreous concentration)
##  3. VEGF / Angiogenesis    — Free VEGF and neovascularization dynamics
##  4. Inflammation & Oxidative Stress — CYT/ROS/AGE
##  5. Retinal Structural     — CRT (OCT thickness) / permeability
##  6. Visual Outcomes        — BCVA (ETDRS letter count), VA change
##  7. Scenario Comparison    — Comparison of 6 treatment scenarios
##  8. Biomarkers & About
## ============================================================
