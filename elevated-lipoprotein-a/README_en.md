...
| File | Contents |
|---|---|
| [`lpa_qsp_model.dot`](lpa_qsp_model.dot) · [`.svg`](lpa_qsp_model.svg) · [`.png`](lpa_qsp_model.png) | mechanistic map — **152 nodes · 17 clusters · 210 edges** |
| [`lpa_mrgsolve_model_en.R`](lpa_mrgsolve_model_en.R) | **50 ODEs** · 20 scenarios · 4 analysis runs · calibration notes |
| [`lpa_shiny_app_en.R`](lpa_shiny_app_en.R) | **10-tab** interactive dashboard |
| [`lpa_references_en.md`](lpa_references_en.md) | **112** PubMed citations · equation-to-literature mapping table |
...
Rscript lpa_mrgsolve_model_en.R

# dashboard
shiny::runApp("lpa_shiny_app_en.R")
