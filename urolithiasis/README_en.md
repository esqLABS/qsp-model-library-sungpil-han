...
| File | Description |
|------|------|
| [uri_qsp_model.dot](uri_qsp_model.dot) | Graphviz mechanistic map source (approximately 431 nodes / 10 clusters) |
| [uri_qsp_model.svg](uri_qsp_model.svg) | SVG vector image (scalable) |
| [uri_qsp_model.png](uri_qsp_model.png) | PNG image (150 dpi) |
| [uri_mrgsolve_model.R](uri_mrgsolve_model.R) | mrgsolve ODE model (approximately 19 compartments / 6 treatment scenarios) |
| [uri_shiny_app.R](uri_shiny_app.R) | Shiny dashboard |
| [uri_references.md](uri_references.md) | References (approximately 38 articles, PubMed links) |
...
For detailed citations, see [uri_references.md](uri_references.md) (approximately 38 articles).
