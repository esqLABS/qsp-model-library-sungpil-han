...
| Deliverable | File |
|--------|------|
| Mechanistic map | [`pda_qsp_model.dot`](pda_qsp_model.dot) · [SVG](pda_qsp_model.svg) · [PNG](pda_qsp_model.png) |
| mrgsolve model | [`pda_mrgsolve_model.R`](pda_mrgsolve_model.R) |
| Python reference implementation | [`pda_reference_model.py`](pda_reference_model.py) |
| Shiny dashboard | [`pda_shiny_app_en.R`](pda_shiny_app_en.R) |
| References | [`pda_references_en.md`](pda_references_en.md) |
...
Rscript -e 'shiny::runApp("pda_shiny_app_en.R")'
```
