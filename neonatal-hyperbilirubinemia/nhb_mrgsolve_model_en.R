...
#  ---------------------------------------------------------------------------
#  Neonatal hyperbilirubinaemia (neonatal jaundice) QSP model · mrgsolve · 34 ODEs
#
#  ===========================================================================
...
#  Every quantitative claim in this header and in README_en.md is from that file.
