...
| File | Contents |
|------|------|
| [`nhb_qsp_model_en.dot`](nhb_qsp_model_en.dot) | Mechanistic map source (15 clusters · 137 nodes · 179 edges) |
| [`nhb_qsp_model_en.svg`](nhb_qsp_model_en.svg) · [`nhb_qsp_model_en.png`](nhb_qsp_model_en.png) | Rendered map |
| [`nhb_mrgsolve_model_en.R`](nhb_mrgsolve_model_en.R) | mrgsolve 34-ODE model + 10 scenarios + 8 analysis functions |
| [`nhb_shiny_app_en.R`](nhb_shiny_app_en.R) | 11-tab interactive dashboard |
| [`nhb_reference_check.py`](nhb_reference_check.py) | **Independent implementation** (pure python RK4). The source of every number here |
| [`nhb_reference_output.txt`](nhb_reference_output.txt) | Run output of the file above (A1-A14) |
| [`nhb_references_en.md`](nhb_references_en.md) | 97 references (all bibliographically verified through the PubMed API) |

```bash
dot -Tsvg nhb_qsp_model_en.dot -o nhb_qsp_model_en.svg
dot -Tpng -Gdpi=150 nhb_qsp_model_en.dot -o nhb_qsp_model_en.png
python3 nhb_reference_check.py > nhb_reference_output.txt   # ~100 s
Rscript -e 'shiny::runApp("nhb_shiny_app_en.R")'
```
