...
| File | Description |
|------|------|
| [aps_qsp_model.dot](aps_qsp_model.dot) | Graphviz mechanistic map source (approximately 186 nodes / 13 clusters) |
| [aps_qsp_model.svg](aps_qsp_model.svg) | SVG vector image (scalable) |
| [aps_qsp_model.png](aps_qsp_model.png) | PNG image (150 dpi) |
| [aps_mrgsolve_model.R](aps_mrgsolve_model.R) | mrgsolve ODE model (approximately 22 compartments / multiple treatment scenarios) |
| [aps_shiny_app.R](aps_shiny_app.R) | Shiny dashboard |
| [aps_references.md](aps_references.md) | References (approximately 58 articles, PubMed links) |
...
For detailed citations, see [aps_references.md](aps_references.md) (approximately 58 articles).
