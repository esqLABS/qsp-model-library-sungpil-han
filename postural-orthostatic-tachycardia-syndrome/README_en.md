# Postural Orthostatic Tachycardia Syndrome (POTS) — QSP Model
...
| Deliverable | File |
|---|---|
| 🗺️ Mechanistic map (DOT) | [`pots_qsp_model_en.dot`](pots_qsp_model_en.dot) |
| 🖼️ Map (SVG)             | [`pots_qsp_model_en.svg`](pots_qsp_model_en.svg) |
| 🖼️ Map (PNG, 150 dpi)    | [`pots_qsp_model_en.png`](pots_qsp_model_en.png) |
| ⚙️ mrgsolve ODE model     | [`pots_mrgsolve_model_en.R`](pots_mrgsolve_model_en.R) |
...
dot -Tsvg pots_qsp_model_en.dot -o pots_qsp_model_en.svg
dot -Tpng -Gdpi=150 pots_qsp_model_en.dot -o pots_qsp_model_en.png
```
...
install.packages(c("mrgsolve","dplyr","tidyr","ggplot2","shiny",
                   "shinydashboard","DT"))
library(mrgsolve)
mod <- mread_cache("pots_mrgsolve_model_en.R")
