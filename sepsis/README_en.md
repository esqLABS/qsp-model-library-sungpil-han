...
|---------|------|-----|
| 🗺️ Mechanistic map | [`sep_qsp_model.dot`](sep_qsp_model.dot) / [`.svg`](sep_qsp_model.svg) / [`.png`](sep_qsp_model.png) | **130+ nodes, 11 clusters** |
| ⚙️ mrgsolve ODE model | [`sep_mrgsolve_model.R`](sep_mrgsolve_model.R) | **24-compartment ODE**, **7 treatment scenarios** |
| 📊 Shiny dashboard | [`sep_shiny_app.R`](sep_shiny_app.R) | **8 tabs** (patient profile · antibiotic PK · cytokine/immune · haemodynamics/SOFA · organ function · scenario comparison · biomarkers · About) |
| 📚 References | [`sep_references.md`](sep_references.md) | **55 PubMed citations** (14 sections) |
