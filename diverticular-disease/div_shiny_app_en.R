## =============================================================================
## Diverticular Disease QSP Shiny Dashboard
## =============================================================================
## Tabs:
##   1. Patient Profile & Risk Assessment
##   2. Pharmacokinetics – Drug Concentration (PK)
##   3. PD / Biomarkers – Inflammation & Microbiome
##   4. Clinical Endpoints – Disease Progression
##   5. Scenario Comparison
##   6. Microbiome & Barrier Health
## =============================================================================
...
ui <- fluidPage(
  titlePanel(
    div(
      h2("Diverticular Disease QSP Dashboard",
