## =============================================================================
## Diverticular Disease QSP Model — mrgsolve ODE Implementation
## =============================================================================
...
div_model_code <- '
$PROB Diverticular Disease QSP Model v1.0
...
combined_plot <- (p1 + p2) / (p3 + p4) / (p5 + p6) +
  plot_annotation(
    ...
    subtitle = "Diverticular disease quantitative systems pharmacology model simulation",
