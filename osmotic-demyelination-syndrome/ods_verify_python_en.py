...
#  number quoted in README_en.md / the .dot map / the references file.
#
#  Osmotic demyelination syndrome — independent re-implementation and verification of the mrgsolve model
# ---------------------------------------------------------------------
#  STRUCTURAL THESIS
#  -----------------
...
#    quoted in README_en.md, the .dot map and the mrgsolve header comes from
