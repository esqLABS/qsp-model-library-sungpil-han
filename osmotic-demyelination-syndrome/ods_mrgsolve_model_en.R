...
##
##  Osmotic demyelination syndrome — quantitative systems pharmacology model
## ---------------------------------------------------------------------
##  STRUCTURAL THESIS
##  -----------------
...
##      (ods_verify_python_en.py) and integrated; that file is the source of
...
$ODE
// =====================================================================
//  ALGEBRAIC LAYER  (identical to algebra() in ods_verify_python_en.py)
// =====================================================================
...
##  Interactive exploration: ods_shiny_app_en.R
## =====================================================================
