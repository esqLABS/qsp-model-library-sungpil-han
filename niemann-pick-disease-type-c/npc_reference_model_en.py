...
Niemann-Pick disease type C · Python reference implementation (the numerical twin of the mrgsolve model)
================================================================================

WHY THIS FILE EXISTS
--------------------
`npc_mrgsolve_model_en.R` is the deliverable; this file is its independently
written twin.  Every parameter, every right-hand side and every derived output
is duplicated here so that (a) the numbers quoted in README_en.md are produced by
...
def main():
    ...
    print("   (section 14).  None of them was tuned away; see README_en.md section 7.")
    print("\nDone.\n")
