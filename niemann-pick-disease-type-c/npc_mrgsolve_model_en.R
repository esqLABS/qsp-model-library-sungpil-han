...
##
##  Twin implementation:  npc_reference_model_en.py  (independently written; every
##  shared parameter and right-hand side agrees.  Any number quoted in README_en.md
...
- Reference twin: npc_reference_model_en.py
...
## ---------------------------------------------------------------------------
## Model vs published targets.  See npc_references_en.md for the full target list;
