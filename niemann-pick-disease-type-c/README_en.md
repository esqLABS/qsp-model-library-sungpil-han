...
<a href="npc_qsp_model_en.svg"><img src="npc_qsp_model_en.png" width="820" alt="NPC QSP mechanistic map"></a>
...
| File | Contents |
|------|------|
| [`npc_qsp_model_en.dot`](npc_qsp_model_en.dot) · [`.svg`](npc_qsp_model_en.svg) · [`.png`](npc_qsp_model_en.png) | 198 nodes · 287 edges · 21 mechanism clusters + legend |
| [`npc_mrgsolve_model_en.R`](npc_mrgsolve_model_en.R) | 41-ODE mrgsolve model, 148 annotated parameters, 6 genotypes · 6 age forms · 18 scenarios · design-experiment functions |
| [`npc_reference_model_en.py`](npc_reference_model_en.py) | Independently written Python twin. Prints every number in this README (`python3 npc_reference_model_en.py`) |
| [`npc_shiny_app_en.R`](npc_shiny_app_en.R) | 9-tab dashboard (patient · PK · lysosome · reserve · endpoints · scenarios · biomarkers · design experiments · calibration comparison) |
| [`npc_references_en.md`](npc_references_en.md) | 13 sections, 144 references, every PMID individually looked up and confirmed |
...
Of the 15 targets in `npc_references_en.md`, **only 7 were used for calibration**; the rest are
validation only.
...
# mrgsolve
library(mrgsolve)
mod <- mread("npc_mrgsolve_model_en.R")
...
# Shiny
shiny::runApp("npc_shiny_app_en.R")
```

```bash
# the Python reference implementation — prints every number in this README
python3 npc_reference_model_en.py
python3 npc_reference_model_en.py --quick        # coarse dt, about 4× faster
python3 npc_reference_model_en.py --emit-param   # dump the mrgsolve $PARAM values
```
...
[`npc_references_en.md`](npc_references_en.md).
