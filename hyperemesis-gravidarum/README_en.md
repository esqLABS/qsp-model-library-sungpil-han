...
| File | Contents |
|------|------|
| [`hg_qsp_model.dot`](hg_qsp_model.dot) | Source of the mechanistic map — **214 nodes · 19 clusters · 165 edges** |
| [`hg_qsp_model.svg`](hg_qsp_model.svg) | Vector render (6583 × 4148 pt) |
| [`hg_qsp_model.png`](hg_qsp_model.png) | Raster render (150 dpi, 13714 × 8642 px) |
| [`hg_mrgsolve_model.R`](hg_mrgsolve_model.R) | mrgsolve model — **42 ODE compartments · 182 parameters · 16 scenarios** |
| [`hg_reference_impl.py`](hg_reference_impl.py) | A pure-Python RK4 twin of the same ODE system + the validation table |
| [`hg_shiny_app.R`](hg_shiny_app.R) | Shiny dashboard — **12 tabs** |
| [`hg_references_en.md`](hg_references_en.md) | **77** PMID-verified references, with the grounds mapped for each parameter |
