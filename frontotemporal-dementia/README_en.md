...
| File | Contents |
|---|---|
| [`ftd_qsp_model.dot`](ftd_qsp_model.dot) | Mechanistic map source — **215 nodes · 313 edges · 14 clusters** |
| [`ftd_qsp_model.svg`](ftd_qsp_model.svg) | Vector rendering (zoom in to read) |
| [`ftd_qsp_model.png`](ftd_qsp_model.png) | Raster rendering (9706 × 5965) |
| [`ftd_mrgsolve_model.R`](ftd_mrgsolve_model.R) | **49-ODE** mrgsolve model + 13 scenarios + p-sensitivity analysis |
| [`ftd_reference_model.py`](ftd_reference_model.py) | Dependency-free RK4 reference implementation (same 49 states) — for validation |
| [`ftd_model_report.txt`](ftd_model_report.txt) | The **computed** output of the Python implementation above (the source of every figure below) |
| [`ftd_shiny_app.R`](ftd_shiny_app.R) | 9-tab interactive dashboard |
| [`ftd_references.md`](ftd_references.md) | 66 literature links — PMIDs clearly separated into **verified (✅ 44)** / **unverified (🔍 26)** |
