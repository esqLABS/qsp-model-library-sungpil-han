...
| File | Description |
|------|------|
| [rpc_qsp_model.dot](rpc_qsp_model.dot) | Graphviz mechanistic map source (approximately 100+ nodes / 10 clusters) |
| [rpc_qsp_model.svg](rpc_qsp_model.svg) | SVG vector image (scalable) |
| [rpc_qsp_model.png](rpc_qsp_model.png) | PNG image (150 dpi) |
| [rpc_mrgsolve_model.R](rpc_mrgsolve_model.R) | mrgsolve ODE model (approximately 21 compartments / approximately 41 scenarios) |
| [rpc_shiny_app.R](rpc_shiny_app.R) | Shiny dashboard |
| [rpc_references.md](rpc_references.md) | References (approximately 63 articles, PubMed links) |
...
For detailed citations, see [rpc_references.md](rpc_references.md) (approximately 63 articles).
