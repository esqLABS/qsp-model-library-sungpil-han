...
| File | Description |
|------|------|
| [cf_qsp_model.dot](cf_qsp_model.dot) | Graphviz mechanistic map (165 nodes, 12 clusters) |
| [cf_qsp_model.svg](cf_qsp_model.svg) | SVG vector image |
| [cf_qsp_model.png](cf_qsp_model.png) | PNG 150 dpi |
| [cf_mrgsolve_model.R](cf_mrgsolve_model.R) | mrgsolve ODE model (25 compartments, 7 scenarios) |
| [cf_shiny_app.R](cf_shiny_app.R) | Shiny dashboard (6 tabs) |
| [cf_references.md](cf_references.md) | References (53 articles, PubMed links) |
