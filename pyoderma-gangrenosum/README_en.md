...
| File | Description |
|------|-------------|
| [`pg_qsp_model.dot`](pg_qsp_model.dot) | Graphviz mechanistic map source (200+ nodes, 10 clusters) |
| [`pg_qsp_model.svg`](pg_qsp_model.svg) | Scalable vector map (high-resolution) |
| [`pg_qsp_model.png`](pg_qsp_model.png) | Raster map at 150 dpi |
| [`pg_mrgsolve_model.R`](pg_mrgsolve_model.R) | 30-compartment mrgsolve QSP model; 9 treatment scenarios; virtual population helper |
| [`pg_shiny_app.R`](pg_shiny_app.R) | 7-tab interactive Shiny dashboard |
| [`pg_references.md`](pg_references.md) | 40+ PubMed-linked references organized by category |
