...
<p align="center">
  <a href="mhb_qsp_model_en.svg">
    <img src="mhb_qsp_model_en.png" width="900" alt="Methaemoglobinaemia QSP mechanistic map">
  </a><br>
  <sub><a href="mhb_qsp_model_en.svg">View full-resolution SVG</a> · 153 nodes · 209 edges · 19 clusters (18 mechanisms + 1 legend)</sub>
</p>
...
[`mhb_reference_check.py`](mhb_reference_check.py), and
the full output is in
[`mhb_reference_output.txt`](mhb_reference_output.txt).
...
| File | Contents |
|---|---|
| [`mhb_qsp_model_en.dot`](mhb_qsp_model_en.dot) · [`.svg`](mhb_qsp_model_en.svg) · [`.png`](mhb_qsp_model_en.png) | Mechanistic map — 153 nodes, 209 edges, 19 clusters |
| [`mhb_mrgsolve_model_en.R`](mhb_mrgsolve_model_en.R) | mrgsolve model — 42 ODEs, 139 parameters, 23 scenarios |
| [`mhb_shiny_app_en.R`](mhb_shiny_app_en.R) | Shiny dashboard — 13 tabs |
| [`mhb_reference_check.py`](mhb_reference_check.py) | Independent Python/scipy re-implementation and verification |
| [`mhb_reference_output.txt`](mhb_reference_output.txt) | Full output of the script above (the source of every figure in this README) |
| [`mhb_references_en.md`](mhb_references_en.md) | 171 references — every PMID actually looked up via the PubMed E-utilities |

### Reproduce

```bash
python3 mhb_reference_check.py --all                      # 42/42 anchors pass
python3 mhb_reference_check.py --params mhb_mrgsolve_model_en.R   # 139/139 parameters match
dot -Tsvg mhb_qsp_model_en.dot -o mhb_qsp_model_en.svg
dot -Tpng -Gdpi=150 mhb_qsp_model_en.dot -o mhb_qsp_model_en.png
Rscript -e 'shiny::runApp("mhb_shiny_app_en.R")'
```
