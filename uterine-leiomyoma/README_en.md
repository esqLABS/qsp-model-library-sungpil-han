...
[![Mechanistic Map](ufl_qsp_model_en.png)](ufl_qsp_model_en.svg)
...
| File | Description |
|------|------|
| `ufl_qsp_model_en.dot` | Graphviz mechanistic map source |
| `ufl_qsp_model_en.svg` | Mechanistic map SVG (vector, high resolution) |
| `ufl_qsp_model_en.png` | Mechanistic map PNG (150 dpi) |
| `ufl_mrgsolve_model_en.R` | mrgsolve ODE model + 6 treatment scenarios + visualisation |
| `ufl_shiny_app_en.R` | Shiny interactive dashboard (6 tabs) |
| `ufl_references_en.md` | 60 references (with PubMed links) |
| `README.md` | This file |
...
source("ufl_mrgsolve_model_en.R")

# Run the Shiny app
shiny::runApp("ufl_shiny_app_en.R")
```
