# Hypercalcaemia of Malignancy — References

Every PMID was looked up via the NCBI E-utilities (`esearch` → `esummary`) to confirm
the author, journal, year, and title. The italicised note after each entry records **which
structure or parameter in the model that reference supports**. Where there is no evidence, it is marked "assumption".
...
## 2. PTHrP and the humoral mechanism
...
## 4. Calcitriol-mediated mechanism
...
## 5. Ectopic PTH, parathyroid carcinoma, calcimimetics
...
## 6. Bone remodelling and the RANKL/OPG axis
...
## 7. Calcium-sensing receptor and renal handling
...
## 8. Nephrogenic DI, concentrating defect, hypercalcaemic nephropathy
...
## 14. Extracorporeal therapy and other agents
...
## 16. QSP and bone-calcium modelling
...
## 17. Where the model asserts rather than cites

Recorded honestly: the items below are **modelling choices** not directly supported by the literature.
