...
<p align="center">
  ...
  <sub>140 nodes · 18 subgraph clusters · 222 edges — click the <a href="mah_qsp_model.svg">SVG</a> for a larger view</sub>
</p>
...
| File | Contents |
|---|---|
| [`mah_qsp_model.dot`](mah_qsp_model.dot) · [`.svg`](mah_qsp_model.svg) · [`.png`](mah_qsp_model.png) | Mechanistic map — 140 nodes, 18 clusters, 222 edges |
| [`mah_mrgsolve_model_en.R`](mah_mrgsolve_model_en.R) | 50-ODE mrgsolve model, 205 parameters, 23 scenarios, calibration notes A–J |
| [`mah_shiny_app_en.R`](mah_shiny_app_en.R) | 10-tab Shiny dashboard (including the ceiling curve and the bifurcation calculation) |
| [`mah_references_en.md`](mah_references_en.md) | 105 references, every PMID checked with the NCBI E-utilities |
...
separately in [`mah_references_en.md` §17](mah_references_en.md#17-where-the-model-asserts-rather-than-cites).
