...
| File | Description |
|------|------|
| [hfref_qsp_model.dot](hfref_qsp_model.dot) | Graphviz mechanistic map source (approximately 100+ nodes / 9 clusters) |
| [hfref_qsp_model.svg](hfref_qsp_model.svg) | SVG vector image (scalable) |
| [hfref_qsp_model.png](hfref_qsp_model.png) | PNG image (150 dpi) |
| [hfref_mrgsolve_model.R](hfref_mrgsolve_model.R) | mrgsolve ODE model (approximately 26 compartments / 5 treatment scenarios + dose-response analysis) |
| [hfref_shiny_app.R](hfref_shiny_app.R) | Shiny dashboard |
| [hfref_references.md](hfref_references.md) | References (approximately 62 articles, PubMed links) |
...
For detailed citations, see [hfref_references.md](hfref_references.md) (approximately 62 articles).
