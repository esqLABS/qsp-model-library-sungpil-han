...
<a href="g6pd_qsp_model_en.svg"><img src="g6pd_qsp_model_en.png" width="820" alt="G6PD QSP mechanistic map"></a>
...
`g6pd_mrgsolve_model_en.R` (mrgsolve) and `g6pd_reference_check.py` (pure Python, an
...
| File | Contents |
|---|---|
| [`g6pd_qsp_model_en.dot`](g6pd_qsp_model_en.dot) | Source of the mechanistic map — **176 mechanistic nodes · 234 edges · 17 clusters** (plus 64 invisible layout-only edges) |
| [`g6pd_qsp_model_en.svg`](g6pd_qsp_model_en.svg) / [`.png`](g6pd_qsp_model_en.png) | The renders (`dot -Tsvg` / `dot -Tpng -Gdpi=150`) |
| [`g6pd_mrgsolve_model_en.R`](g6pd_mrgsolve_model_en.R) | **48-ODE** mrgsolve model + variant/patient generators + **22 scenarios** |
| [`g6pd_reference_check.py`](g6pd_reference_check.py) | An independent re-implementation (pure-Python RK4). Cross-validates the numbers above |
| [`g6pd_reference_output.txt`](g6pd_reference_output.txt) | The output of that run, verbatim |
| [`g6pd_shiny_app_en.R`](g6pd_shiny_app_en.R) | 8-tab interactive dashboard |
| [`g6pd_references_en.md`](g6pd_references_en.md) | **77 references**, 15 sections, PubMed links |

### Running it

```bash
# redraw the mechanistic map
dot -Tsvg g6pd_qsp_model_en.dot -o g6pd_qsp_model_en.svg
dot -Tpng -Gdpi=150 g6pd_qsp_model_en.dot -o g6pd_qsp_model_en.png

# the 22 scenarios (R + mrgsolve)
Rscript -e 'source("g6pd_mrgsolve_model_en.R"); print(g6pd_age_table()); print(g6pd_all()$summary)'
...
Rscript -e 'shiny::runApp("g6pd_shiny_app_en.R")'
```
...
For the supporting literature see [`g6pd_references_en.md`](g6pd_references_en.md) (77 references, PubMed links).
