...
##  Glucose-6-phosphate dehydrogenase deficiency · QSP / PK-PD model for mrgsolve
##
##  48 ODE compartments:
...
##    central values (see g6pd_references_en.md) but the model as a whole has
...
##  Morelli 1978, Luzzatto & Arese 2018 review. See g6pd_references_en.md.
