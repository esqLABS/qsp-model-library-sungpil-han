...
| File | Description |
|------|------|
| [pv_qsp_model.dot](pv_qsp_model.dot) | Graphviz mechanistic map source (approximately 159 nodes / 12 clusters) |
| [pv_qsp_model.svg](pv_qsp_model.svg) | SVG vector image (scalable) |
| [pv_qsp_model.png](pv_qsp_model.png) | PNG image (150 dpi) |
| [pv_mrgsolve_model.R](pv_mrgsolve_model.R) | mrgsolve ODE model (approximately 23 compartments / 6 treatment scenarios) |
| [pv_shiny_app.R](pv_shiny_app.R) | Shiny dashboard |
| [pv_references.md](pv_references.md) | References (approximately 40 articles, PubMed links) |
...
For detailed citations, see [pv_references.md](pv_references.md) (approximately 40 articles).
