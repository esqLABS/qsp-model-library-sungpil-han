...
> Parent library → [../README_en.md](../README_en.md) · Category: Dermatology
...
| File | Description |
|------|------|
| [aa_qsp_model.dot](aa_qsp_model.dot) | Graphviz mechanistic map source (approximately 164 nodes / 11 clusters) |
| [aa_qsp_model.svg](aa_qsp_model.svg) | SVG vector image (scalable) |
| [aa_qsp_model.png](aa_qsp_model.png) | PNG image (150 dpi) |
| [aa_mrgsolve_model_en.R](aa_mrgsolve_model_en.R) | mrgsolve ODE model (approximately 22 compartments / multiple treatment scenarios) |
| [aa_shiny_app.R](aa_shiny_app.R) | Shiny dashboard |
| [aa_references_en.md](aa_references_en.md) | References (approximately 55 articles, PubMed links) |
...
```r
library(mrgsolve)
mod <- mread("aa_mrgsolve_model_en.R")
...
For detailed citations, see [aa_references_en.md](aa_references_en.md) (approximately 55 articles).
