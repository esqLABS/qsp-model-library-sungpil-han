...
| Deliverable | File |
|--------|------|
| 🗺️ Mechanistic map | [`cvid_qsp_model_en.dot`](cvid_qsp_model_en.dot) · [SVG](cvid_qsp_model_en.svg) · [PNG](cvid_qsp_model_en.png) — 234 nodes · 20 clusters |
| ⚙️ mrgsolve model | [`cvid_mrgsolve_model_en.R`](cvid_mrgsolve_model_en.R) — 74 ODEs · 224 parameters · 30 scenarios · 34 diagnostics (34 PASS) |
| 📊 Shiny dashboard | [`cvid_shiny_app_en.R`](cvid_shiny_app_en.R) — 10 tabs |
| 📚 References | [`cvid_references_en.md`](cvid_references_en.md) — 124 PubMed citations (all confirmed by lookup through the E-utilities) |
...
dot -Tsvg cvid_qsp_model_en.dot -o cvid_qsp_model_en.svg
dot -Tpng -Gdpi=150 cvid_qsp_model_en.dot -o cvid_qsp_model_en.png

# model + 30 scenarios + 34 diagnostics (a real mrgsolve run, takes several minutes)
Rscript cvid_mrgsolve_model_en.R

# interactive dashboard (10 tabs)
Rscript -e 'shiny::runApp("cvid_shiny_app_en.R")'
```
