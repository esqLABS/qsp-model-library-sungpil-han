...
| File | Description |
|------|------|
| [`mm_qsp_model.dot`](mm_qsp_model.dot) | Graphviz mechanistic map (13 clusters, 130+ nodes) |
| [`mm_qsp_model.svg`](mm_qsp_model.svg) | SVG vector image (click to zoom) |
| [`mm_qsp_model.png`](mm_qsp_model.png) | PNG raster image (150 dpi) |
| [`mm_mrgsolve_model.R`](mm_mrgsolve_model.R) | mrgsolve ODE model (30 compartments, 6 treatment scenarios) |
| [`mm_shiny_app.R`](mm_shiny_app.R) | Shiny dashboard (6 interactive tabs) |
| [`mm_references.md`](mm_references.md) | 50 references (with PubMed links) |
