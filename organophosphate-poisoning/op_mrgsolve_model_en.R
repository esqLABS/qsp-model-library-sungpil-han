...
##  Acute deliberate organophosphorus pesticide self-poisoning — quantitative systems pharmacology model
##
...
##
##  -------------------------------------------------------------------------
##  CALIBRATION AND PROVENANCE  (full citations in op_references_en.md)
##  -------------------------------------------------------------------------
...
##  found during that exercise are listed in README_en.md under DEFECTS FOUND.
##
