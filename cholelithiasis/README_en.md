...
| File | Description |
|------|------|
| [chol_qsp_model.dot](chol_qsp_model.dot) | Graphviz mechanistic map source (approximately 431 nodes / 10 clusters) |
| [chol_qsp_model.svg](chol_qsp_model.svg) | SVG vector image (scalable) |
| [chol_qsp_model.png](chol_qsp_model.png) | PNG image (150 dpi) |
| [chol_mrgsolve_model.R](chol_mrgsolve_model.R) | mrgsolve ODE model (approximately 25 compartments / 5 treatment scenarios) |
| [chol_shiny_app.R](chol_shiny_app.R) | Shiny dashboard |
| [chol_references.md](chol_references.md) | References (approximately 46 articles, PubMed links) |
...
For detailed citations, see [chol_references.md](chol_references.md) (approximately 46 articles).
