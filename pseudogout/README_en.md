...
| File | Description |
|------|------|
| [cppd_qsp_model.dot](cppd_qsp_model.dot) | Graphviz mechanistic map source (100+ nodes / 12 clusters) |
| [cppd_qsp_model.svg](cppd_qsp_model.svg) | SVG vector image (scalable) |
| [cppd_qsp_model.png](cppd_qsp_model.png) | PNG image (150 dpi) |
| [cppd_mrgsolve_model.R](cppd_mrgsolve_model.R) | mrgsolve ODE model (approximately 21 compartments / approximately 27 scenarios) |
| [cppd_shiny_app.R](cppd_shiny_app.R) | Shiny dashboard |
| [cppd_references_en.md](cppd_references_en.md) | References (approximately 62 articles, PubMed links) |
...
For detailed citations, see [cppd_references_en.md](cppd_references_en.md) (approximately 62 articles).
