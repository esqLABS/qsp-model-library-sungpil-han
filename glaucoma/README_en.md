...
[![POAG QSP Model](poag_qsp_model_en.png)](poag_qsp_model_en.svg)
...
**File:** [`poag_mrgsolve_model.R`](poag_mrgsolve_model.R)
...
**File:** [`poag_shiny_app.R`](poag_shiny_app.R)
...
**File:** [`poag_references.md`](poag_references.md) — **66** references
...
| File | Description |
|------|------|
| `poag_qsp_model_en.dot` | Graphviz DOT — 150+ nodes, 10 subgraphs |
| `poag_qsp_model_en.svg` | Vector image (interactive) |
| `poag_qsp_model_en.png` | Raster image (150 dpi) |
