...
[![FBR QSP mechanistic map](fbr_qsp_model_en.png)](fbr_qsp_model_en.svg)
...
|--------|------|------|
| 🗺️ Mechanistic map | [`fbr_qsp_model_en.dot`](fbr_qsp_model_en.dot) · [`fbr_qsp_model_en.svg`](fbr_qsp_model_en.svg) · [`fbr_qsp_model_en.png`](fbr_qsp_model_en.png) | **138 nodes, 14 clusters** |
| ⚙️ mrgsolve ODE | [`fbr_mrgsolve_model_en.R`](fbr_mrgsolve_model_en.R) | **22-compartment ODE**, **6 treatment scenarios** |
| 📊 Shiny app | [`fbr_shiny_app_en.R`](fbr_shiny_app_en.R) | **8 tabs** (patient profile · PK/enzyme · Gb3 dynamics · renal · cardiac · scenario comparison · biomarkers · virtual population) |
| 📚 References | [`fbr_references_en.md`](fbr_references_en.md) | **60 PubMed citations** (14 sections) |
...
dot -Tsvg fbr_qsp_model_en.dot -o fbr_qsp_model_en.svg
dot -Tpng -Gdpi=150 fbr_qsp_model_en.dot -o fbr_qsp_model_en.png
```

```r
# 2. Run the mrgsolve ODE model
install.packages(c("mrgsolve", "dplyr", "ggplot2", "tidyr", "patchwork"))
source("fbr_mrgsolve_model_en.R")

# 3. Launch the Shiny dashboard
shiny::runApp("fbr_shiny_app_en.R")
```
