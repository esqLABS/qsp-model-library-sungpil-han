...
| File | Contents |
|------|------|
| [`denv_qsp_model.dot`](denv_qsp_model.dot) · [`.svg`](denv_qsp_model.svg) · [`.png`](denv_qsp_model.png) | Mechanistic map — 129 nodes · 17 clusters · 225 edges |
| [`denv_mrgsolve_model.R`](denv_mrgsolve_model.R) | mrgsolve QSP model — **45 ODEs**, 18 treatment scenarios, the WHO fluid ladder |
| [`denv_reference_model.py`](denv_reference_model.py) | Independent Python/scipy re-implementation (for verification) |
| [`denv_reference_output.txt`](denv_reference_output.txt) | The full output of the script above — the source of every number below |
| [`denv_scenario_results.json`](denv_scenario_results.json) | Scenario and sweep results (machine-readable) |
| [`denv_shiny_app.R`](denv_shiny_app.R) | Shiny dashboard — 10 tabs |
| [`denv_references.md`](denv_references.md) | 121 PubMed links, 14 sections |
