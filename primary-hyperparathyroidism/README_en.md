...
| File | Description |
|------|------|
| [phpt_qsp_model.dot](phpt_qsp_model.dot) | Graphviz mechanistic map source (approximately 128 nodes / 12 clusters) |
| [phpt_qsp_model.svg](phpt_qsp_model.svg) | SVG vector image (scalable) |
| [phpt_qsp_model.png](phpt_qsp_model.png) | PNG image (150 dpi) |
| [phpt_mrgsolve_model.R](phpt_mrgsolve_model.R) | mrgsolve ODE model (approximately 20 compartments / 8 treatment scenarios) |
| [phpt_shiny_app_en.R](phpt_shiny_app_en.R) | Shiny dashboard |
| [phpt_references_en.md](phpt_references_en.md) | References (approximately 62 articles, PubMed links) |
...
plot(out)
# Shiny dashboard:
shiny::runApp("phpt_shiny_app_en.R")
```
```bash
...
## References
For detailed citations, see [phpt_references_en.md](phpt_references_en.md) (approximately 62 articles).
