...
## Interactive QSP dashboard  ·  Delayed Cerebral Ischemia after Aneurysmal Subarachnoid Hemorrhage Dashboard
##
## 8 tabs:
##   1  Patient Profile        Patient profile & the shared reserve
##   2  Drug PK              Drug pharmacokinetics
##   3  Blood-Haemoglobin Clock  The haemoglobin clock (why day 4-10 exists)
##   4  Four Consumers           The four consumers of one reserve
##   5  Perfusion & Oxygen           Perfusion, oxygen delivery & extraction
##   6  Clinical Endpoints       Clinical endpoints
##   7  Scenario Comparison         Scenario comparison (15 arms)
##   8  Biomarkers · Monitoring  Biomarkers and bedside monitoring
##
...
source("sah_mrgsolve_model_en.R")   # provides sah_mod, sah_population, scenarios,
...
ui <- fluidPage(
  titlePanel(HTML(paste0(
    ...
    "<span style='font-size:14px;color:#555'>Delayed Cerebral Ischemia after Aneurysmal Subarachnoid Hemorrhage ",
    "— One Arteriolar Reserve, Four Consumers</span>"))),
    ...
    mainPanel(
      ...
      tabsetPanel(
        ...
        tabPanel(
          ...
          br(),
          fluidRow(
            column(7, h4("Shared Reserve Gauge"),
                   plotOutput("reserve_gauge", height = "300px")),
            column(5, h4("Summary"), tableOutput("profile_tbl"))
          ),
          hr(),
          h4("Key State Variables (over 21 days)"),
        ...
        tabPanel(
          ...
          hr(),
          h4("Steady-State Exposure and Receptor Occupancy"),
          tableOutput("pk_tbl"),
          helpText(HTML(paste0(
        ...
        tabPanel(
          ...
          hr(),
          fluidRow(
            column(6, h4("The Transit Chain"),
                   plotOutput("clock_chain", height = "300px")),
            column(6, h4("Clearance Capacity"),
        ...
        tabPanel(
          ...
          br(),
          h4("Reserve Consumption Breakdown (stacked)"),
          plotOutput("consumers_stack", height = "420px"),
          hr(),
          fluidRow(
            column(6, h4("Share of Total Demand by Consumer"),
                   plotOutput("consumers_share", height = "320px")),
            column(6, h4("Ischaemic Margin (CBFmax / CBFrequired)"),
        ...
        ## ---------------------------------------------------------- tab 5
        tabPanel(
          "5. Perfusion and Oxygen",
          br(),
          plotOutput("perf_plot", height = "500px"),
          hr(),
          fluidRow(
            column(6, h4("Resistance Components"),
                   plotOutput("resist_plot", height = "300px")),
            column(6, h4("Extraction Limit (CTH degrades OEFmax)"),
        ...
        tabPanel(
          ...
          br(),
          fluidRow(
            column(6, h4("This Patient's Endpoints"), tableOutput("endpoint_tbl")),
            column(6, h4("Outcome Probability Breakdown (logit contributions)"),
                   plotOutput("outcome_waterfall", height = "320px"))
          ),
          hr(),
          h4("Virtual Population Endpoints (current treatment)"),
        ...
        tabPanel(
          ...
          hr(),
          h4("Incidence and Risk Ratios (vs S2)"),
          DTOutput("arm_tbl"),
          br(),
        ...
        tabPanel(
          ...
          hr(),
          fluidRow(
            column(6, h4("Diagnostic Performance (TCD vs PbtO2 as DCI tests)"),
                   tableOutput("test_tbl")),
            column(6, h4("Lead Time (in DCI patients)"),
