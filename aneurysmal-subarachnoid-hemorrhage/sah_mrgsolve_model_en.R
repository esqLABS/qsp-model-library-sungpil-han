...
## Delayed cerebral ischaemia after aneurysmal subarachnoid haemorrhage — mrgsolve QSP model
##
...
##
##   Every number quoted in README_en.md is produced by sah_reference_check.py,
...
##   there and in README_en.md rather than tuned away:
