...
| File | Contents |
|---|---|
| [`ed_qsp_model.dot`](ed_qsp_model.dot) · [`.svg`](ed_qsp_model.svg) · [`.png`](ed_qsp_model.png) | Mechanistic map — 189 nodes, 18 clusters |
| [`ed_mrgsolve_model_en.R`](ed_mrgsolve_model_en.R) | 45-ODE mrgsolve model, PK library for 4 PDE5 inhibitors, 9 patient archetypes, 16 scenarios, virtual population functions, calibration notes |
| [`ed_shiny_app_en.R`](ed_shiny_app_en.R) | 14-tab interactive dashboard |
| [`ed_references_en.md`](ed_references_en.md) | 102 references (every PMID automatically verified via NCBI E-utilities) |

```r
source("ed_mrgsolve_model_en.R")
...
shiny::runApp("ed_shiny_app_en.R")
```
