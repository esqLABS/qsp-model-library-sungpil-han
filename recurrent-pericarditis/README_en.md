...
[![RP Mechanistic Map](rp_qsp_model_en.png)](rp_qsp_model_en.svg)
...
| File | Description |
|------|------|
| `rp_qsp_model_en.dot` | Graphviz mechanistic map (14 clusters, 162+ nodes) |
| `rp_qsp_model_en.svg` | Vector graphic (for interactive browser viewing) |
| `rp_qsp_model_en.png` | PNG thumbnail (150 dpi) |
...
57 total — see [rp_references.md](rp_references.md)
