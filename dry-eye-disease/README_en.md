...
| Deliverable | File |
|---|---|
| 🗺️ Mechanistic map (DOT) | [`ded_qsp_model_en.dot`](ded_qsp_model_en.dot) |
| 🖼️ Map (SVG)             | [`ded_qsp_model_en.svg`](ded_qsp_model_en.svg) |
| 🖼️ Map (PNG, 150 dpi)    | [`ded_qsp_model_en.png`](ded_qsp_model_en.png) |
| ⚙️ mrgsolve ODE model     | [`ded_mrgsolve_model_en.R`](ded_mrgsolve_model_en.R) |
| 📊 Shiny dashboard        | [`ded_shiny_app.R`](ded_shiny_app.R) |
| 📚 References             | [`ded_references_en.md`](ded_references_en.md) |
...
dot -Tsvg ded_qsp_model_en.dot -o ded_qsp_model_en.svg
dot -Tpng -Gdpi=150 ded_qsp_model_en.dot -o ded_qsp_model_en.png
```
...
install.packages(c("mrgsolve","dplyr","tidyr","ggplot2","shiny",
                   "shinydashboard","DT"))
library(mrgsolve)
mod <- mread_cache("ded_mrgsolve_model_en.R")
