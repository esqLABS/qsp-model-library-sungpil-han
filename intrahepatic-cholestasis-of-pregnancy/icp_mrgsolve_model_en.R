...
##  Intrahepatic cholestasis of pregnancy — mrgsolve QSP model
##
...
##  (icp_reference_model_en.py, fixed-step RK4), and this file is a
...
$INIT @annotated
// Converged pre-third-trimester state of icp_reference_model_en.py after a
