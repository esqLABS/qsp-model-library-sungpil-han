...
| File | Contents |
|------|------|
| `icp_qsp_model_en.dot` / `.svg` / `.png` | 20-cluster mechanistic map |
| `icp_reference_model_en.py` | Dependency-free Python RK4 reference implementation (78 ODEs) — every equation was run here first |
...
| `icp_mrgsolve_model_en.R` | mrgsolve model (78 ODEs, 35 scenarios) |
| `icp_shiny_app_en.R` | 10-tab Shiny dashboard |
| `README_en.md` | A summary of the model's structure and results |
