...
| File | Description |
|------|------|
| [vit_qsp_model.dot](vit_qsp_model.dot) | Graphviz mechanistic map source (approximately 262 nodes / 11 clusters) |
| [vit_qsp_model.svg](vit_qsp_model.svg) | SVG vector image (scalable) |
| [vit_qsp_model.png](vit_qsp_model.png) | PNG image (150 dpi) |
| [vit_mrgsolve_model.R](vit_mrgsolve_model.R) | mrgsolve ODE model (approximately 21 compartments / 5 treatment scenarios) |
| [vit_shiny_app.R](vit_shiny_app.R) | Shiny dashboard |
| [vit_references_en.md](vit_references_en.md) | References (approximately 32 articles, PubMed links) |
...
For detailed citations, see [vit_references_en.md](vit_references_en.md) (approximately 32 articles).
