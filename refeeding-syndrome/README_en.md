...
| Deliverable | File |
|--------|------|
| 🗺️ Mechanistic map (147 nodes · 17 clusters · 229 edges) | [`rfs_qsp_model.dot`](rfs_qsp_model.dot) · [`.svg`](rfs_qsp_model.svg) · [`.png`](rfs_qsp_model.png) |
| ⚙️ mrgsolve ODE model (48 ODEs · 172 params · 16 scenarios) | [`rfs_mrgsolve_model.R`](rfs_mrgsolve_model.R) |
| 📊 Shiny dashboard (10 tabs) | [`rfs_shiny_app.R`](rfs_shiny_app.R) |
| 📚 References (106 refs · 96 PubMed links) | [`rfs_references.md`](rfs_references.md) |
| 🐍 Independent validation implementation (Python/scipy) | [`rfs_reference_model.py`](rfs_reference_model.py) → [`rfs_reference_output.txt`](rfs_reference_output.txt) |
...
([`rfs_reference_model.py`](rfs_reference_model.py)). In the
