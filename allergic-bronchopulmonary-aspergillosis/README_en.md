...
| File | Contents |
|---|---|
| [`abpa_qsp_model.dot`](abpa_qsp_model.dot) | 200-node · 18-cluster mechanistic map (Graphviz source) |
| [`abpa_qsp_model.svg`](abpa_qsp_model.svg) · [`abpa_qsp_model.png`](abpa_qsp_model.png) | Renders (`dot -Tpng -Gdpi=150`) |
| [`abpa_mrgsolve_model.R`](abpa_mrgsolve_model.R) | 42-compartment mrgsolve model + scenario builder |
| [`abpa_reference_implementation.py`](abpa_reference_implementation.py) | Dependency-free pure-Python reference implementation (A0–A13) |
| [`abpa_numerical_report.txt`](abpa_numerical_report.txt) | The full output of the above script — the source of every number in this README |
| [`abpa_shiny_app.R`](abpa_shiny_app.R) | 10-tab Shiny dashboard |
| [`abpa_references.md`](abpa_references.md) | 97 references, every PMID verified against the API + annotations on their role in the model |
