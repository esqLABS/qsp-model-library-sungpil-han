...
| File | Contents |
|------|----------|
| [`pph_qsp_model.dot`](pph_qsp_model.dot) · [SVG](pph_qsp_model.svg) · [PNG](pph_qsp_model.png) | Mechanistic map — 137 nodes / 158 edges / 12 clusters |
| [`pph_mrgsolve_model.R`](pph_mrgsolve_model.R) | mrgsolve ODE model — 41 compartments (10 drug PK + 31 disease/physiology), 12 scenario blocks |
| [`pph_shiny_app.R`](pph_shiny_app.R) | Shiny dashboard — 9 tabs |
| [`pph_references.md`](pph_references.md) | 90 references (every PMID verified via the PubMed E-utilities) |
