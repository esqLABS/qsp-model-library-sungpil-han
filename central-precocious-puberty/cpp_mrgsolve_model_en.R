...
#  ---------------------------------------------------------------------------
#  Central precocious puberty QSP model · mrgsolve (44 ODEs)
#
...
#  cpp_references_en.md, or (ii) derived by hand from a published steady-state
...
#  README_en.md rather than tuned away.
# =============================================================================
...
# When cpp_shiny_app_en.R sources it with local = TRUE, environment() is not the
