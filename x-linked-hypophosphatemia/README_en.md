# X-Linked Hypophosphatemia (XLH) — QSP Disease Model
...
- Sodium-phosphate cotransporter (NPT2a/NPT2c)
- Tubular maximum phosphate reabsorption / GFR (TmP/GFR)
- Rickets (pediatric) / Osteomalacia (adult)
...
Library. See root [README.md](../README_en.md) for the full model gallery.*
