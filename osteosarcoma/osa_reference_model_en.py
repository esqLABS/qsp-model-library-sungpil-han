...
#  Osteosarcoma QSP model — numerical reference implementation
#
#  WHY THIS FILE EXISTS
#  --------------------
#  The deliverable model of record is `osa_mrgsolve_model_en.R` (mrgsolve / R).
...
#  so that every number quoted in README_en.md and in the .dot map is a computed
...
def main():
    ...
    say("#  osa_reference_model.py    (numerical mirror of osa_mrgsolve_model_en.R)")
    say("#")
