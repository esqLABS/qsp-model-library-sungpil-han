...
##
##  Tab 1  Patient Profile     patient, tumour and regimen builder
##  Tab 2  Pharmacokinetics (PK)       methotrexate / doxorubicin / cisplatin profiles
##  Tab 3  Renal Feedback Loop  the bifurcation: C_tub vs S(pH), critical pH
##  Tab 4  Tumour · PD         viable vs necrotic primary, log-kill accrual
##  Tab 5  Clinical Endpoints   Huvos, cure, TRM, survival, LVEF, hearing, eGFR
##  Tab 6  Scenario Comparison     all 20 arms, ranked by SURVIVAL not by kill
##  Tab 7  Biomarkers · Toxicity ALP, ANC, mucositis, the go/no-go gate log
##  Tab 8  Virtual Population         the detectability wall, and where the budget belongs
##
##  Run:  shiny::runApp("osa_shiny_app.R")
##  Requires osa_mrgsolve_model_en.R in the same directory.
## ===========================================================================
...
source("osa_mrgsolve_model_en.R", local = TRUE)
...
ui <- fluidPage(
  titlePanel(
    div(
      h3("Osteosarcoma Quantitative Systems Pharmacology"),
  ...
  sidebarLayout(
    sidebarPanel(
      ...
      hr(),
      h4("② Supportive Care — the real lever"),
