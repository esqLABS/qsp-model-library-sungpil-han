...
[![CS QSP mechanistic map](cs_qsp_model_en.png)](cs_qsp_model_en.svg)
...
|---------|------|-----|
| 🗺️ Mechanistic map (DOT) | [`cs_qsp_model_en.dot`](cs_qsp_model_en.dot) | **140+ nodes, 13 clusters** |
| 🖼️ SVG vector image | [`cs_qsp_model_en.svg`](cs_qsp_model_en.svg) | Zoomable, high resolution |
| 🖼️ PNG raster image | [`cs_qsp_model_en.png`](cs_qsp_model_en.png) | 150 dpi |
| ⚙️ mrgsolve ODE model | [`cs_mrgsolve_model_en.R`](cs_mrgsolve_model_en.R) | **21-compartment ODE, 6 treatment scenarios** |
| 📊 Shiny app | [`cs_shiny_app_en.R`](cs_shiny_app_en.R) | **8-tab dashboard** |
| 📚 References | [`cs_references_en.md`](cs_references_en.md) | **55 PubMed citations (10 sections)** |
