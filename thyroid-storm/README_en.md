...
<p align="center">
  <a href="ts_qsp_model_en.svg"><img src="ts_qsp_model_en.png" width="900" alt="Thyroid storm QSP mechanistic map"></a>
</p>

| Deliverable | File | Scale |
|---|---|---|
| Mechanistic map | [`ts_qsp_model_en.dot`](ts_qsp_model_en.dot) · [SVG](ts_qsp_model_en.svg) · [PNG](ts_qsp_model_en.png) | 142 nodes · 21 clusters · 216 edges |
| mrgsolve ODE model | [`ts_mrgsolve_model_en.R`](ts_mrgsolve_model_en.R) | **38 ODEs** · 18 scenarios · 5 diagnostic sweeps |
| Shiny app | [`ts_shiny_app_en.R`](ts_shiny_app_en.R) | 11 tabs |
| References | [`ts_references_en.md`](ts_references_en.md) | 145 papers (PubMed links throughout) |
| Numerical verification | [`ts_verify_python_en.py`](ts_verify_python_en.py) → [`ts_verification_output_en.txt`](ts_verification_output_en.txt) | **The source of every number** in this README |
...
shiny::runApp("ts_shiny_app_en.R")
```

```bash
# numerical verification — regenerates every number in this README
python3 ts_verify_python_en.py      # → ts_verification_output_en.txt

# rendering the map
dot -Tsvg ts_qsp_model_en.dot -o ts_qsp_model_en.svg
dot -Tpng -Gdpi=150 ts_qsp_model_en.dot -o ts_qsp_model_en.png
```
...
Parent library → [../README_en.md](../README_en.md) · category: endocrine and metabolic
