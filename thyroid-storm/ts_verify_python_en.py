...
This file is the ARITHMETIC OF RECORD for every number quoted in README_en.md.
ts_mrgsolve_model_en.R is a line-by-line port of the ODE system implemented here;
...
def main():
    ...
    w(RULE("="))
    w("THYROID STORM QSP MODEL -- NUMERICAL VERIFICATION")
    w(RULE("="))
    w("Every number quoted in README_en.md is produced by this file.")
    ...
    with open(os.path.join(os.path.dirname(os.path.abspath(__file__)),
                           "ts_verification_output_en.txt"), "w") as f:
        f.write(txt + "\n")
