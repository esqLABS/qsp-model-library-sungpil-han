# =============================================================================
#  ts_mrgsolve_model.R
#  THYROID STORM (thyrotoxic crisis) — QSP model for mrgsolve
# =============================================================================
#
#  CENTRAL THESIS
#  --------------
...
#
#  This file is a line-by-line port of ts_verify_python_en.py, which is the
#  arithmetic of record for every number quoted in README_en.md.  Three deliberate
...
// represented (see caveat L7 in README_en.md).
...
#  ts_verify_python_en.py: gut compartments in mg, plasma compartments already
