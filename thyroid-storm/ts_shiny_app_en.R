# =============================================================================
#  ts_shiny_app.R
#  THYROID STORM — interactive QSP dashboard
# =============================================================================
#
...
#
#  Requires: shiny, mrgsolve, dplyr, and ts_mrgsolve_model_en.R in the same folder.
#
...
source("ts_mrgsolve_model_en.R", local = TRUE)
