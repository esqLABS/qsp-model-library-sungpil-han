...
| File | Description |
|------|------|
| [cgast_qsp_model.dot](cgast_qsp_model.dot) | Graphviz mechanistic map source (about 439 nodes / 10 clusters) |
| [cgast_qsp_model.svg](cgast_qsp_model.svg) | SVG vector image (zoomable) |
| [cgast_qsp_model.png](cgast_qsp_model.png) | PNG image (150 dpi) |
| [cgast_mrgsolve_model.R](cgast_mrgsolve_model.R) | mrgsolve ODE model (about 22 compartments / 7 treatment scenarios) |
| [cgast_shiny_app.R](cgast_shiny_app.R) | Shiny dashboard |
| [cgast_references_en.md](cgast_references_en.md) | References (about 61, PubMed links) |
...
For full citations, see [cgast_references_en.md](cgast_references_en.md) (about 61 entries).
