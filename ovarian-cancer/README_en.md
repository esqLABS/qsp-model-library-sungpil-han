...
[![QSP Mechanistic Map](oc_qsp_model_en.png)](oc_qsp_model_en.svg)
...
|---------|------|------|
| 🗺️ Mechanistic map (DOT) | [`oc_qsp_model_en.dot`](oc_qsp_model_en.dot) | **180+ nodes, 10 clusters** (fdp layout) |
| 🖼️ Mechanistic map (SVG) | [`oc_qsp_model_en.svg`](oc_qsp_model_en.svg) | Vector image |
| 🖼️ Mechanistic map (PNG) | [`oc_qsp_model_en.png`](oc_qsp_model_en.png) | 150 dpi raster image |
| ⚙️ mrgsolve ODE model | [`oc_mrgsolve_model.R`](oc_mrgsolve_model.R) | **18-compartment ODE**, **6 treatment scenarios**, calibrated to SOLO-1/PRIMA/PAOLA-1 |
| 📊 Shiny dashboard | [`oc_shiny_app_en.R`](oc_shiny_app_en.R) | **6-tab** interactive dashboard |
| 📚 References | [`oc_references_en.md`](oc_references_en.md) | **55 PubMed citations** (14 sections) |
