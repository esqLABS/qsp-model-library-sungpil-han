...
| File | Description |
|------|------|
| [`ln_qsp_model.dot`](ln_qsp_model.dot) | Graphviz mechanistic map source (15 subgraph clusters) |
| [`ln_qsp_model.svg`](ln_qsp_model.svg) | Vector graphic map |
| [`ln_qsp_model.png`](ln_qsp_model.png) | Raster map (150 dpi) |
| [`ln_mrgsolve_model.R`](ln_mrgsolve_model.R) | mrgsolve ODE model + 5 treatment scenarios |
| [`ln_shiny_app.R`](ln_shiny_app.R) | Shiny dashboard (6 tabs) |
| [`ln_references.md`](ln_references.md) | 45 PubMed references |
