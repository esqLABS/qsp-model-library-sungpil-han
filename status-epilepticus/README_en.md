...
| File | Contents |
|---|---|
| [`se_qsp_model.dot`](se_qsp_model.dot) · [`.svg`](se_qsp_model.svg) · [`.png`](se_qsp_model.png) | mechanistic map — **177 nodes, 19 clusters** |
| [`se_mrgsolve_model_en.R`](se_mrgsolve_model_en.R) | **59 ODEs** (27 PK + 32 disease PD), **193 parameters**, **22 treatment scenarios**, 8 analysis functions |
| [`se_shiny_app_en.R`](se_shiny_app_en.R) | **10-tab** interactive dashboard |
| [`se_references_en.md`](se_references_en.md) | **126 references** — every PMID confirmed via NCBI E-utilities |
...
source("se_mrgsolve_model_en.R")   # prints all 22 scenarios + 8 analyses
...
shiny::runApp("se_shiny_app_en.R")
```
