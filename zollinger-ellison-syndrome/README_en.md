...
| Deliverable | File |
|--------|------|
| 🗺️ Mechanistic map | [`zes_qsp_model.dot`](zes_qsp_model.dot) · [SVG](zes_qsp_model.svg) · [PNG](zes_qsp_model.png) — 188 nodes / 275 edges / 22 clusters |
| ⚙️ mrgsolve model | [`zes_mrgsolve_model.R`](zes_mrgsolve_model.R) — 59 ODEs, time unit = hour, 37 scenarios |
| 📊 Shiny dashboard | [`zes_shiny_app.R`](zes_shiny_app.R) — 12 tabs |
| 📚 References | [`zes_references.md`](zes_references.md) — 105 PubMed entries (every PMID verified) |
