...
| Deliverable | File |
|---|---|
| 🗺️ Mechanistic map | [`prl_qsp_model.dot`](prl_qsp_model.dot) · [`.svg`](prl_qsp_model.svg) · [`.png`](prl_qsp_model.png) |
| ⚙️ mrgsolve ODE model | [`prl_mrgsolve_model.R`](prl_mrgsolve_model.R) |
| 📊 Shiny dashboard | [`prl_shiny_app_en.R`](prl_shiny_app_en.R) |
| 📄 Directory README | [`README_en.md`](README_en.md) |
