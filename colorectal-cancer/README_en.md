...
| File | Description |
|------|------|
| [`crc_qsp_model.dot`](crc_qsp_model.dot) | Graphviz mechanistic map source |
| [`crc_qsp_model.svg`](crc_qsp_model.svg) | Vector graphic (zoomable) |
| [`crc_qsp_model.png`](crc_qsp_model.png) | 150 dpi raster image |
| [`crc_mrgsolve_model.R`](crc_mrgsolve_model.R) | mrgsolve ODE model (20 compartments, 7 scenarios) |
| [`crc_shiny_app.R`](crc_shiny_app.R) | Shiny interactive dashboard (6 tabs) |
| [`crc_references.md`](crc_references.md) | 40 references (grouped by section) |
