...
<p align="center">
  <a href="ich_qsp_model_en.svg"><img src="ich_qsp_model_en.png" width="720" alt="ICH QSP mechanistic map"></a>
</p>
...
| File | Contents |
|---|---|
| [`ich_qsp_model_en.dot`](ich_qsp_model_en.dot) | Mechanistic map source — 20 clusters, 219 nodes, 361 edges |
| [`ich_qsp_model_en.svg`](ich_qsp_model_en.svg) / [`ich_qsp_model_en.png`](ich_qsp_model_en.png) | Rendered map (Graphviz `dot`, PNG 150 dpi) |
| [`ich_mrgsolve_model.R`](ich_mrgsolve_model.R) | mrgsolve model — **60 ODE compartments**, 12 scenarios, including response surfaces and falsification switches |
| [`ich_shiny_app_en.R`](ich_shiny_app_en.R) | Shiny dashboard — 8 tabs |
| [`ich_references_en.md`](ich_references_en.md) | 112 PubMed-verified references (every PMID checked) |
...
shiny::runApp("ich_shiny_app_en.R")
```
