...
| | |
|---|---|
| **Mechanistic map** | [`rili_qsp_model_en.svg`](rili_qsp_model_en.svg) · [`rili_qsp_model_en.dot`](rili_qsp_model_en.dot) — 244 nodes / 385 edges / 18 clusters |
| **mrgsolve model** | [`rili_mrgsolve_model_en.R`](rili_mrgsolve_model_en.R) — **79 ODEs** (6 DVH bins × 10 states + 19 global), 40 scenarios |
| **Shiny app** | [`rili_shiny_app_en.R`](rili_shiny_app_en.R) — 10 tabs |
| **References** | [`rili_references_en.md`](rili_references_en.md) — **236 papers**, every PMID verified by lookup |
| **Reference implementation** | [`rili_reference_model.py`](rili_reference_model.py) · [output](rili_reference_output.txt) — dependency-free Python RK4 |
| **Calibration · derived-quantity analysis** | [`rili_calibration.py`](rili_calibration.py) · [output](rili_calibration_output.txt) |

<a href="rili_qsp_model_en.svg"><img src="rili_qsp_model_en.png" width="820" alt="RILI QSP map"></a>
...
is in [`rili_reference_output.txt`](rili_reference_output.txt).
...
step)**, and [`rili_mrgsolve_model_en.R`](rili_mrgsolve_model_en.R) is a literal port of that
...
dot -Tsvg rili_qsp_model_en.dot -o rili_qsp_model_en.svg
dot -Tpng -Gdpi=96 rili_qsp_model_en.dot -o rili_qsp_model_en.png
```
...
shiny::runApp("rili_shiny_app_en.R")
```
