...
| File | Contents |
|------|------|
| [`oic_qsp_model_en.dot`](oic_qsp_model_en.dot) | Mechanistic map source — **160 nodes · 236 edges · 18 clusters** |
| [`oic_qsp_model_en.svg`](oic_qsp_model_en.svg) | Zoomable vector map (10579 × 3565) |
| [`oic_qsp_model_en.png`](oic_qsp_model_en.png) | 150 dpi raster |
| [`oic_mrgsolve_model_en.R`](oic_mrgsolve_model_en.R) | 51-ODE mrgsolve model + 16 scenarios + 5 analysis functions |
| [`oic_shiny_app_en.R`](oic_shiny_app_en.R) | 10-tab interactive dashboard |
| [`oic_reference_model.py`](oic_reference_model.py) | Independent Python/scipy implementation — **the only implementation that was actually integrated** |
| [`oic_reference_output.txt`](oic_reference_output.txt) | Run log of that implementation — the source of **every** number in this README |
| [`oic_population_results.json`](oic_population_results.json) | Virtual population results (machine-readable) |
| [`oic_references_en.md`](oic_references_en.md) | **110 references** queried directly on PubMed, 14 sections |
...
`oic_mrgsolve_model_en.R` was **transcribed term by term** from `oic_reference_model.py`,
...
```r
# R
source("oic_mrgsolve_model_en.R")
...
shiny::runApp("oic_shiny_app_en.R")    # 10-tab dashboard
```
