...
| File | Contents |
|------|------|
| [`acn_qsp_model_en.dot`](acn_qsp_model_en.dot) | Mechanistic map source — **18 clusters · 277 nodes · 383 edges** |
| [`acn_qsp_model_en.svg`](acn_qsp_model_en.svg) | Vector rendering (zoom in to read) |
| [`acn_qsp_model_en.png`](acn_qsp_model_en.png) | Raster rendering (150 dpi) |
| [`acn_mrgsolve_model.R`](acn_mrgsolve_model.R) | mrgsolve model with **55 ODE compartments · 213 parameters · 17 scenarios** |
| [`acn_shiny_app_en.R`](acn_shiny_app_en.R) | 10-tab interactive dashboard |
| [`acn_references_en.md`](acn_references_en.md) | **110** PubMed-verified references (PMIDs actually looked up) |

Rendering:
```bash
dot -Tsvg acn_qsp_model_en.dot -o acn_qsp_model_en.svg
dot -Tpng -Gdpi=150 acn_qsp_model_en.dot -o acn_qsp_model_en.png
```
...
[![ACN QSP map](acn_qsp_model_en.png)](acn_qsp_model_en.svg)
...
evidence table in [`acn_references_en.md`](acn_references_en.md), and no formal
...
```r
shiny::runApp("acn_shiny_app_en.R")
```
...
[`acn_references_en.md`](acn_references_en.md) — 15 sections, **110** entries.
