...
For the model itself see [`cio_mrgsolve_model_en.R`](cio_mrgsolve_model_en.R), and for the verification run see
[`cio_reference_output.txt`](cio_reference_output.txt).
