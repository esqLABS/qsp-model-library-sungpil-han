...
##  Cisplatin-Induced Ototoxicity QSP Dashboard
##
##  10 tabs:
...
##  Loads the model from cio_mrgsolve_model_en.R in the same directory.
## =============================================================================
...
source("cio_mrgsolve_model_en.R", local = TRUE)
...
## =============================================================================
ui <- fluidPage(
  titlePanel("Cisplatin-Induced Ototoxicity — QSP Dashboard"),
