...
<a href="cio_qsp_model_en.svg"><img src="cio_qsp_model_en.png" width="640" alt="CIO QSP mechanistic map"></a>
...
| Deliverable | File |
|---|---|
| Mechanistic map (140 nodes · 174 edges · 15 clusters) | [`cio_qsp_model_en.dot`](cio_qsp_model_en.dot) · [SVG](cio_qsp_model_en.svg) · [PNG](cio_qsp_model_en.png) |
| mrgsolve ODE model (**73 ODEs**, 20 scenarios) | [`cio_mrgsolve_model_en.R`](cio_mrgsolve_model_en.R) |
| Shiny dashboard (**10 tabs**) | [`cio_shiny_app_en.R`](cio_shiny_app_en.R) |
| Independent Python verification implementation | [`cio_reference_model.py`](cio_reference_model.py) |
| Verification run output (full) | [`cio_reference_output.txt`](cio_reference_output.txt) |
| References (**158**, verified directly via PubMed) | [`cio_references_en.md`](cio_references_en.md) |
...
source("cio_mrgsolve_model_en.R")
print(cio_table(mod))
...
# dashboard
shiny::runApp("cio_shiny_app_en.R")
```
