...
| Deliverable | File |
|---|---|
| 🗺️ Mechanistic map (DOT) | [`pku_qsp_model_en.dot`](pku_qsp_model_en.dot) |
| 🖼️ Map (SVG)             | [`pku_qsp_model_en.svg`](pku_qsp_model_en.svg) |
| 🖼️ Map (PNG, 150 dpi)    | [`pku_qsp_model_en.png`](pku_qsp_model_en.png) |
| ⚙️ mrgsolve ODE model     | [`pku_mrgsolve_model_en.R`](pku_mrgsolve_model_en.R) |
| 📊 Shiny dashboard        | [`pku_shiny_app.R`](pku_shiny_app.R) |
| 📚 References             | [`pku_references_en.md`](pku_references_en.md) |
...
dot -Tsvg pku_qsp_model_en.dot -o pku_qsp_model_en.svg
dot -Tpng -Gdpi=150 pku_qsp_model_en.dot -o pku_qsp_model_en.png
```
...
install.packages(c("mrgsolve","dplyr","tidyr","ggplot2","shiny",
                   "shinydashboard","DT"))
library(mrgsolve)
mod <- mread_cache("pku_mrgsolve_model_en.R")
...
* Multi-stage scenarios (e.g. #10) require carrying state forward via the
  ...
  the R-side scenario helpers at the bottom of `pku_mrgsolve_model_en.R`.
