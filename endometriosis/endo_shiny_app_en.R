...
# Endometriosis Quantitative Systems Pharmacology Dashboard
# ============================================================
...
ui <- fluidPage(
  ...
  titlePanel(
    div(
      h2("Endometriosis QSP Simulator",
  ...
  tabsetPanel(id = "main_tabs",
    ...
    # ---- TAB 3: HPO Hormones ----
    tabPanel("3. HPO Hormone Dynamics",
      fluidRow(
        column(12,
    ...
    tabPanel("4. Pain & Clinical Endpoints",
      fluidRow(
        column(6,
