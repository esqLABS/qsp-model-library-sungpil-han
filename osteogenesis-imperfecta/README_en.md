...
| Deliverable | File |
|---|---|
| 🗺️ Mechanistic map (DOT) | [`oi_qsp_model_en.dot`](oi_qsp_model_en.dot) |
| 🖼️ Map (SVG)             | [`oi_qsp_model_en.svg`](oi_qsp_model_en.svg) |
| 🖼️ Map (PNG, 150 dpi)    | [`oi_qsp_model_en.png`](oi_qsp_model_en.png) |
| ⚙️ mrgsolve ODE model     | [`oi_mrgsolve_model.R`](oi_mrgsolve_model.R) |
| 📊 Shiny dashboard        | [`oi_shiny_app_en.R`](oi_shiny_app_en.R) |
| 📚 References             | [`oi_references_en.md`](oi_references_en.md) |
...
dot -Tsvg oi_qsp_model_en.dot -o oi_qsp_model_en.svg
dot -Tpng -Gdpi=150 oi_qsp_model_en.dot -o oi_qsp_model_en.png
```
...
shiny::runApp("oi_shiny_app_en.R")
```
