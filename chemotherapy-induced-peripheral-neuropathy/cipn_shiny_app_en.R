...
## Chemotherapy-Induced Peripheral Neuropathy QSP Dashboard
##
## 12 tabs:
...
## Requires:  cipn_mrgsolve_model_en.R in the same directory.
## =============================================================================
...
source("cipn_mrgsolve_model_en.R")
...
ui <- fluidPage(
  titlePanel("CIPN QSP Dashboard — Chemotherapy-Induced Peripheral Neuropathy"),
  sidebarLayout(
    sidebarPanel(
      width = 3,
      h4("1. Chemotherapy Regimen"),
