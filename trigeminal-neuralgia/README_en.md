...
| Deliverable | File |
|---|---|
| Mechanistic map (DOT) | [`tn_qsp_model_en.dot`](tn_qsp_model_en.dot) |
| Map (SVG)             | [`tn_qsp_model_en.svg`](tn_qsp_model_en.svg) |
| Map (PNG, 150 dpi)    | [`tn_qsp_model_en.png`](tn_qsp_model_en.png) |
| mrgsolve ODE model     | [`tn_mrgsolve_model.R`](tn_mrgsolve_model.R) |
| Shiny dashboard        | [`tn_shiny_app_en.R`](tn_shiny_app_en.R) |
| References             | [`tn_references_en.md`](tn_references_en.md) |
...
dot -Tsvg tn_qsp_model_en.dot -o tn_qsp_model_en.svg
dot -Tpng -Gdpi=150 tn_qsp_model_en.dot -o tn_qsp_model_en.png
```
...
shiny::runApp("tn_shiny_app_en.R")
```
