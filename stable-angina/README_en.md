...
| File | Description |
|------|------|
| [sa_qsp_model.dot](sa_qsp_model.dot) | Graphviz mechanistic map source (approximately 100+ nodes / 15 clusters) |
| [sa_qsp_model.svg](sa_qsp_model.svg) | SVG vector image (scalable) |
| [sa_qsp_model.png](sa_qsp_model.png) | PNG image (150 dpi) |
| [sa_mrgsolve_model.R](sa_mrgsolve_model.R) | mrgsolve ODE model (approximately 22 compartments / approximately 11 scenarios) |
| [sa_shiny_app.R](sa_shiny_app.R) | Shiny dashboard |
| [sa_references.md](sa_references.md) | References (approximately 49 articles, PubMed links) |
...
For detailed citations, see [sa_references.md](sa_references.md) (approximately 49 articles).
