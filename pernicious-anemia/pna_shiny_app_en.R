##############################################################################
# Pernicious Anemia — QSP Interactive Shiny Dashboard
#
# Tabs:
#  1. Patient Profile   — Patient profile, risk factors, PA stage
#  2. Drug PK         — Cobalamin PK (plasma B12, HoloTC, depot)
#  3. Blood PD         — Hematological PD (Hb, MCV, retic crisis)
#  4. Neuro PD       — Neurological PD (NEURO score, SCD timeline)
#  5. Biomarkers       — Functional markers (MMA, Hcy, gastrin)
#  6. Scenario Comparison    — Multi-scenario comparison (5 treatment arms)
#
...
ui <- fluidPage(
  ...
  titlePanel(
    div(
      ...
      p("Pernicious Anemia Quantitative Systems Pharmacology Simulator",
