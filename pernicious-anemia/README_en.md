...
[![PNA QSP Model](pna_qsp_model_en.png)](pna_qsp_model_en.svg)
...
| File | Description |
|------|------|
| [pna_qsp_model_en.dot](pna_qsp_model_en.dot) | Graphviz mechanistic map source (approximately 154 nodes / 11 clusters) |
| [pna_qsp_model_en.svg](pna_qsp_model_en.svg) | SVG vector image (scalable) |
| [pna_qsp_model_en.png](pna_qsp_model_en.png) | PNG image (150 dpi) |
| [pna_mrgsolve_model_en.R](pna_mrgsolve_model_en.R) | mrgsolve ODE model (approximately 18 compartments / 5 treatment scenarios) |
| [pna_shiny_app_en.R](pna_shiny_app_en.R) | Shiny dashboard |
| [pna_references_en.md](pna_references_en.md) | References (approximately 35 articles, PubMed links) |
...
```r
library(mrgsolve)
mod <- mread("pna_mrgsolve_model_en.R")
out <- mrgsim(mod, end = 365)
plot(out)
# Shiny dashboard:
shiny::runApp("pna_shiny_app_en.R")
```
```bash
# Render the mechanistic map
dot -Tsvg pna_qsp_model_en.dot -o pna_qsp_model_en.svg
```

## References
For detailed citations, see [pna_references_en.md](pna_references_en.md) (approximately 35 articles).
