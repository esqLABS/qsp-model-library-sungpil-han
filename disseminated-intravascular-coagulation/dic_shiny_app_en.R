...
##  Disseminated Intravascular Coagulation · Quantitative Systems Pharmacology Dashboard
##
...
##  Sources:   dic_mrgsolve_model_en.R (must sit in the same directory)
## =====================================================================
...
source("dic_mrgsolve_model_en.R", local = TRUE)
...
## =====================================================================
ui <- navbarPage(
  title = "DIC QSP — Disseminated Intravascular Coagulation",
  theme = NULL,
  ...
  ## ------------------------------------------------------------------
  tabPanel(
    "1 · Patient & Precipitating Factors",
    sidebarLayout(
      sidebarPanel(
        width = 4,
        h4("Aetiology — this is where the two clocks are set"),
        radioButtons("aet", "Aetiology",
  ...
  ## ------------------------------------------------------------------
  tabPanel(
    "2 · Clock 1 · Acute-Phase Response",
    fluidRow(
