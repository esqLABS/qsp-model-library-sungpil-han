...
| File | Description |
|------|-------------|
| [`pv_qsp_model_en.dot`](pv_qsp_model_en.dot) | Graphviz mechanistic map (100+ nodes, 10 subgraph clusters) |
| [`pv_qsp_model_en.svg`](pv_qsp_model_en.svg) | Mechanistic map (SVG, scalable) |
| [`pv_qsp_model_en.png`](pv_qsp_model_en.png) | Mechanistic map (PNG, 150 dpi) |
| [`pv_mrgsolve_model_en.R`](pv_mrgsolve_model_en.R) | mrgsolve ODE model (16 compartments, 6 scenarios) |
| [`pv_shiny_app_en.R`](pv_shiny_app_en.R) | Interactive Shiny dashboard (7 tabs) |
...
[![PV QSP Mechanistic Map](pv_qsp_model_en.png)](pv_qsp_model_en.svg)
...
# Run mrgsolve model
source("pv_mrgsolve_model_en.R")

# Launch Shiny app
shiny::runApp("pv_shiny_app_en.R")
```
