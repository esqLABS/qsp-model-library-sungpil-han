...
##  Severe traumatic brain injury quantitative systems pharmacology model
## =============================================================================
##
...
##  pure-Python reference implementation `tbi_reference_model_en.py`, whose
##  committed output `tbi_reference_output_en.txt` is the source of every number
##  quoted in README_en.md.  The Python version is the one that has been run; if
...
##  scenarios produce are reproduced, with commentary, in tbi_reference_output_en.txt
