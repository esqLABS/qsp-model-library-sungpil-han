...
================================================================================
 ...
 Traumatic brain injury quantitative systems pharmacology model : reference implementation
================================================================================

WHY THIS FILE EXISTS
--------------------
Every number quoted in README_en.md, in the mechanistic map annotations and in the
mrgsolve model header is produced by RUNNING THIS FILE.  Nothing is asserted
from memory.  The committed transcript `tbi_reference_output_en.txt` is the
verbatim stdout of
