#!/usr/bin/env python3
"""Build onfh_references_en.md from PubMed.
...
def main():
    ...
    lines = []
    lines.append("# Osteonecrosis of the Femoral Head (ONFH) — references")
    lines.append("")
    ...
    for section in order:
        ...
        lines.append("")
    open("onfh_references_en.md", "w").write("\n".join(lines) + "\n")
    print(f"wrote onfh_references_en.md with {total} references")
