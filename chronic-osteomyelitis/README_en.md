...
|---|---|---|
| Mechanistic map | [`com_qsp_model_en.dot`](com_qsp_model_en.dot) · [SVG](com_qsp_model_en.svg) · [PNG](com_qsp_model_en.png) | **158 nodes · 260 edges · 15 subgraphs** |
| mrgsolve model | [`com_mrgsolve_model_en.R`](com_mrgsolve_model_en.R) | **47 ODEs · 2 systemic drugs + 1 local depot · 5 bacterial subpopulations · 14 scenarios** |
| Shiny app | [`com_shiny_app_en.R`](com_shiny_app_en.R) | **10 tabs** |
| References | [`com_references_en.md`](com_references_en.md) | **85 papers (every one confirmed by PubMed lookup)** |
...
`com_qsp_model_en.dot` (158 nodes · 260 edges)
...
`Rscript -e 'options(com.autorun = TRUE); source("com_mrgsolve_model_en.R")'`
...
dot -Tsvg com_qsp_model_en.dot -o com_qsp_model_en.svg
dot -Tpng -Gdpi=150 com_qsp_model_en.dot -o com_qsp_model_en.png

# structural diagnostics + the 14 scenarios + the full duration sweep
Rscript -e 'options(com.autorun = TRUE); source("com_mrgsolve_model_en.R")'

# an individual scenario
Rscript -e 'source("com_mrgsolve_model_en.R"); summarise_scn(scn04())'

# Shiny dashboard (10 tabs)
Rscript -e 'shiny::runApp("com_shiny_app_en.R", port = 8080)'
```
...
[`com_references_en.md`](com_references_en.md), and the
