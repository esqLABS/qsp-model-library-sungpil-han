...
| Deliverable | File |
|---|---|
| 🗺️ Mechanistic map (DOT) | [`adeno_qsp_model_en.dot`](adeno_qsp_model_en.dot) |
| 🖼️ Map (SVG)             | [`adeno_qsp_model_en.svg`](adeno_qsp_model_en.svg) |
| 🖼️ Map (PNG, 150 dpi)    | [`adeno_qsp_model_en.png`](adeno_qsp_model_en.png) |
| ⚙️ mrgsolve ODE model     | [`adeno_mrgsolve_model_en.R`](adeno_mrgsolve_model_en.R) |
| 📊 Shiny dashboard        | [`adeno_shiny_app.R`](adeno_shiny_app.R) |
| 📚 References             | [`adeno_references_en.md`](adeno_references_en.md) |
...
* **Drug PK (8 drugs, 16 compartments)** — relugolix-CT, elagolix, leuprolide
  ...
  tranexamic acid (literature PK anchors in `adeno_references_en.md`).
...
dot -Tsvg adeno_qsp_model_en.dot -o adeno_qsp_model_en.svg
dot -Tpng -Gdpi=150 adeno_qsp_model_en.dot -o adeno_qsp_model_en.png
```
...
install.packages(c("mrgsolve","dplyr","tidyr","ggplot2","shiny",
                   "shinydashboard","DT"))
library(mrgsolve)
mod <- mread_cache("adeno_mrgsolve_model_en.R")
