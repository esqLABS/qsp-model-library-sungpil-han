...
| File | Contents |
|------|------|
| [`sbe_qsp_model_en.dot`](sbe_qsp_model_en.dot) | Mechanistic map source — **145 nodes · 21 clusters · 245 edges** |
| [`sbe_qsp_model_en.svg`](sbe_qsp_model_en.svg) | Zoomable vector map |
| [`sbe_qsp_model_en.png`](sbe_qsp_model_en.png) | 150 dpi raster |
| [`sbe_mrgsolve_model_en.R`](sbe_mrgsolve_model_en.R) | **50-ODE** mrgsolve model + 27 scenarios + 7 analysis functions + virtual population |
| [`sbe_shiny_app_en.R`](sbe_shiny_app_en.R) | **15-tab** interactive dashboard |
| [`sbe_reference_model_en.py`](sbe_reference_model_en.py) | Standalone Python implementation (for verification, see below) |
| [`sbe_reference_output_en.txt`](sbe_reference_output_en.txt) | Run log of that implementation — **the source of every number in this README** |
| [`sbe_scenario_results_en.json`](sbe_scenario_results_en.json) | Full results for all 27 scenarios (machine-readable) |
| [`sbe_population_results.json`](sbe_population_results.json) | Results for the 6 population arms (machine-readable) |
| [`sbe_references_en.md`](sbe_references_en.md) | **145 references** retrieved directly from PubMed, in 26 sections |
...
those results. `sbe_mrgsolve_model_en.R` and `sbe_reference_model_en.py` are identical
...
Every table below is transcribed verbatim from `sbe_reference_output_en.txt`.
...
```r
# mrgsolve model
source("sbe_mrgsolve_model_en.R")
...
shiny::runApp("sbe_shiny_app_en.R")
```

```bash
# standalone Python verification implementation (full reproduction without R)
python3 sbe_reference_model_en.py     # → sbe_reference_output_en.txt

# render the mechanistic map
dot -Tsvg sbe_qsp_model_en.dot -o sbe_qsp_model_en.svg
dot -Tpng -Gdpi=150 sbe_qsp_model_en.dot -o sbe_qsp_model_en.png
```
...
[`sbe_references_en.md`](sbe_references_en.md).
