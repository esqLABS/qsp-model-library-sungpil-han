...
##  Snakebite envenoming (venom poisoning) + antivenom — 50-ODE quantitative systems pharmacology model
## =============================================================================
##
...
##  (`sbe_reference_model_en.py`) and actually integrated.  All numbers quoted in
##  README_en.md come from that run (`sbe_reference_output_en.txt`).  The two
...
// It is a MODEL PARAMETER, not a measured potency — see sbe_references_en.md.
...
SNAKES <- list(
  "Daboia russelii (Sri Lanka)" = list(
    ko = "Russell's viper", VDOSE = 63, F_SVMP = 0.28, F_SVSP = 0.14, F_PLA2 = 0.34,
    F_TFTX = 0.01, F_PRE = 0.09, F_MYO = 0.50, F_LOC = 0.30, KOFFM = 1.00, F_LEAK = 1.00),
  "Echis ocellatus" = list(
    ko = "West African carpet viper", VDOSE = 22, F_SVMP = 0.68, F_SVSP = 0.05, F_PLA2 = 0.12,
    F_TFTX = 0.00, F_PRE = 0.00, F_MYO = 0.10, F_LOC = 0.55, KOFFM = 1.00, F_LEAK = 0.60),
  "Naja naja" = list(
    ko = "Indian cobra", VDOSE = 40, F_SVMP = 0.10, F_SVSP = 0.02, F_PLA2 = 0.28,
    F_TFTX = 0.55, F_PRE = 0.05, F_MYO = 0.60, F_LOC = 1.30, KOFFM = 1.00, F_LEAK = 0.35),
  "Bungarus caeruleus" = list(
    ko = "Indian krait", VDOSE = 10, F_SVMP = 0.03, F_SVSP = 0.01, F_PLA2 = 0.66,
    F_TFTX = 0.20, F_PRE = 1.00, F_MYO = 0.05, F_LOC = 0.03, KOFFM = 0.15, F_LEAK = 0.05),
  "Crotalus atrox" = list(
    ko = "Western diamondback rattlesnake", VDOSE = 55, F_SVMP = 0.42, F_SVSP = 0.14, F_PLA2 = 0.08,
    F_TFTX = 0.00, F_PRE = 0.03, F_MYO = 0.30, F_LOC = 0.70, KOFFM = 1.00, F_LEAK = 0.70),
  "Bothrops asper" = list(
    ko = "Central American lancehead", VDOSE = 50, F_SVMP = 0.50, F_SVSP = 0.06, F_PLA2 = 0.30,
    F_TFTX = 0.00, F_PRE = 0.02, F_MYO = 0.80, F_LOC = 1.50, KOFFM = 1.00, F_LEAK = 0.85),
  "Bitis arietans" = list(
    ko = "Puff adder", VDOSE = 90, F_SVMP = 0.62, F_SVSP = 0.04, F_PLA2 = 0.16,
    F_TFTX = 0.00, F_PRE = 0.00, F_MYO = 0.50, F_LOC = 1.30, KOFFM = 1.00, F_LEAK = 1.10),
  "Dry bite" = list(
    ko = "Dry bite", VDOSE = 0, F_SVMP = 0, F_SVSP = 0, F_PLA2 = 0,
...
# the same 27 that `sbe_reference_model_en.py` integrates; every number quoted in
# README_en.md comes from that run.
SCENARIOS <- list(
