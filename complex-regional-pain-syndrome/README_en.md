...
| Deliverable | File |
|---|---|
| 🗺️ Mechanistic map (DOT, 20 clusters · 178 nodes · 263 edges) | [`crps_qsp_model_en.dot`](crps_qsp_model_en.dot) |
| 🖼️ Map (SVG) | [`crps_qsp_model_en.svg`](crps_qsp_model_en.svg) |
| 🖼️ Map (PNG, 150 dpi) | [`crps_qsp_model_en.png`](crps_qsp_model_en.png) |
| ⚙️ mrgsolve ODE model (34 ODEs · 9 scenarios · 10 analysis functions) | [`crps_mrgsolve_model_en.R`](crps_mrgsolve_model_en.R) |
| 📊 Shiny dashboard (8 tabs) | [`crps_shiny_app_en.R`](crps_shiny_app_en.R) |
| 🔬 Independent implementation for verification (numpy/scipy) | [`crps_reference_check.py`](crps_reference_check.py) |
| 📚 References (70, with PubMed links) | [`crps_references_en.md`](crps_references_en.md) |
...
![CRPS QSP map](crps_qsp_model_en.png)
...
> in the last table of [`crps_references_en.md`](crps_references_en.md).
...
library(mrgsolve)
mod <- mread("crps_mrgsolve_model_en.R")
e   <- mod@envir
...
shiny::runApp("crps_shiny_app_en.R")
```
...
# --- rendering the map ---
dot -Tsvg crps_qsp_model_en.dot -o crps_qsp_model_en.svg
dot -Tpng -Gdpi=150 crps_qsp_model_en.dot -o crps_qsp_model_en.png
```
