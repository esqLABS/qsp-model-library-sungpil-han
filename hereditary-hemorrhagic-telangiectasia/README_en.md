...
| Deliverable | File |
|--------|------|
| Mechanistic map (203 nodes · 22 clusters) | [`hht_qsp_model_en.dot`](hht_qsp_model_en.dot) · [`svg`](hht_qsp_model_en.svg) · [`png`](hht_qsp_model_en.png) |
| mrgsolve ODE model (57 states · 18 scenarios) | [`hht_mrgsolve_model_en.R`](hht_mrgsolve_model_en.R) |
| Shiny dashboard (10 tabs) | [`hht_shiny_app_en.R`](hht_shiny_app_en.R) |
| References (96 papers · each PMID individually confirmed) | [`hht_references_en.md`](hht_references_en.md) |
...
#    dot -Tsvg hht_qsp_model_en.dot -o hht_qsp_model_en.svg
#    dot -Tpng -Gdpi=150 hht_qsp_model_en.dot -o hht_qsp_model_en.png
...
shiny::runApp("hht_shiny_app_en.R")
```
...
96 papers, every PMID individually confirmed → [`hht_references_en.md`](hht_references_en.md)
