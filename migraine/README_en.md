...
| File | Description |
|------|------|
| [mgr_qsp_model.dot](mgr_qsp_model.dot) | Graphviz mechanistic map source (100+ nodes, 12 subgraph clusters) |
| [mgr_qsp_model.svg](mgr_qsp_model.svg) | SVG vector image (scalable) |
| [mgr_qsp_model.png](mgr_qsp_model.png) | PNG raster image (150 dpi) |
| [mgr_mrgsolve_model.R](mgr_mrgsolve_model.R) | mrgsolve ODE model (18 compartments, 7 scenarios) |
| [mgr_shiny_app.R](mgr_shiny_app.R) | Shiny dashboard (6 tabs) |
| [mgr_references.md](mgr_references.md) | 50 references (including PubMed links) |
