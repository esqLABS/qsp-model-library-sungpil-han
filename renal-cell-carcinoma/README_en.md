...
| File | Content |
|------|------|
| [`rcc_qsp_model.dot`](rcc_qsp_model.dot) | Graphviz mechanistic map (125+ nodes, 11 clusters) |
| [`rcc_qsp_model.svg`](rcc_qsp_model.svg) | SVG vector map |
| [`rcc_qsp_model.png`](rcc_qsp_model.png) | PNG thumbnail (150 dpi) |
| [`rcc_mrgsolve_model.R`](rcc_mrgsolve_model.R) | mrgsolve ODE model (18 compartments, 7 treatment scenarios) |
| [`rcc_shiny_app.R`](rcc_shiny_app.R) | 7-tab Shiny interactive dashboard |
| [`rcc_references.md`](rcc_references.md) | 60 PubMed references (14 sections) |
