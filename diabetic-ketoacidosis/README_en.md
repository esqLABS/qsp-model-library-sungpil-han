...
| File | Content |
|------|------|
| [`dka_qsp_model.dot`](dka_qsp_model.dot) | Mechanistic map source — 218 nodes, 297 edges, 19 clusters |
| [`dka_qsp_model.svg`](dka_qsp_model.svg) · [`dka_qsp_model.png`](dka_qsp_model.png) | Rendered map (SVG vector / PNG 150 dpi) |
| [`dka_mrgsolve_model.R`](dka_mrgsolve_model.R) | mrgsolve model — 42 ODEs, a closed-loop protocol executor, 12 scenarios |
| [`dka_shiny_app.R`](dka_shiny_app.R) | Shiny dashboard — 11 tabs |
| [`dka_references_en.md`](dka_references_en.md) | 132 references, classified by section, each noting which part of the model it supports |
| [`dka_reference_check.py`](dka_reference_check.py) | An independent **reimplementation** of the same 42 equations (pure standard-library Python, RK4) |
| [`dka_reference_output.txt`](dka_reference_output.txt) | The complete output of the script above — **the source of every number below** |
