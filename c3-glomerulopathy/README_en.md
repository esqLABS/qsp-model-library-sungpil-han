...
| Deliverable | File |
|---|---|
| 🗺️ Mechanistic map (DOT) | [`c3g_qsp_model_en.dot`](c3g_qsp_model_en.dot) |
| 🖼️ Map (SVG)             | [`c3g_qsp_model_en.svg`](c3g_qsp_model_en.svg) |
| 🖼️ Map (PNG, 150 dpi)    | [`c3g_qsp_model_en.png`](c3g_qsp_model_en.png) |
| ⚙️ mrgsolve ODE model     | [`c3g_mrgsolve_model.R`](c3g_mrgsolve_model.R) |
| 📊 Shiny dashboard        | [`c3g_shiny_app_en.R`](c3g_shiny_app_en.R) |
| 📚 References             | [`c3g_references_en.md`](c3g_references_en.md) |
...
dot -Tsvg c3g_qsp_model_en.dot -o c3g_qsp_model_en.svg
dot -Tpng -Gdpi=150 c3g_qsp_model_en.dot -o c3g_qsp_model_en.png
```
...
shiny::runApp("c3g_shiny_app_en.R")
```
