...
#  ---------------------------------------------------------------------------
#  Gestational diabetes mellitus QSP model · mrgsolve (31 ODEs, maternal–placental–fetal triad)
#
...
#  gdm_references_en.md, or (ii) derived by hand from a published steady-state
