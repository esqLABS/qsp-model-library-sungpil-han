...
##  parameter names and is the numerical source of truth for README_en.md.  The
...
##
##  Calibration, misses and uncalibrated guesses are documented in README_en.md
##  section "Model calibration" and in section 12 of inph_model_report.txt.  In short:
...
void hydro(HYD &o,
  ...
  for (int up = 0; up < 2; ++up) {
    ...
    // NOT converge for a 40 mL tap; see the defect list in README_en.md.)
