# Gastroparesis — QSP Model

[![Mechanistic Map](gp_qsp_model_en.png)](gp_qsp_model_en.svg)

---

## Disease Overview

**Gastroparesis** (delayed gastric emptying) is a chronic gastric motility disorder defined by objectively delayed gastric emptying in the absence of mechanical obstruction. The hallmark is reduced gastric emptying rate resulting in symptoms of nausea, vomiting, early satiety, bloating, and postprandial fullness.
...
### 1. Mechanistic Map (`gp_qsp_model_en.dot/.svg/.png`)
...
### 2. mrgsolve ODE Model (`gp_mrgsolve_model_en.R`)
...
| File | Description |
|------|-------------|
| `gp_qsp_model_en.dot` | Graphviz mechanistic map source |
| `gp_qsp_model_en.svg` | Vector graphic (interactive) |
| `gp_qsp_model_en.png` | Raster image (150 dpi) |
| `gp_mrgsolve_model_en.R` | ODE model with 16 compartments, 7 scenarios |
...
# mrgsolve model
library(mrgsolve)
source("gp_mrgsolve_model_en.R")  # runs all 7 scenarios & generates PDF plots
