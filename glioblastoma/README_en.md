...
| File | Description |
|------|------|
| [`gbm_qsp_model.dot`](gbm_qsp_model.dot) | Graphviz mechanistic map source (220+ nodes, 13 clusters) |
| [`gbm_qsp_model.svg`](gbm_qsp_model.svg) | Vector-format map (zoomable in browser) |
| [`gbm_qsp_model.png`](gbm_qsp_model.png) | Raster-format map (150 dpi) |
| [`gbm_mrgsolve_model.R`](gbm_mrgsolve_model.R) | mrgsolve ODE QSP model (18 compartments, 7 scenarios) |
| [`gbm_shiny_app.R`](gbm_shiny_app.R) | Shiny interactive dashboard (7 tabs) |
| [`gbm_references_en.md`](gbm_references_en.md) | 60+ references (13 sections) |
