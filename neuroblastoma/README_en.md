...
| File | Contents |
|------|------|
| [`nb_qsp_model.dot`](nb_qsp_model.dot) | Mechanistic map source — **162 nodes · 247 edges · 14 clusters** |
| [`nb_qsp_model.svg`](nb_qsp_model.svg) / [`.png`](nb_qsp_model.png) | Rendered map (`dot -Tpng -Gdpi=150`) |
| [`nb_mrgsolve_model.R`](nb_mrgsolve_model.R) | **46-ODE** mrgsolve model + regimen builder + 9 scenarios + virtual cohort |
| [`nb_shiny_app_en.R`](nb_shiny_app_en.R) | **9-tab** Shiny dashboard |
| [`nb_references_en.md`](nb_references_en.md) | **79 references** (every PMID checked against the PubMed API) |
...
Rscript -e 'shiny::runApp("nb_shiny_app_en.R")'
```
...
```r
shiny::runApp("nb_shiny_app_en.R")
```
...
79 references: [`nb_references_en.md`](nb_references_en.md)
