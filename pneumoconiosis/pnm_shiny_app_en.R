...
# Pneumoconiosis Quantitative Systems Pharmacology Dashboard
#
# Tabs:
#   1. Patient Profile & Exposure History
#   2. PK Simulation (Drug PK — NAC, Pirfenidone, Nintedanib, Tetrandrine)
#   3. PD Key Biomarkers (Cytokines, Oxidative Stress, Fibrotic Signaling)
#   4. Clinical Endpoints (FVC, DLCO, mPAP, KL-6, Dyspnea)
#   5. Scenario Comparison
#   6. Biomarkers & Virtual Population
################################################################################
