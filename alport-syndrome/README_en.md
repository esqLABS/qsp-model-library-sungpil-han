...
| Deliverable | File |
|---|---|
| 🗺️ Mechanistic map (DOT) | [`alp_qsp_model_en.dot`](alp_qsp_model_en.dot) |
| 🖼️ Map (SVG)             | [`alp_qsp_model_en.svg`](alp_qsp_model_en.svg) |
| 🖼️ Map (PNG, 150 dpi)    | [`alp_qsp_model_en.png`](alp_qsp_model_en.png) |
| ⚙️ mrgsolve ODE model     | [`alp_mrgsolve_model.R`](alp_mrgsolve_model.R) |
| 📊 Shiny dashboard        | [`alp_shiny_app_en.R`](alp_shiny_app_en.R) |
| 📚 References             | [`alp_references_en.md`](alp_references_en.md) |
...
dot -Tsvg alp_qsp_model_en.dot -o alp_qsp_model_en.svg
dot -Tpng -Gdpi=150 alp_qsp_model_en.dot -o alp_qsp_model_en.png
```
...
shiny::runApp("alp_shiny_app_en.R")
```
