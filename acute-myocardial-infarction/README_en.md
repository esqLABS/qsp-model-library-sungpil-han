...
<p align="center">
  <a href="ami_qsp_model_en.svg">
    <img src="ami_qsp_model_en.png" width="900" alt="AMI QSP mechanistic map">
  </a><br>
  <sub><a href="ami_qsp_model_en.svg">View the full-resolution SVG</a> · 246 nodes · 409 edges · 16 clusters (15 mechanistic + 1 legend)</sub>
</p>
...
[`ami_reference_check.py`](ami_reference_check.py),
and the full output is in
[`ami_reference_output.txt`](ami_reference_output.txt).
...
| File | Contents |
|---|---|
| [`ami_qsp_model_en.dot`](ami_qsp_model_en.dot) | Mechanistic map source — 16 clusters · 246 nodes · 409 edges |
| [`ami_qsp_model_en.svg`](ami_qsp_model_en.svg) / [`.png`](ami_qsp_model_en.png) | The rendered map (`dot -Tsvg` / `dot -Tpng -Gdpi=150`) |
| [`ami_mrgsolve_model.R`](ami_mrgsolve_model.R) | mrgsolve model — **82 ODEs**, 5 transmural layers, 13 PK compartments, 7 reference scenarios |
| [`ami_reference_check.py`](ami_reference_check.py) | numpy/scipy reimplementation — **the source of the numbers**. Regenerates every figure without R |
| [`ami_reference_output.txt`](ami_reference_output.txt) | The full output of that script (16 experiments) |
| [`ami_shiny_app_en.R`](ami_shiny_app_en.R) | Shiny dashboard — 11 tabs |
| [`ami_references_en.md`](ami_references_en.md) | 105 references + a table of **where the model disagrees with the literature** |

```bash
python3 ami_reference_check.py          # all experiments
python3 ami_reference_check.py 2 8      # experiments 2 and 8 only
dot -Tsvg ami_qsp_model_en.dot -o ami_qsp_model_en.svg
```
...
> fitted away —
> [`ami_references_en.md`](ami_references_en.md) §14.
...
shiny::runApp("ami_shiny_app_en.R")
```
...
in [`ami_references_en.md`](ami_references_en.md)
§14–15.
