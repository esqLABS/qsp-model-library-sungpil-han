...
| File | Description |
|------|------|
| [fsgs_qsp_model.dot](fsgs_qsp_model.dot) | Graphviz mechanistic map source (approximately 143 nodes / 12 clusters) |
| [fsgs_qsp_model.svg](fsgs_qsp_model.svg) | SVG vector image (scalable) |
| [fsgs_qsp_model.png](fsgs_qsp_model.png) | PNG image (150 dpi) |
| [fsgs_mrgsolve_model.R](fsgs_mrgsolve_model.R) | mrgsolve ODE model (approximately 23 compartments / 6 treatment scenarios) |
| [fsgs_shiny_app.R](fsgs_shiny_app.R) | Shiny dashboard |
| [fsgs_references.md](fsgs_references.md) | References (approximately 67 articles, PubMed links) |
...
For detailed citations, see [fsgs_references.md](fsgs_references.md) (approximately 67 articles).
