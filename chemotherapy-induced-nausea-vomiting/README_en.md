...
| Deliverable | File |
|--------|------|
| 🗺️ Mechanistic map | [`cinv_qsp_model.dot`](cinv_qsp_model.dot) · [SVG](cinv_qsp_model.svg) · [PNG](cinv_qsp_model.png) — 220 nodes / 335 edges / 25 clusters |
| ⚙️ mrgsolve model | [`cinv_mrgsolve_model.R`](cinv_mrgsolve_model.R) — 81 ODEs, time unit = hour, 37 scenarios |
| 📊 Shiny dashboard | [`cinv_shiny_app.R`](cinv_shiny_app.R) — 15 tabs |
| 📚 References | [`cinv_references_en.md`](cinv_references_en.md) — 163 entries / 162 unique PMIDs (every one looked up and verified) |
