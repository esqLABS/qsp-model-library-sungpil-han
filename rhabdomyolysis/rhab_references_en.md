...
This is the 80-reference basis for the structure and parameters of this QSP model. Every PubMed identifier (PMID) was looked up via NCBI E-utilities to confirm the title, journal, and year; none was estimated or fabricated.

All 80 PubMed identifiers below were resolved through the NCBI E-utilities API and their titles, journals and years verified against the returned records; none were reconstructed from memory. Where a citation supports a specific parameter or structural choice in `rhab_mrgsolve_model_en.R`, the connection is stated in the section preamble rather than claimed for individual papers.

---

## A. Definitions, epidemiology and clinical spectrum
...
## B. Mechanisms of myoglobin nephrotoxicity
...
## D. Renal vasoconstriction and ischaemia
...
## E. Fluid resuscitation, crush syndrome and disaster nephrology
...
## G. Crystalloid choice and chloride load
...
## H. Marker kinetics — the two clocks
...
## J. Compartment syndrome and fasciotomy
...
## L. Cause-specific aetiology — drugs, exertion, genetics
...
## M. Prediction scores, outcomes and recovery
...
## N. Quantitative modelling methodology
...
This model set its parameters using the **central tendency** of the literature above, rather than fitting to any specific patient dataset. The clinical anchors the model was calibrated to reproduce are as follows.

| Anchor | Source section | Model output |
|---|---|---|
| Peak CK in severe crush injury in the tens of thousands of U/L, peaking at 24–72 h | A, H | 63,900 U/L @ 38–39 h |
| Myoglobin half-life approximately 2–3 h, early peak | H | Peak 11.8 h, t½ approximately 2.4 h |
| CK half-life approximately 36–48 h | H | 36 h (set value), peak delayed to 25.7 h |
| Starting fluids at the scene results in almost no renal failure | E | KDIGO 1, eGFR d90 113.8 |
| A 24-hour delay produces dialysis-requiring AKI | E | KDIGO 3, anuria 14 h, McMahon 11 |
| No detectable benefit from adding bicarbonate on top of adequate fluids | F | Absolute benefit 43 → 18 units (100 → 1000 mL/h) |
| Mannitol 100 g/day is neutral; cumulative high dose is nephrotoxic | F | Creatinine 2.17 vs 2.15 / 5.18 |
| K⁺ 7–9 mmol/L in untreated crush injury | I | 8.07 mmol/L |
| Rebound hypercalcaemia during recovery | I | Ionised Ca 0.88 → 1.41 mmol/L |
| Compartment pressure ΔP < 30 mmHg is the fasciotomy threshold | J | ΔP gate centred at 30 mmHg |
| High-cutoff-membrane CVVH has limited myoglobin clearance benefit | K | Only about 1/10 of the total benefit is from Mb removal |
| Renal recovery from rhabdomyolysis-induced AKI is relatively good | M | eGFR d90 84.8–113.8 |

Scenarios that fail to meet the anchors, or that are deliberately exaggerated (mannitol overdose, no fasciotomy performed, etc.), are documented in the CALIBRATION NOTES at the bottom of `rhab_mrgsolve_model_en.R` and in the limitations section of `README_en.md`.
