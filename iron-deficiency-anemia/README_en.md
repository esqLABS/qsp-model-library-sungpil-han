...
| Deliverable | File |
|---|---|
| 🗺️ Mechanistic map (150 nodes · 13 clusters · 225 edges) | [`ida_qsp_model.dot`](ida_qsp_model.dot) · [SVG](ida_qsp_model.svg) · [PNG](ida_qsp_model.png) |
| ⚙️ mrgsolve ODE model (37 compartments · 122 parameters · 15 scenarios) | [`ida_mrgsolve_model_en.R`](ida_mrgsolve_model_en.R) |
| 📊 Shiny dashboard (8 tabs) | [`ida_shiny_app_en.R`](ida_shiny_app_en.R) |
| 📚 References (69 PubMed links, all verified) | [`ida_references_en.md`](ida_references_en.md) |
| 🔁 Independent-verification Python reference implementation (no dependencies) | [`ida_reference_model.py`](ida_reference_model.py) |
...
[`ida_reference_model.py`](ida_reference_model.py). The two
...
Rscript -e 'options(ida.report=TRUE); source("ida_mrgsolve_model_en.R")'

# Interactive dashboard (8 tabs)
Rscript -e 'shiny::runApp("ida_shiny_app_en.R")'
...
sections of [`ida_references_en.md`](ida_references_en.md). In summary,
