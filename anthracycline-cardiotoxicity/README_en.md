...
| File | Contents |
|------|------|
| [`aic_qsp_model_en.dot`](aic_qsp_model_en.dot) · [`.svg`](aic_qsp_model_en.svg) · [`.png`](aic_qsp_model_en.png) | Mechanistic map — 18 clusters · 174 nodes · 241 edges |
| [`aic_mrgsolve_model_en.R`](aic_mrgsolve_model_en.R) | mrgsolve QSP model — 32 ODEs · 14 scenarios · 11 analysis functions |
| [`aic_shiny_app_en.R`](aic_shiny_app_en.R) | Shiny dashboard — 8 tabs |
| [`aic_references_en.md`](aic_references_en.md) | 62 references (PMIDs verified) |
| [`aic_reference_check.py`](aic_reference_check.py) | Independent numpy/RK4 transcription + virtual population — **source of every figure below** |
| [`aic_reference_check_output.txt`](aic_reference_check_output.txt) | Full run output of the script above (A0–A11) |
