...
| Deliverable | File |
|--------|------|
| 🗺️ Mechanistic map | [`ctcl_qsp_model_en.dot`](ctcl_qsp_model_en.dot) · [SVG](ctcl_qsp_model_en.svg) · [PNG](ctcl_qsp_model_en.png) — 187 nodes / 273 edges / 21 clusters |
| ⚙️ mrgsolve model | [`ctcl_mrgsolve_model.R`](ctcl_mrgsolve_model.R) — 67 ODEs, time unit = day, 24 scenarios + 6 structural experiments |
| 📊 Shiny dashboard | [`ctcl_shiny_app_en.R`](ctcl_shiny_app_en.R) — 13 tabs |
| 📚 References | [`ctcl_references_en.md`](ctcl_references_en.md) — 181 PubMed articles (checked in full via E-utilities) |
