...
[`myp_mrgsolve_model.R`](myp_mrgsolve_model.R) — **52 ODE compartments**, time unit **days**.
...
[`myp_shiny_app_en.R`](myp_shiny_app_en.R) — **10 tabs**
...
| File | Role |
|---|---|
| [`myp_reference_model.py`](myp_reference_model.py) | Independent re-implementation of the slow (disease) part, RK4 |
| [`myp_atropine_pk.py`](myp_atropine_pk.py) | The fast atropine PK subsystem (linear and autonomous, so integrated separately) |
| [`myp_calibration.py`](myp_calibration.py) | Fitting of the 13 constants and a verification battery of 13 sections |
| [`myp_calibration_output.txt`](myp_calibration_output.txt) | The full output of the script above |
| [`myp_fetch_references.py`](myp_fetch_references.py) | The PubMed E-utilities lookup script |
...
[`myp_references_en.md`](myp_references_en.md) — **219 papers**.
