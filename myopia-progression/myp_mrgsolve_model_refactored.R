...
KA_MX    : 6.0    : 7-MX absorption rate (1/day)
CL_MX    : 96.0   : 7-MX clearance (L/day) [= KELMX(2.4/day) * V1_MX(40 L), original micro-constant form]
V1_MX    : 40     : 7-MX volume of distribution (L)
EMAX_MX  : 0.38   : maximal 7-MX suppression of the growth drive
EC50_MX  : 1.2    : 7-MX EC50 (umol/L)
GAMMA_MX : 1      : Hill coefficient, 7-MX growth-drive suppression (original had no explicit Hill term)
...
GUT_MX  : 7-methylxanthine, gut depot (umol)
CENT_MX : 7-methylxanthine, central/plasma compartment (umol) [C_MX = CENT_MX/V1_MX gives the umol/L concentration]
...
##      NOTE (refactored file only): the 7-MX gut depot compartment was
##      renamed MXGUT -> GUT_MX by this file's PK/PD refactor (see
##      myp_refactor_notes.md); any dosing event targeting "MXGUT" against
##      this file must be updated to target "GUT_MX" instead.
## =============================================================================
