...
| File | Description |
|------|------|
| [hcm_qsp_model.dot](hcm_qsp_model.dot) | Graphviz mechanistic map source (approximately 110+ nodes / 12 clusters) |
| [hcm_qsp_model.svg](hcm_qsp_model.svg) | SVG vector image (scalable) |
| [hcm_qsp_model.png](hcm_qsp_model.png) | PNG image (150 dpi) |
| [hcm_mrgsolve_model.R](hcm_mrgsolve_model.R) | mrgsolve ODE model (approximately 19 compartments / 5+ treatment scenarios) |
| [hcm_shiny_app.R](hcm_shiny_app.R) | Shiny dashboard |
| [hcm_references.md](hcm_references.md) | References (approximately 56 articles, PubMed links) |
...
For detailed citations, see [hcm_references.md](hcm_references.md) (approximately 56 articles).
