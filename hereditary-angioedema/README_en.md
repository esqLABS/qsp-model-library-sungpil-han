...
[![HAE QSP Mechanistic Map](hae_qsp_model_en.png)](hae_qsp_model_en.svg)
...
**File:** [`hae_qsp_model_en.dot`](hae_qsp_model_en.dot) → [`hae_qsp_model_en.svg`](hae_qsp_model_en.svg)
...
**File:** [`hae_mrgsolve_model_en.R`](hae_mrgsolve_model_en.R)
...
**File:** [`hae_shiny_app_en.R`](hae_shiny_app_en.R)
...
**File:** [`hae_references_en.md`](hae_references_en.md) — **58 citations** across 12 sections
...
fdp -Tsvg hae_qsp_model_en.dot -o hae_qsp_model_en.svg
fdp -Tpng -Gdpi=150 hae_qsp_model_en.dot -o hae_qsp_model_en.png
