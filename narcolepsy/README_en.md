...
| File | Description |
|------|------|
| [`narc_qsp_model.dot`](narc_qsp_model.dot) | Graphviz mechanistic map (source) |
| [`narc_qsp_model.svg`](narc_qsp_model.svg) | Vector graphic (zoomable) |
| [`narc_qsp_model.png`](narc_qsp_model.png) | Raster image (150 dpi) |
| [`narc_mrgsolve_model.R`](narc_mrgsolve_model.R) | mrgsolve ODE QSP model |
| [`narc_shiny_app_en.R`](narc_shiny_app_en.R) | Shiny interactive dashboard |
| [`narc_references_en.md`](narc_references_en.md) | References (35+ PubMed citations) |
