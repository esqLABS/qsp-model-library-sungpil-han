...
| File | Description |
|------|------|
| [pud_qsp_model.dot](pud_qsp_model.dot) | Graphviz mechanistic map source (approximately 174 nodes / 9 clusters) |
| [pud_qsp_model.svg](pud_qsp_model.svg) | SVG vector image (scalable) |
| [pud_qsp_model.png](pud_qsp_model.png) | PNG image (150 dpi) |
| [pud_mrgsolve_model_en.R](pud_mrgsolve_model_en.R) | mrgsolve ODE model (approximately 18 compartments / 5 treatment scenarios) |
| [pud_shiny_app.R](pud_shiny_app.R) | Shiny dashboard |
| [pud_references.md](pud_references.md) | References (approximately 55 articles, PubMed links) |
...
```r
library(mrgsolve)
mod <- mread("pud_mrgsolve_model_en.R")
...
## References
For detailed citations, see [pud_references.md](pud_references.md) (approximately 55 articles).
