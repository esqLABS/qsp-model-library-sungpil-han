...
## Tardive dyskinesia quantitative systems pharmacology model
##
...
## independent numpy/scipy transcription (td_reference_check_en.py), not
...
TD_run_all <- function() {
  ...
  cat("\n", strrep("=", 104), "\n",
      ...
      "See td_references_en.md for the calibration sources\n",
      "and td_reference_check_en.py for an independent numerical ",
...
if (!interactive() && !exists("TD_SKIP_RUN")) {
  ...
  ##  which is what td_shiny_app_en.R does)
  TD_run_all()
}
