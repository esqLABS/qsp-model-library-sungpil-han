...
# Tardive dyskinesia QSP model — independent verification implementation of the mrgsolve model
#
# This file is a numpy/scipy transcription of the SAME equations that appear in
# td_mrgsolve_model_en.R ($ODE block).  It exists so that every number quoted in
# README_en.md can be re-derived without R / mrgsolve installed.
#
