...
##
## The model itself lives in td_mrgsolve_model_en.R; this file only loads it
...
server <- function(input, output, session) {
  ...
  output$disclaim <- renderText(paste(
    ...
    "\nSee td_references_en.md for the literature list, and",
    "td_reference_check_en.py for independent numerical verification."))
}
