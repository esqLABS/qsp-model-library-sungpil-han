# Tardive Dyskinesia QSP Model — References

This is the list of literature used to build the mechanistic map of tardive dyskinesia (`td_qsp_model_en.dot`), the mrgsolve ODE model
(`td_mrgsolve_model_en.R`), and the Shiny dashboard (`td_shiny_app_en.R`).
72 articles in total.

> **Note on link format**: All links below are **PubMed search query URLs**.
> A mistyped PMID would cite an entirely different paper, so links that search by author, year, and title
> keywords were used instead. Where a model parameter is
> anchored to a specific reference, the correspondence is laid out in the CALIBRATION ANCHORS
> section at the top of `td_mrgsolve_model_en.R`.
>
> **Important**: Any figure in the README or model files marked "Model:" is
> a computed output of this model, not a literature value. The literature was used only
> as a basis for parameter calibration.

---

## 1. Diagnostic Criteria · Rating Scales
...
## 2. Pathophysiology (1) — D2 Receptor Supersensitivity Hypothesis
...
## 3. Pathophysiology (2) — Oxidative Stress · Structural Damage · Interneuron Loss
...
## 4. Striatal Microcircuitry · Basal Ganglia Loops
...
## 5. D2 Occupancy · Antipsychotic PK/PD
...
## 6. VMAT2 Inhibitors — Valbenazine
...
## 7. VMAT2 Inhibitors — Deutetrabenazine · Tetrabenazine
...
## 8. CYP2D6 · Pharmacogenetics · Exposure-Response
...
## 9. Causative Drug Strategies — Dose Reduction · Discontinuation · Switching
...
## 10. Adjunctive Therapy · Non-Pharmacological Treatment
...
## 11. Risk Factors · Special Populations
...
## 12. Guidelines · Comprehensive Reviews
...
## 13. QSP · Quantitative Modelling Methodology
