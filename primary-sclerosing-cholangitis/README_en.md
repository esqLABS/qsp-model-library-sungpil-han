...
| File | Description |
|------|------|
| [psc_qsp_model.dot](psc_qsp_model.dot) | Graphviz mechanistic map source (approximately 213 nodes / 11 clusters) |
| [psc_qsp_model.svg](psc_qsp_model.svg) | SVG vector image (scalable) |
| [psc_qsp_model.png](psc_qsp_model.png) | PNG image (150 dpi) |
| [psc_mrgsolve_model.R](psc_mrgsolve_model.R) | mrgsolve ODE model (approximately 27 compartments / 5 treatment scenarios) |
| [psc_shiny_app.R](psc_shiny_app.R) | Shiny dashboard |
| [psc_references.md](psc_references.md) | References (approximately 43 articles, PubMed links) |
...
## References
For detailed citations, see [psc_references.md](psc_references.md) (approximately 43 articles).
