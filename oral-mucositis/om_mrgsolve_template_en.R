...
#  Oral mucositis · chemotherapy / radiotherapy induced — quantitative systems pharmacology model
# =============================================================================
#
#  THE ONE IDEA
#  ------------
...
#  from the literature cited in om_references_en.md.  pot_mtx is a PLACEHOLDER:
