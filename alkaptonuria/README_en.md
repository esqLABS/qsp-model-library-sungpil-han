...
|---|---|---|
| 🗺️ Mechanistic map | [`aku_qsp_model.dot`](aku_qsp_model.dot) · [SVG](aku_qsp_model.svg) · [PNG](aku_qsp_model.png) | 221 nodes · 307 edges · 23 clusters |
| ⚙️ mrgsolve model | [`aku_mrgsolve_model.R`](aku_mrgsolve_model.R) | 60 ODEs · 137 parameters · 24 scenarios |
| 📊 Shiny dashboard | [`aku_shiny_app_en.R`](aku_shiny_app_en.R) | 12 tabs |
| 📚 References | [`aku_references_en.md`](aku_references_en.md) | 131 papers, every PMID verified |
...
shiny::runApp("aku_shiny_app_en.R")     # 12-tab dashboard
```
