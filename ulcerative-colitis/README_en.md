...
| File | Description |
|------|------|
| [uc_qsp_model.dot](uc_qsp_model.dot) | Graphviz mechanistic map source (approximately 422 nodes / 12 clusters) |
| [uc_qsp_model.svg](uc_qsp_model.svg) | SVG vector image (scalable) |
| [uc_qsp_model.png](uc_qsp_model.png) | PNG image (150 dpi) |
| [uc_mrgsolve_model.R](uc_mrgsolve_model.R) | mrgsolve ODE model (approximately 35 compartments / 6 treatment scenarios) |
| [uc_shiny_app.R](uc_shiny_app.R) | Shiny dashboard |
| [uc_references.md](uc_references.md) | References (approximately 47 articles, PubMed links) |
...
For detailed citations, see [uc_references.md](uc_references.md) (approximately 47 articles).
