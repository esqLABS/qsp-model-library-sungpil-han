...
##
##  Eight tabs:
##    1. Patient Profile      Patient & aetiology — where is the lesion?
##    2. GH PK             daily vs weekly exposure, free vs total, carrier pool
##    3. Signaling · IGF Axis     GHR / STAT5b / SOCS2 / IGF-1 / IGFBP-3 / ALS / free IGF-1
##    4. Growth Plate             resting-zone reserve, zones, senescence, fusion
##    5. Clinical Endpoints     height, height SDS, height velocity, bone age, near-adult height
##    6. Puberty · Sex Hormones     puberty, testosterone, oestradiol, GnRHa / aromatase inhibitor
##    7. Metabolism · Body Composition · Safety  fat/lean mass, HOMA-IR, IGF-1 SDS ceiling, free T4, ICP, ADA
##    8. Scenario Comparison       side-by-side comparison + summary table
##
  ...
  sidebarLayout(
    ...
    mainPanel(
      ...
      tabsetPanel(
        ...
        tabPanel("6. Puberty · Sex Hormones",
        ...
        tabPanel("7. Metabolism · Body Composition · Safety",
