...
([`ghd_qsp_model_en.dot`](ghd_qsp_model_en.dot)), the 42-ODE mrgsolve model
([`ghd_mrgsolve_model.R`](ghd_mrgsolve_model.R)) and the Shiny dashboard
([`ghd_shiny_app_en.R`](ghd_shiny_app_en.R)).
...
### 1. Guidelines, Consensus Statements and Major Reviews
...
### 2. Neuroendocrine Control of GH Secretion
...
### 3. GHR–JAK2–STAT5b Signal Transduction and the SOCS2 Brake
...
### 4. GH Resistance and the IGF System — Binding State Determines Bioactivity
...
### 5. Growth-Plate Biology — Proliferative Reserve and Senescence
...
### 6. Oestrogen and Epiphyseal Fusion
...
### 8. Glucocorticoid-Induced Growth Suppression
...
### 9. Daily Somatropin — Response Prediction and Dosing
...
### 11. rhIGF-1 (Mecasermin) — Recombinant IGF-1 for GH Insensitivity
...
### 12. Diagnosis: Provocation Testing and Biomarkers
...
### 13. Interactions with Other Pituitary Axes — Thyroid and Adrenal
...
### 14. Adjuvant Drugs — GnRH Analogues and Aromatase Inhibitors
...
### 16. Acquired GHD: Irradiation and Tumours
