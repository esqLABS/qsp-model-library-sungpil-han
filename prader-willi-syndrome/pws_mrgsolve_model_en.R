...
##  Prader-Willi syndrome — mrgsolve QSP model
##
...
- 64 ODEs. Time in DAYS from birth. Run `pws_reference_model.py` for the
  verified reference output that every number in README_en.md quotes.
...
// map in cluster 3 of pws_qsp_model_en.dot can be checked at run time
