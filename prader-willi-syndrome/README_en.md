...
| | |
|---|---|
| **Mechanistic map** | [`pws_qsp_model_en.svg`](pws_qsp_model_en.svg) · [`pws_qsp_model_en.dot`](pws_qsp_model_en.dot) — 223 nodes / 316 edges / 20 clusters |
| **mrgsolve model** | [`pws_mrgsolve_model_en.R`](pws_mrgsolve_model_en.R) — **64 ODEs**, 15 scenarios, 10 drugs |
| **Shiny app** | [`pws_shiny_app_en.R`](pws_shiny_app_en.R) — 10 tabs (mechanism drawn alongside the endpoints) |
| **References** | [`pws_references_en.md`](pws_references_en.md) — **357 papers**, every PMID looked up in PubMed |
| **Reference implementation** | [`pws_reference_model.py`](pws_reference_model.py) · [output](pws_reference_output.txt) — dependency-free Python RK4 |
| **Calibration and derived-quantity analysis** | [`pws_calibration.py`](pws_calibration.py) · [output](pws_calibration_output.txt) — all in closed form |

<a href="pws_qsp_model_en.svg"><img src="pws_qsp_model_en.png" width="820" alt="PWS QSP map"></a>
...
| File | Contents |
|---|---|
| [`pws_qsp_model_en.dot`](pws_qsp_model_en.dot) | Mechanistic map source (20 clusters, with reading-order comments) |
| [`pws_qsp_model_en.svg`](pws_qsp_model_en.svg) · [`.png`](pws_qsp_model_en.png) | Rendering (`dot -Tsvg` / `dot -Tpng -Gdpi=150`) |
| [`pws_mrgsolve_model_en.R`](pws_mrgsolve_model_en.R) | 64-ODE mrgsolve model + 15 scenario drivers |
| [`pws_shiny_app_en.R`](pws_shiny_app_en.R) | 10-tab dashboard (the mechanism tabs come before the endpoint tabs) |
| [`pws_reference_model.py`](pws_reference_model.py) | Dependency-free Python RK4 reference implementation |
| [`pws_reference_output.txt`](pws_reference_output.txt) | The source of every number in the document above |
| [`pws_calibration.py`](pws_calibration.py) | Closed-form derived quantities · branch structure · sensitivities |
| [`pws_calibration_output.txt`](pws_calibration_output.txt) | Its output |
| [`pws_references_en.md`](pws_references_en.md) | 357 papers, every PMID looked up in PubMed |
...
dot -Tsvg pws_qsp_model_en.dot -o pws_qsp_model_en.svg
dot -Tpng -Gdpi=150 pws_qsp_model_en.dot -o pws_qsp_model_en.png
```
...
- **Only three lines were calibrated** (`KGHRD`, `ECBMAX`/`EV1AMX`, `EDZMAX`). None of
  ...
  [`pws_references_en.md`](pws_references_en.md).
