...
| File | Description |
|------|------|
| [als_qsp_model.dot](als_qsp_model.dot) | Graphviz mechanistic map source (196+ nodes, 10 clusters) |
| [als_qsp_model.svg](als_qsp_model.svg) | SVG vector image (zoomable) |
| [als_qsp_model.png](als_qsp_model.png) | PNG raster image (150 dpi) |
| [als_mrgsolve_model.R](als_mrgsolve_model.R) | mrgsolve ODE model (26 compartments, 60+ parameters, 7 scenarios) |
| [als_shiny_app.R](als_shiny_app.R) | Shiny dashboard (6 tabs, plotly, DT) |
| [als_references.md](als_references.md) | 40 references (with PubMed links) |
