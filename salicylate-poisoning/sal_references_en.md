...
All PMIDs were confirmed by looking them up via the PubMed E-utilities.
...
## 2. Pharmacokinetics: Capacity-Limited Metabolism
...
## 3. Protein Binding Saturation — MULTIPLIER 1
...
## 4. pH Partition and Tissue Distribution — MULTIPLIER 2
...
### 4a. Intracellular pH Buffering — Why CO2 and HCO3 Are Not Symmetric
...
### 6a. The Danger of Mechanical Ventilation — the Central Experiment of This Model
...
## 7. Renal Handling and Urinary Alkalinisation
...
## 9. Decontamination and Delayed Absorption
...
## 10. CNS Injury and Neuroglycopenia
...
## 11. Ototoxicity — the Earliest Clinical Signal
...
## 12. Pulmonary Oedema and Other Organ Effects
...
## 13. Chronic Salicylism — the Same Molecule, a Different Disease
...
## 14. The Nomogram and the Failure of Measurement
...
## 16. Guidelines and Management Pathways
...
## 17. Cited but Not Confirmed in the PubMed Index

Listed separately for honesty. The two papers below are cited in the text, but their
PMIDs could not be confirmed by the E-utilities lookups above, so only the bibliographic details are given.
...
- mrgsolve: <https://mrgsolve.org/> — the ODE simulation engine used by `sal_mrgsolve_model_en.R`.
- Shiny: <https://shiny.posit.co/> — the dashboard framework used by `sal_shiny_app_en.R`.
...
| mg/dL → mmol/L | × 0.0724 |
| Therapeutic anti-inflammatory range | 150–300 mg/L (15–30 mg/dL) |
| Tinnitus threshold | approximately 200–300 mg/L |
| EXTRIP dialysis consideration (normal renal function) | > 900 mg/L (90 mg/dL, 6.6 mmol/L) |
| Aspirin → salicylate molar conversion | × 138.12 / 180.16 = 0.767 |
