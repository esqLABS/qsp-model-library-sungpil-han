...
##  11 tabs · driven by sal_mrgsolve_model_en.R
##
...
##  (sal_mrgsolve_model_en.R must be in the same directory; it is sourced on
...
source("sal_mrgsolve_model_en.R")
...
server <- function(input, output, session) {
  ...
  output$about <- renderUI(HTML('
    ...
    <ul>
      ...
      <li>Model: <code>sal_mrgsolve_model_en.R</code></li>
      ...
      <li>References: <code>sal_references_en.md</code> (all PMIDs verified by lookup on PubMed)</li>
    </ul>
    <h4>Limitations</h4>
