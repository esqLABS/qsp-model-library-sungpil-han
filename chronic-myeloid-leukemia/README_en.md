...
| [`cml_shiny_app_en.R`](cml_shiny_app_en.R) | Shiny interactive dashboard (6 tabs) |
| [`cml_references_en.md`](cml_references_en.md) | 60 PubMed-linked references |
...
See [`cml_references_en.md`](cml_references_en.md) for complete 60-reference bibliography.
