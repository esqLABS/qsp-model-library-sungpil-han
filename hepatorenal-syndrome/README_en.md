...
> Parent library → [../README_en.md](../README_en.md) · Category: Gastroenterology & Hepatobiliary / Renal
...
| File | Description |
|------|------|
| [hrs_qsp_model.dot](hrs_qsp_model.dot) | Graphviz mechanistic map source (~148 nodes / 15 clusters) |
| [hrs_qsp_model.svg](hrs_qsp_model.svg) | SVG vector image |
| [hrs_qsp_model.png](hrs_qsp_model.png) | PNG image (150 dpi) |
| [hrs_mrgsolve_model.R](hrs_mrgsolve_model.R) | mrgsolve ODE model (26 compartments / 10 scenarios) |
| [hrs_shiny_app.R](hrs_shiny_app.R) | Shiny dashboard (8 tabs) |
| [hrs_references.md](hrs_references.md) | References (82 entries, PubMed links) |
...
## References
[hrs_references.md](hrs_references.md) — 82 references including ICA-2015/2019, CONFIRM, REVERSE, OT-0401, ATTIRE, ANSWER, PREDICT, CANONIC.
