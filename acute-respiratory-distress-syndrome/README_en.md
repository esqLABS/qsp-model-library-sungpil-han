...
| Deliverable | File |
|---|---|
| Mechanistic map (DOT) | [`ards_qsp_model.dot`](ards_qsp_model.dot) |
| Map (SVG, full detail) | [`ards_qsp_model.svg`](ards_qsp_model.svg) |
| Map (PNG)              | [`ards_qsp_model.png`](ards_qsp_model.png) |
| mrgsolve ODE model     | [`ards_mrgsolve_model.R`](ards_mrgsolve_model.R) |
| Shiny dashboard        | [`ards_shiny_app.R`](ards_shiny_app.R) |
| References             | [`ards_references_en.md`](ards_references_en.md) |
