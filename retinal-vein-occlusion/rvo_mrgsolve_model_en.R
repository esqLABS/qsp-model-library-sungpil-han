...
#  Retinal vein occlusion (central/branch) macular oedema — an mrgsolve-based quantitative systems pharmacology model
# =============================================================================
#
...
#  for term in `rvo_reference_model_en.py`, which IS executed; the numbers quoted
#  in README_en.md come from that reference implementation and the captured log is
#  `rvo_reference_output_en.txt`.  If you find a discrepancy between the two files,
#  the Python file is the one that was run.
#
#  CALIBRATION TARGETS (see rvo_references_en.md for the citations)
#  ------------------------------------------------------------
...
#  class in rvo_reference_model_en.py.
# -----------------------------------------------------------------------------
