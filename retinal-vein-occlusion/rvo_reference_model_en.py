...
Retinal vein occlusion (central / branch) and metabolic macular oedema — INDEPENDENT PYTHON REFERENCE MODEL
===============================================================================

WHY THIS FILE EXISTS
--------------------
This build environment has no R runtime, so `rvo_mrgsolve_model_en.R` cannot be
...
Every number quoted in `README_en.md` is produced by running this file; the
captured log is `rvo_reference_output_en.txt` and the machine-readable results are
...
-------------------------------------------------------------------------------
CALIBRATION TARGETS (all from published trials; see rvo_references_en.md)
-------------------------------------------------------------------------------
...
# =============================================================================
# 11.  MAIN — produce every number quoted in README_en.md
# =============================================================================
...
def main():
    ...
    # ------------------------------------------------------------ write files
    with open(os.path.join(outdir, "rvo_reference_output_en.txt"), "w") as fh:
        fh.write("\n".join(log) + "\n")
    ...
    print(f"\nwrote rvo_reference_output_en.txt, rvo_scenario_results.json, "
