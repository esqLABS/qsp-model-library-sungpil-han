...
#
#  This file sources rvo_mrgsolve_model_en.R from the same directory for the model
...
# -----------------------------------------------------------------------------
#  Load the model. Everything below assumes rvo_mrgsolve_model_en.R has defined:
...
# -----------------------------------------------------------------------------
model_file <- "rvo_mrgsolve_model_en.R"
if (!file.exists(model_file)) {
  stop("rvo_mrgsolve_model_en.R must be in the working directory.")
}
local({
