...
| File | Description |
|------|------|
| [adpkd_qsp_model.dot](adpkd_qsp_model.dot) | Graphviz mechanistic map source (approximately 184 nodes / 10 clusters) |
| [adpkd_qsp_model.svg](adpkd_qsp_model.svg) | SVG vector image (scalable) |
| [adpkd_qsp_model.png](adpkd_qsp_model.png) | PNG image (150 dpi) |
| [adpkd_mrgsolve_model.R](adpkd_mrgsolve_model.R) | mrgsolve ODE model (approximately 19 compartments / multiple treatment scenarios) |
| [adpkd_shiny_app.R](adpkd_shiny_app.R) | Shiny dashboard |
| [adpkd_references.md](adpkd_references.md) | References (approximately 53 articles, PubMed links) |
...
For detailed citations, see [adpkd_references.md](adpkd_references.md) (approximately 53 articles).
