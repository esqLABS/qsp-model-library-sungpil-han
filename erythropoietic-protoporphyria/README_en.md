...
| File | Contents |
|------|------|
| [`epp_qsp_model.dot`](epp_qsp_model.dot) | Source of the mechanistic map — 14 clusters, 180 nodes, 238 edges |
| [`epp_qsp_model.svg`](epp_qsp_model.svg) · [`.png`](epp_qsp_model.png) | The renders (`dot -Tsvg` / `dot -Tpng -Gdpi=150`) |
| [`epp_mrgsolve_model.R`](epp_mrgsolve_model.R) | **37-ODE** mrgsolve model + 9 treatment scenarios |
| [`epp_shiny_app.R`](epp_shiny_app.R) | **9-tab** interactive dashboard |
| [`epp_references_en.md`](epp_references_en.md) | **78 references** (13 sections, title-based PubMed links) |
| [`epp_reference_check.py`](epp_reference_check.py) | Dependency-free pure-Python verification implementation (a 1:1 mirror of the `$ODE` block) |
| [`epp_reference_output.txt`](epp_reference_output.txt) | The complete output of that script — **the source of every number in this README** |
...
*QSP Disease Model Library · [top-level repository README](../README_en.md)*
