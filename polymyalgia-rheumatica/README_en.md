...
[![mrgsolve](https://img.shields.io/badge/ODE-22%20compartments%2C%207%20scenarios-green)](pmr_mrgsolve_model_en.R)
[![Shiny](https://img.shields.io/badge/Shiny-6%20tabs%20dashboard-orange)](pmr_shiny_app.R)
[![References](https://img.shields.io/badge/Refs-55%20PubMed%20citations-red)](pmr_references_en.md)
...
**File**: [`pmr_mrgsolve_model_en.R`](pmr_mrgsolve_model_en.R)
...
**File**: [`pmr_shiny_app.R`](pmr_shiny_app.R)
...
**File**: [`pmr_references_en.md`](pmr_references_en.md)
...
|---------|------|------|
| Mechanistic map | [`pmr_qsp_model.dot`](pmr_qsp_model.dot) · [`.svg`](pmr_qsp_model.svg) · [`.png`](pmr_qsp_model.png) | **130+ nodes, 12 clusters** |
| mrgsolve ODE | [`pmr_mrgsolve_model_en.R`](pmr_mrgsolve_model_en.R) | **22-compartment ODE, 7 treatment scenarios, VPop of 200** |
| Shiny app | [`pmr_shiny_app.R`](pmr_shiny_app.R) | **6 tabs** (patient profile · PK · inflammatory markers · disease activity · scenario comparison · biomarker explorer) |
| References | [`pmr_references_en.md`](pmr_references_en.md) | **55 PubMed citations** (12 sections) |
