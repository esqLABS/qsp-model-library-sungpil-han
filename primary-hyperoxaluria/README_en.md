...
|---|---|---|
| 🗺️ Mechanistic map | [`ph1_qsp_model.dot`](ph1_qsp_model.dot) · [SVG](ph1_qsp_model.svg) · [PNG](ph1_qsp_model.png) | 238 nodes · 21 clusters · 292 edges |
| ⚙️ mrgsolve ODE model | [`ph1_mrgsolve_model.R`](ph1_mrgsolve_model.R) | **73 ODEs** · 138 parameters · 34 scenarios · 16 diagnostics |
| 📊 Shiny dashboard | [`ph1_shiny_app.R`](ph1_shiny_app.R) | 11 tabs |
| 📚 References | [`ph1_references_en.md`](ph1_references_en.md) | **294 entries** (every PMID actually looked up and verified through the NCBI E-utilities) |
...
parameters" of
[`ph1_references_en.md`](ph1_references_en.md). In
summary:
