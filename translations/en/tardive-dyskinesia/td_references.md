...
This is the list of literature used to build the mechanistic map of tardive dyskinesia (`td_qsp_model.dot`), the mrgsolve ODE model
(`td_mrgsolve_model.R`), and the Shiny dashboard (`td_shiny_app.R`).
...
> section at the top of `td_mrgsolve_model.R`.
>
