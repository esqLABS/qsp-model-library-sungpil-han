...
##   3. Tumor Growth Dynamics
##   4. Clinical Endpoints — OS/PFS/ORR
  ...
  dashboardSidebar(
    ...
    sidebarMenu(
      ...
      menuItem("Drug PK", tabName = "pk",
               icon = icon("pills")),
      menuItem("Tumor Dynamics", tabName = "tumor",
               icon = icon("chart-line")),
      menuItem("Clinical Endpoints", tabName = "endpoints",
               icon = icon("heartbeat")),
      menuItem("Treatment Scenario Comparison", tabName = "scenarios",
               icon = icon("balance-scale")),
      menuItem("Biomarker Analysis", tabName = "biomarkers",
