...
| Deliverable | File |
|--------|------|
| 🗺️ Mechanistic map | [`rcc_qsp_model.dot`](rcc_qsp_model.dot) · [SVG](rcc_qsp_model.svg) · [PNG](rcc_qsp_model.png) |
| ⚙️ mrgsolve model | [`rcc_mrgsolve_model.R`](../../../refractory-chronic-cough/rcc_mrgsolve_model.R) — 69 compartments · 241 parameters · 25 scenarios · 14 diagnostics |
| 📊 Shiny dashboard | [`rcc_shiny_app.R`](../../../refractory-chronic-cough/rcc_shiny_app.R) — 10 tabs |
| 📚 References | [`rcc_references.md`](../../../refractory-chronic-cough/rcc_references.md) — 120 PubMed citations |
...
- The list of parameters without experimental support is set out in the final table of
  [`rcc_references.md`](../../../refractory-chronic-cough/rcc_references.md).
