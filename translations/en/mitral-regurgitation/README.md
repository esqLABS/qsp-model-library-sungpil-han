# Mitral Regurgitation — QSP Model
...
| file | what it is |
|---|---|
| [`mr_qsp_model.dot`](../../../mitral-regurgitation/mr_qsp_model.dot) · [SVG](../../../mitral-regurgitation/mr_qsp_model.svg) · [PNG](../../../mitral-regurgitation/mr_qsp_model.png) | mechanistic map: 187 nodes, 18 clusters, 305 edges |
| [`mr_mrgsolve_model.R`](../../../mitral-regurgitation/mr_mrgsolve_model.R) | 43-ODE mrgsolve model, 17 annotated scenarios |
| [`mr_shiny_app.R`](../../../mitral-regurgitation/mr_shiny_app.R) | 12-tab dashboard, one tab per denominator |
| [`mr_references.md`](../../../mitral-regurgitation/mr_references.md) | 116 references, every PMID resolved against PubMed programmatically |
| [`mr_python_reference.py`](../../../mitral-regurgitation/mr_python_reference.py) | the independent implementation — the source of every number below |
| [`mr_reference_output.txt`](../../../mitral-regurgitation/mr_reference_output.txt) | its verbatim output |
...
> **Disclaimer.** This model is a QSP model intended for educational and research
> purposes. It was built from published literature but has not been independently
> validated or certified, and must not be used directly for clinical
> decision-making, prescribing, or regulatory submission. In particular, this
> model's predictions regarding the indication and timing of mitral valve
> intervention are hypotheses, not clinical evidence, and must be read together
> with the fact that it does not reproduce the MITRA-FR result (see "Results 4"
> above).
