...
|---|---|---|
| 🗺️ Mechanistic map | [`hit_qsp_model.dot`](hit_qsp_model.dot) · [`.svg`](hit_qsp_model.svg) · [`.png`](hit_qsp_model.png) | **226 nodes · 22 clusters · 330+ edges** |
| ⚙️ mrgsolve ODE model | [`hit_mrgsolve_model.R`](../../../heparin-induced-thrombocytopenia/hit_mrgsolve_model.R) | **59 ODEs · 31 scenarios · 14 diagnostic analyses** |
| 📊 Shiny dashboard | [`hit_shiny_app.R`](../../../heparin-induced-thrombocytopenia/hit_shiny_app.R) | **10 tabs** |
| 📚 References | [`hit_references.md`](../../../heparin-induced-thrombocytopenia/hit_references.md) | **159 PubMed citations** |
