...
| File | Contents |
|---|---|
| [`cap_qsp_model.dot`](cap_qsp_model.dot) | Mechanistic map source (14 clusters, 150+ nodes, 270+ edges) |
| [`cap_qsp_model.svg`](cap_qsp_model.svg) / [`cap_qsp_model.png`](cap_qsp_model.png) | Rendered map (Graphviz `dot`, PNG 150 dpi) |
| [`cap_mrgsolve_model.R`](../../../community-acquired-pneumonia/cap_mrgsolve_model.R) | mrgsolve model — **38 ODE compartments**, 9 predefined scenarios |
| [`cap_shiny_app.R`](../../../community-acquired-pneumonia/cap_shiny_app.R) | Shiny dashboard — 8 tabs |
| [`cap_references.md`](cap_references.md) | 71 PubMed-verified references (every PMID cross-checked) |
