...
| File | Content | Scale |
|------|------|------|
| [`ros_qsp_model.dot`](../../../rosacea/ros_qsp_model.dot) | Mechanistic map (Graphviz source) | **220 nodes · 305 edges · 16 clusters** |
| [`ros_qsp_model.svg`](../../../rosacea/ros_qsp_model.svg) | Vector rendering (zoomable, searchable) | 308 KB |
| [`ros_qsp_model.png`](../../../rosacea/ros_qsp_model.png) | Raster rendering (150 dpi) | 8.1 MB |
| [`ros_mrgsolve_model.R`](../../../rosacea/ros_mrgsolve_model.R) | mrgsolve ODE model | **44 ODEs · 227 parameters · 18 scenarios · 10 phenotype presets · 6 dedicated experiments** |
| [`ros_shiny_app.R`](../../../rosacea/ros_shiny_app.R) | Shiny dashboard | **10 tabs** |
| [`ros_references.md`](ros_references.md) | References | **96 PubMed links · 13 sections + a prediction-validation table** |
...
[`ros_references.md`](ros_references.md) — 96 PubMed links across 13 sections.
