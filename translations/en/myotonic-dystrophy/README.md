...
[![DM1 QSP Mechanistic Map](dm1_qsp_model.png)](../../../myotonic-dystrophy/dm1_qsp_model.svg)
...
| File | Description |
|------|------|
| [`dm1_qsp_model.dot`](dm1_qsp_model.dot) | Graphviz mechanistic map (~158 nodes, 10 clusters) |
| [`dm1_qsp_model.svg`](dm1_qsp_model.svg) | Vector-format map (high resolution) |
| [`dm1_qsp_model.png`](dm1_qsp_model.png) | Raster-format map (150 dpi) |
| [`dm1_mrgsolve_model.R`](dm1_mrgsolve_model.R) | mrgsolve ODE QSP model (22 compartments, 7 scenarios) |
| [`dm1_shiny_app.R`](dm1_shiny_app.R) | Shiny interactive dashboard (7 tabs) |
| [`dm1_references.md`](dm1_references.md) | 40 references (10 sections) |
