...
| File | Contents |
|------|------|
| [`mmd_qsp_model.dot`](../../../moyamoya-disease/mmd_qsp_model.dot) · [`.svg`](../../../moyamoya-disease/mmd_qsp_model.svg) · [`.png`](../../../moyamoya-disease/mmd_qsp_model.png) | Mechanistic map — **126 nodes / 11 clusters** |
| [`mmd_mrgsolve_model.R`](../../../moyamoya-disease/mmd_mrgsolve_model.R) | mrgsolve model — **37 ODE compartments · 24 scenarios**, including the C++ 3-node network solver |
| [`mmd_shiny_app.R`](../../../moyamoya-disease/mmd_shiny_app.R) | Shiny dashboard — **12 tabs** |
| [`mmd_references.md`](../../../moyamoya-disease/mmd_references.md) | **99 references** (every PMID verified through the NCBI E-utilities) |
| [`mmd_reference_model.py`](../../../moyamoya-disease/mmd_reference_model.py) | Independent Python/scipy reimplementation (the numerical ground truth) |
| [`mmd_reference_output.txt`](../../../moyamoya-disease/mmd_reference_output.txt) | The run output that generated every number below |
| [`mmd_cross_validation.txt`](../../../moyamoya-disease/mmd_cross_validation.txt) | mrgsolve ↔ Python cross-validation results (80 paired values) |
| [`mmd_cross_validation.py`](../../../moyamoya-disease/mmd_cross_validation.py) · [`.R`](../../../moyamoya-disease/mmd_cross_validation.R) | The two-stage script that reproduces the cross-validation above |
| [`mmd_r_validation.txt`](../../../moyamoya-disease/mmd_r_validation.txt) | R model self-verification · JAM reproduction · MAP optimisation · virtual population output |
