...
<p align="center">
  <a href="../../../nontuberculous-mycobacterial-lung-disease/ntm_qsp_model.svg"><img src="../../../nontuberculous-mycobacterial-lung-disease/ntm_qsp_model.png" width="900" alt="MAC-PD QSP mechanistic map"></a>
</p>
...
| File | Content |
|---|---|
| [`ntm_qsp_model.dot`](../../../nontuberculous-mycobacterial-lung-disease/ntm_qsp_model.dot) | Mechanistic map source — **194 nodes, 15 subgraph clusters** |
| [`ntm_qsp_model.svg`](../../../nontuberculous-mycobacterial-lung-disease/ntm_qsp_model.svg) | Vector map (zoom in to view) |
| [`ntm_qsp_model.png`](../../../nontuberculous-mycobacterial-lung-disease/ntm_qsp_model.png) | Raster map (150 dpi) |
| [`ntm_mrgsolve_model.R`](../../../nontuberculous-mycobacterial-lung-disease/ntm_mrgsolve_model.R) | **47-ODE** mrgsolve model + 12 treatment scenarios + sensitivity analysis |
| [`ntm_shiny_app.R`](ntm_shiny_app.R) | **11-tab** interactive dashboard |
| [`ntm_references.md`](ntm_references.md) | **76 references**, 12 sections |
