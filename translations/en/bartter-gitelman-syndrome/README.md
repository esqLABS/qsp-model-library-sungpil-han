...
| File | Content | Scale |
|------|------|------|
| [`bgs_qsp_model.dot`](../../../bartter-gitelman-syndrome/bgs_qsp_model.dot) | Mechanistic map (Graphviz source) | **229 nodes · 296 edges · 15 clusters** |
| [`bgs_qsp_model.svg`](../../../bartter-gitelman-syndrome/bgs_qsp_model.svg) | Vector rendering (zoomable, searchable) | 338 KB |
| [`bgs_qsp_model.png`](../../../bartter-gitelman-syndrome/bgs_qsp_model.png) | Raster rendering (150 dpi) | 9.8 MB |
| [`bgs_mrgsolve_model.R`](../../../bartter-gitelman-syndrome/bgs_mrgsolve_model.R) | mrgsolve ODE model | **38 ODEs · 17 scenarios · 10 genotype presets** |
| [`bgs_shiny_app.R`](../../../bartter-gitelman-syndrome/bgs_shiny_app.R) | Shiny dashboard | **10 tabs** |
| [`bgs_references.md`](bgs_references.md) | References | **71 PubMed links · 10 sections** |
...
Underlying references: [`bgs_references.md`](bgs_references.md)
...
[![BGS QSP map](../../../bartter-gitelman-syndrome/bgs_qsp_model.png)](../../../bartter-gitelman-syndrome/bgs_qsp_model.svg)
...
*Part of the QSP disease model library · [back to repository root](../README.md)*
