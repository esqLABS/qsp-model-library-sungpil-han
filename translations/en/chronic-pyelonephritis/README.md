...
| File | Description |
|------|------|
| [`cpn_qsp_model.dot`](cpn_qsp_model.dot) | Graphviz mechanistic map source (10 clusters, 140+ nodes) |
| [`cpn_qsp_model.svg`](cpn_qsp_model.svg) | SVG vector image (scalable) |
| [`cpn_qsp_model.png`](cpn_qsp_model.png) | PNG raster image (150 dpi) |
| [`cpn_mrgsolve_model.R`](cpn_mrgsolve_model.R) | mrgsolve ODE model (18 compartments, 7 scenarios) |
| [`cpn_shiny_app.R`](cpn_shiny_app.R) | Shiny dashboard (7 tabs: patient/PK/bacteria/renal function/scenarios/biomarkers/references) |
| [`cpn_references.md`](cpn_references.md) | 38 references (with PubMed links) |
