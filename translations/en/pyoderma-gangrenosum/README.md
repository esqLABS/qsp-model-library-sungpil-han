...
| File | Description |
|------|-------------|
| [`pg_qsp_model.dot`](../../../pyoderma-gangrenosum/pg_qsp_model.dot) | Graphviz mechanistic map source (200+ nodes, 10 clusters) |
| [`pg_qsp_model.svg`](../../../pyoderma-gangrenosum/pg_qsp_model.svg) | Scalable vector map (high-resolution) |
| [`pg_qsp_model.png`](../../../pyoderma-gangrenosum/pg_qsp_model.png) | Raster map at 150 dpi |
| [`pg_mrgsolve_model.R`](../../../pyoderma-gangrenosum/pg_mrgsolve_model.R) | 30-compartment mrgsolve QSP model; 9 treatment scenarios; virtual population helper |
| [`pg_shiny_app.R`](../../../pyoderma-gangrenosum/pg_shiny_app.R) | 7-tab interactive Shiny dashboard |
| [`pg_references.md`](../../../pyoderma-gangrenosum/pg_references.md) | 40+ PubMed-linked references organized by category |
...
- Full bibliography: [`pg_references.md`](../../../pyoderma-gangrenosum/pg_references.md)
