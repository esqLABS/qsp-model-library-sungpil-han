...
> Category · **Chronic neurological** | Abbreviation · **RLS / WED** | Last updated · 2026-06-30

## Quick links

| File | Purpose |
|------|---------|
| [`rls_qsp_model.dot`](../../../restless-legs-syndrome/rls_qsp_model.dot) · [`.svg`](../../../restless-legs-syndrome/rls_qsp_model.svg) · [`.png`](../../../restless-legs-syndrome/rls_qsp_model.png) | 100+ node mechanistic map (12 subgraph clusters) |
| [`rls_mrgsolve_model.R`](../../../restless-legs-syndrome/rls_mrgsolve_model.R) | 19-compartment ODE / PK-PD QSP model |
| [`rls_shiny_app.R`](../../../restless-legs-syndrome/rls_shiny_app.R) | 8-tab interactive dashboard |
| [`rls_references.md`](../../../restless-legs-syndrome/rls_references.md) | 50+ PubMed-indexed references |
