...
| Deliverable | File |
|---|---|
| 🗺️ Mechanistic map (DOT) | [`hes_qsp_model.dot`](../../../hypereosinophilic-syndrome/hes_qsp_model.dot) |
| 🖼️ Map (SVG)             | [`hes_qsp_model.svg`](../../../hypereosinophilic-syndrome/hes_qsp_model.svg) |
| 🖼️ Map (PNG, 150 dpi)    | [`hes_qsp_model.png`](../../../hypereosinophilic-syndrome/hes_qsp_model.png) |
| ⚙️ mrgsolve ODE model     | [`hes_mrgsolve_model.R`](../../../hypereosinophilic-syndrome/hes_mrgsolve_model.R) |
| 📊 Shiny dashboard        | [`hes_shiny_app.R`](../../../hypereosinophilic-syndrome/hes_shiny_app.R) |
| 📚 References             | [`hes_references.md`](../../../hypereosinophilic-syndrome/hes_references.md) |
