# Carbon Monoxide Poisoning — QSP Model
...
| file | what it is |
|---|---|
| [`co_qsp_model.dot`](../../../carbon-monoxide-poisoning/co_qsp_model.dot) · [SVG](../../../carbon-monoxide-poisoning/co_qsp_model.svg) · [PNG](../../../carbon-monoxide-poisoning/co_qsp_model.png) | mechanistic map: 150 nodes, 17 clusters, 239 edges |
| [`co_mrgsolve_model.R`](../../../carbon-monoxide-poisoning/co_mrgsolve_model.R) | 45-ODE mrgsolve model, 17 annotated scenarios |
| [`co_shiny_app.R`](../../../carbon-monoxide-poisoning/co_shiny_app.R) | 12-tab interactive dashboard |
| [`co_references.md`](../../../carbon-monoxide-poisoning/co_references.md) | 132 references, every PMID resolved against PubMed programmatically |
| [`co_reference_output.txt`](../../../carbon-monoxide-poisoning/co_reference_output.txt) | verbatim output of the independent Python implementation — the source of every number below |
| [`co_python_reference.py`](../../../carbon-monoxide-poisoning/co_python_reference.py) | that independent implementation |
...
> **Disclaimer.** This model is a QSP model for educational and research purposes.
> It was built from the public literature but has not been independently validated
> or certified, and must not be used directly for clinical decision-making,
> prescribing, or regulatory submission. In particular, this model's predictions
> regarding the indications and timing of hyperbaric oxygen therapy are a
