# CRPS QSP model — references

A list of the literature used to build the mechanistic map, the mrgsolve ODE model, and the Shiny
dashboard for complex regional pain syndrome (CRPS).

> **A note on the link format**: the links below are all **PubMed search query URLs**.
> Because a wrongly recorded PMID would cite an entirely different paper, links that search on the author, year, and
> title keywords were used instead. Clicking one goes to the paper concerned (or to a results list
> in which that paper is the top hit). Where a model parameter is anchored to a particular reference, the
> correspondence is set out in the CALIBRATION ANCHORS section at the top of
> `crps_mrgsolve_model.R`.

---

## 1. Diagnostic criteria and severity scores
...
5. de Mos M, et al. **The incidence of complex regional pain syndrome: a population-based study.** *Pain.* 2007. (26.2/100,000 person-years)
...
7. Beerthuizen A, et al. **Demographic and medical parameters in the development of CRPS type 1 after fractures.** *Pain.* 2012. (incidence after fracture)
...
9. Schwartzman RJ, et al. **The natural history of complex regional pain syndrome.** *Clin J Pain.* 2009. (spread and progression)
   <https://pubmed.ncbi.nlm.nih.gov/?term=Schwartzman+natural+history+complex+regional+pain+syndrome+Clin+J+Pain+2009>
10. Bruehl S. **Complex regional pain syndrome.** *BMJ.* 2015. (a clinical overview)
    <https://pubmed.ncbi.nlm.nih.gov/?term=Bruehl+complex+regional+pain+syndrome+BMJ+2015+review>

## 3. Neurogenic inflammation and cytokines

11. Birklein F, et al. **Neuropeptides and neurogenic inflammation in CRPS.** *Neurology / Neurosci Lett.* the 2001-2011 series.
    <https://pubmed.ncbi.nlm.nih.gov/?term=Birklein+neuropeptide+neurogenic+inflammation+complex+regional+pain+syndrome>
12. Huygen FJPM, et al. **Evidence for local inflammation in complex regional pain syndrome type 1.** *Mediators Inflamm.* 2002. (IL-6 and TNF-α in blister fluid)
...
## 4. Small-fibre pathology and the peripheral nerve

16. Oaklander AL, et al. **Evidence of focal small-fiber axonal degeneration in complex regional pain syndrome-I.** *Pain.* 2006. (reduced IENFD)
...
19. Tékus V, et al. **A CRPS-IgG-transfer-trauma model reproducing inflammatory and positive sensory signs.** *Pain.* 2014. (passive transfer)
...
21. Goebel A, et al. **Intravenous immunoglobulin treatment of the complex regional pain syndrome: a randomized trial.** *Ann Intern Med.* 2010. (small and positive)
...
22. Goebel A, et al. **Low-dose intravenous immunoglobulin treatment for long-standing complex regional pain syndrome (LIPS): a randomized trial.** *Ann Intern Med.* 2017. (**negative** — constrains the weight of the autoantibody pathway in the model)
...
## 6. Oxidative stress and free radical scavengers
...
25. Eisenberg E, et al. **Evidence for oxidative stress / lipid peroxidation in CRPS.** *Pain Med / Eur J Pain.* the 2008-2012 series.
    <https://pubmed.ncbi.nlm.nih.gov/?term=oxidative+stress+lipid+peroxidation+complex+regional+pain+syndrome>

## 7. Vascular dysfunction, the warm and cold phenotypes
...
## 8. Sympatho-afferent coupling

31. Baron R, et al. **Causalgia and reflex sympathetic dystrophy: does the sympathetic nervous system contribute to the generation of pain?** *Muscle Nerve / Lancet Neurol.* series.
...
32. Drummond PD, et al. **α1-adrenoceptor expression in hyperalgesic skin of complex regional pain syndrome.** *Pain / Clin J Pain.* series.
...
## 9. Central sensitisation and glia

34. Ji RR, et al. **Glia and pain: is chronic pain a gliopathy?** *Pain.* 2013. (the basis for the glial locking structure)
...
36. Coull JAM, et al. **BDNF from microglia causes the shift in neuronal anion gradient underlying neuropathic pain.** *Nature.* 2005. (BDNF-KCC2 disinhibition)
...
38. Seifert F, et al. **Differential endogenous pain modulation in complex regional pain syndrome.** *Brain.* 2009. (loss of descending modulation)
...
## 10. NMDA antagonism — ketamine

39. Sigtermans MJ, et al. **Ketamine produces effective and long-term pain relief in patients with complex regional pain syndrome type 1.** *Pain.* 2009. (a 100-hour infusion, with the effect gone by 11 weeks)
...
## 11. Bone remodelling and the bisphosphonates
...
## 12. Cortical reorganisation, rehabilitation, psychology
...
## 13. Neuromodulation and interventions
...
57. Kemler MA, et al. **Effect of spinal cord stimulation for chronic complex regional pain syndrome type I: five-year final follow-up of patients in a randomized controlled trial.** *J Neurosurg.* 2008. (the between-group difference gone by year 5)
...
## 14. Anti-inflammatory and symptomatic pharmacotherapy
...
## 15. QSP and modelling methodology

66. Baral R, et al. / the mrgsolve documentation. **mrgsolve: Simulate from ODE-based population PK/PD and QSP models in R.**
    <https://mrgsolve.org/>
...
69. Angeli D, Ferrell JE, Sontag ED. **Detection of multistability, bifurcations, and hysteresis in a large class of biological positive-feedback systems.** *PNAS.* 2004. (the formalism of multistability)
...
### Summary of the model parameter anchoring (calibration anchors → parameters)

| Evidence | Model parameter / result |
|---|---|
| Sigtermans 2009 (ketamine for 100 hours, NRS 7.2→2.7 during the infusion, gone after ~11 weeks) | `A_KET`, `EC50_KET`, `EMAX_KET` → the model gives 6.04→3.02 (d34) and returns to within 0.3 of untreated by d44 |
| Kemler 2000 / 2008 (SCS positive at 6 months, the difference gone by year 5) | `A_SCS`, `SCS_EFF`, `SCS_HAB_K` → +3.27 at 7 months, +0.15 at 60 months |
| Varenna 2013 (neridronate 100 mg IV ×4, with the effect sustained to one year) | `EMAX_NER`, `BONE50_NER`, `W_BONE_PS` → at one year NRS −1.83, CTX-I −61%, BMD preserved |
| Goebel 2017 LIPS (IVIG negative in long-standing CRPS) | `W_AAB_PS` kept small → the late IVIG effect ≈ 0 |
| Zollinger 2007 (vitamin C for prevention), Perez 2003 (DMSO/NAC) | `EMAX_NAC`, `EC50_NAC`, `KOUT_ROS` |
| Ji 2013/2019, Coull 2005 (glial priming, BDNF-KCC2) | `W_GLIA_SELF`, `GLIA50`, `HILL_GLIA`, `KOUT_GLIA` (the locking structure) |
| Moseley 2004/2006, Maihöfner 2004 (use-dependent cortical remapping) | `REHAB_CTX`, `KOUT_CTX`, `W_DIS_CTX` |
| de Jong 2005, Bean 2015 (pain-related fear determines prognosis) | `KFEAR`, `PAIN50_FEAR`, `HILL_FEAR`, `REHAB_FEAR` (the bifurcation parameters) |
| Eberle 2009, Wasner 2001, Groeneweg 2006 (the warm→cold transition) | `W_NP_PERF`, `W_A1_PERF`, `W_SS_PERF`, `W_ROS_PERF` |
| Harden 2010/2017 (the Budapest criteria, CSS 0-16) | the four-domain summation of `CSS` in `$TABLE` and the `ACTIVE_CRPS` flag |
