...
| File | Description |
|------|-------------|
| [`bc_qsp_model.dot`](../../../breast-cancer/bc_qsp_model.dot) | Graphviz DOT mechanistic map (110+ nodes, 9 clusters) |
| [`bc_qsp_model.svg`](../../../breast-cancer/bc_qsp_model.svg) | Rendered SVG of mechanistic map (vector format) |
| [`bc_qsp_model.png`](../../../breast-cancer/bc_qsp_model.png) | Rendered PNG of mechanistic map (150 dpi) |
| [`bc_mrgsolve_model.R`](../../../breast-cancer/bc_mrgsolve_model.R) | mrgsolve ODE model with 22 compartments and 6 treatment scenarios |
| [`bc_shiny_app.R`](../../../breast-cancer/bc_shiny_app.R) | Interactive Shiny dashboard with 6 tabs |
| [`bc_references.md`](bc_references.md) | 50 PubMed-linked references organized by 9 sections |
...
| References | See [`bc_references.md`](bc_references.md) (50 PubMed-linked citations, 9 sections) |
