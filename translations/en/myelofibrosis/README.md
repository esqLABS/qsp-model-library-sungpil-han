...
|--------|------|----------|
| 🗺️ **Mechanistic map** | [`mf_qsp_model.dot`](../../../myelofibrosis/mf_qsp_model.dot) / [`.svg`](../../../myelofibrosis/mf_qsp_model.svg) / [`.png`](../../../myelofibrosis/mf_qsp_model.png) | **204 nodes, 12 clusters, 224 edges** |
| ⚙️ **mrgsolve ODE model** | [`mf_mrgsolve_model.R`](../../../myelofibrosis/mf_mrgsolve_model.R) | **23-compartment ODE**, 6 treatment scenarios |
| 📊 **Shiny dashboard** | [`mf_shiny_app.R`](../../../myelofibrosis/mf_shiny_app.R) | **6-tab** interactive app |
| 📚 **References** | [`mf_references.md`](../../../myelofibrosis/mf_references.md) | **36** PubMed citations |
...
See [`mf_references.md`](../../../myelofibrosis/mf_references.md) for the full reference list (36 PubMed citations).
