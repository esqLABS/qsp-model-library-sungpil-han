...
> English translation of the upstream [`scripts/README.md`](../../../scripts/README.md),
> maintained in this fork. The original is already in English apart from one
> cross-reference; see [`translations/README.md`](../../README.md) for why the
...
[`translations/en/CLAUDE.md`](../CLAUDE.md).
