...
[![CML QSP Model Map](../../../chronic-myeloid-leukemia/cml_qsp_model.png)](../../../chronic-myeloid-leukemia/cml_qsp_model.svg)
...
| File | Description |
|------|-------------|
| [`cml_qsp_model.dot`](../../../chronic-myeloid-leukemia/cml_qsp_model.dot) | Graphviz mechanistic map (100+ nodes, 12 clusters) |
| [`cml_qsp_model.svg`](../../../chronic-myeloid-leukemia/cml_qsp_model.svg) | SVG vector graphic (interactive) |
| [`cml_qsp_model.png`](../../../chronic-myeloid-leukemia/cml_qsp_model.png) | PNG thumbnail (150 dpi) |
| [`cml_mrgsolve_model.R`](../../../chronic-myeloid-leukemia/cml_mrgsolve_model.R) | mrgsolve ODE model (22 compartments, 7 scenarios) |
...
| Tab | Contents |
|-----|---------|
| Patient Profile | Sokal/EUTOS score calculator, ELN treatment recommendation |
| Pharmacokinetics (PK) | Plasma & intracellular TKI concentration profiles |
| Molecular Response | BCR-ABL IS% trajectory, ELN milestone checker |
| Cell Dynamics | Normal vs leukemic cell population dynamics |
| Scenario Comparison | Head-to-head TKI comparison (MMR/MR4/MR4.5 rates) |
| Resistance/TFR Assessment | T315I clone kinetics, TFR simulation, mutation table |
