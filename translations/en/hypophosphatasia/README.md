...
| File | Contents |
|------|------|
| [`hpp_qsp_model.dot`](../../../hypophosphatasia/hpp_qsp_model.dot) · [`.svg`](../../../hypophosphatasia/hpp_qsp_model.svg) · [`.png`](../../../hypophosphatasia/hpp_qsp_model.png) | Mechanistic map — **167 nodes, 224 edges, 16 clusters** |
| [`hpp_mrgsolve_model.R`](../../../hypophosphatasia/hpp_mrgsolve_model.R) | mrgsolve ODE model — **32 differential states + 4 quasi-steady-state (QSS) species**, 17 scenarios, calibration notes |
| [`hpp_reference_model.py`](../../../hypophosphatasia/hpp_reference_model.py) | Dependency-free Python reference implementation (**the numerical authority**). Its parameter block corresponds 1:1 with the R file |
| [`hpp_model_report.txt`](../../../hypophosphatasia/hpp_model_report.txt) | The full output of that script — the source of every number in this README |
| [`hpp_shiny_app.R`](../../../hypophosphatasia/hpp_shiny_app.R) | Shiny dashboard — **12 tabs** (profile · PK/target delivery · PPi economy · biochemical markers · skeleton · respiration/survival · mineral/kidney · CNS · vitamin B6 · scenario comparison · threshold explorer · dose-response · model notes) |
| [`hpp_references.md`](../../../hypophosphatasia/hpp_references.md) | **57 references** (sections 1–10 have PMIDs verified via the PubMed E-utilities, section 11 is separated out explicitly as unverified search links, and section 12 lists the parameters with no evidential basis) |
