...
| File | Description |
|------|------|
| [`wm_qsp_model.dot`](../../../waldenstrom-macroglobulinemia/wm_qsp_model.dot) | Graphviz mechanistic map source |
| [`wm_qsp_model.svg`](../../../waldenstrom-macroglobulinemia/wm_qsp_model.svg) | Vector map (interactive view) |
| [`wm_qsp_model.png`](../../../waldenstrom-macroglobulinemia/wm_qsp_model.png) | Raster map (150 dpi) |
| [`wm_mrgsolve_model.R`](../../../waldenstrom-macroglobulinemia/wm_mrgsolve_model.R) | mrgsolve ODE model + simulation of 7 scenarios |
| [`wm_shiny_app.R`](../../../waldenstrom-macroglobulinemia/wm_shiny_app.R) | 7-tab interactive Shiny dashboard |
| [`wm_references.md`](wm_references.md) | 62 references (classified by section) |
