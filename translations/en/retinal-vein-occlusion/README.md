...
| [`rvo_mrgsolve_model.R`](../../../retinal-vein-occlusion/rvo_mrgsolve_model.R) | mrgsolve model (27 ODEs) + agent library + phenotypes + PRN/T&E controllers + 31 scenarios + closed-form analysis + virtual population + one plot per claim (4) |
...
| [`rvo_references.md`](../../../retinal-vein-occlusion/rvo_references.md) | 112 references, every PMID verified against PubMed E-utilities. Each entry states what it was used for in the model (parameter · structural assumption · calibration target). |
