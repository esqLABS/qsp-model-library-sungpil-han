...
|---|---|---|
| Mechanistic map | [`algs_qsp_model.dot`](../../../alagille-syndrome/algs_qsp_model.dot) · [SVG](../../../alagille-syndrome/algs_qsp_model.svg) · [PNG](../../../alagille-syndrome/algs_qsp_model.png) | 184 nodes · 251 edges · 22 clusters |
| mrgsolve ODE model | [`algs_mrgsolve_model.R`](../../../alagille-syndrome/algs_mrgsolve_model.R) | 44 compartments · 16 scenarios |
| Shiny dashboard | [`algs_shiny_app.R`](../../../alagille-syndrome/algs_shiny_app.R) | 12 tabs · 23 outputs (all pass `testServer`) |
| References | [`algs_references.md`](../../../alagille-syndrome/algs_references.md) | 154 PMIDs (all verified against the live PubMed API) |
