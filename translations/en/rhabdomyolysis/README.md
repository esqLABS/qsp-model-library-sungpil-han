...
<p align="center">
  <a href="../../../rhabdomyolysis/rhab_qsp_model.svg"><img src="../../../rhabdomyolysis/rhab_qsp_model.png" width="820" alt="Rhabdomyolysis QSP mechanistic map"></a><br>
  <sub>158 nodes · 18 subgraph clusters — click the <a href="../../../rhabdomyolysis/rhab_qsp_model.svg">SVG</a> to view full size</sub>
</p>
...
`rhab_mrgsolve_model.R` verbatim and independently compiling and integrating them (RK4,
...
`rhab_mrgsolve_model.R`, compiled with `g++ -Wall` (no warnings, all 47 derivatives confirmed
...
[`rhab_references.md`](rhab_references.md) — 80 references across 14
