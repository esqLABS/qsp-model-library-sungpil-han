...
Scenarios that fail to meet the anchors, or that are deliberately exaggerated (mannitol overdose, no fasciotomy performed, etc.), are documented in the CALIBRATION NOTES at the bottom of `rhab_mrgsolve_model.R` and in the limitations section of `README.md`.
