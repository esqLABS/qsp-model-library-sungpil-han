# Opioid Use Disorder (OUD) — QSP Model
...
| Deliverable | File |
|---|---|
| 🗺️ Mechanistic map (DOT) | [`oud_qsp_model.dot`](../../../opioid-use-disorder/oud_qsp_model.dot) |
| 🖼️ Map (SVG)             | [`oud_qsp_model.svg`](../../../opioid-use-disorder/oud_qsp_model.svg) |
| 🖼️ Map (PNG, 150 dpi)    | [`oud_qsp_model.png`](../../../opioid-use-disorder/oud_qsp_model.png) |
| ⚙️ mrgsolve ODE model     | [`oud_mrgsolve_model.R`](../../../opioid-use-disorder/oud_mrgsolve_model.R) |
| 📊 Shiny dashboard        | [`oud_shiny_app.R`](../../../opioid-use-disorder/oud_shiny_app.R) |
| 📚 References             | [`oud_references.md`](../../../opioid-use-disorder/oud_references.md) |
