# Osteonecrosis of the Femoral Head — QSP Model
...
| file | what it is |
|---|---|
| [`onfh_qsp_model.dot`](../../../osteonecrosis-femoral-head/onfh_qsp_model.dot) · [SVG](../../../osteonecrosis-femoral-head/onfh_qsp_model.svg) · [PNG](../../../osteonecrosis-femoral-head/onfh_qsp_model.png) | mechanistic map: 159 nodes, 18 clusters, 219 edges |
| [`onfh_mrgsolve_model.R`](../../../osteonecrosis-femoral-head/onfh_mrgsolve_model.R) | 49-ODE mrgsolve model, 20 annotated scenarios |
| [`onfh_shiny_app.R`](../../../osteonecrosis-femoral-head/onfh_shiny_app.R) | 12-tab dashboard, one tab per subsystem |
...
| [`onfh_python_reference.py`](../../../osteonecrosis-femoral-head/onfh_python_reference.py) | the independent numpy/scipy implementation — the source of every number below |
| [`onfh_reference_output.txt`](../../../osteonecrosis-femoral-head/onfh_reference_output.txt) | its verbatim output |
...
This model is a **QSP model for educational and research purposes.** It was
built on published literature but has not been independently validated against
patient data, and **must not be used for clinical decision-making,
prescribing, or regulatory submission.** The "Known misses" section above
states plainly where the model diverges from the literature.
