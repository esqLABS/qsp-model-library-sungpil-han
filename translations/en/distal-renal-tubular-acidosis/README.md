...
| Deliverable | File |
|---|---|
| 🗺️ Mechanistic map | [`drta_qsp_model.dot`](../../../distal-renal-tubular-acidosis/drta_qsp_model.dot) · [SVG](../../../distal-renal-tubular-acidosis/drta_qsp_model.svg) · [PNG](../../../distal-renal-tubular-acidosis/drta_qsp_model.png) — **171 nodes / 267 edges / 19 clusters** |
| ⚙️ mrgsolve model | [`drta_mrgsolve_model.R`](../../../distal-renal-tubular-acidosis/drta_mrgsolve_model.R) — **56 ODEs / 28 scenarios** |
| 📊 Shiny dashboard | [`drta_shiny_app.R`](../../../distal-renal-tubular-acidosis/drta_shiny_app.R) — **10 tabs** |
| 📚 References | [`drta_references.md`](../../../distal-renal-tubular-acidosis/drta_references.md) — **463 items / 24 sections** (every one looked up through the NCBI E-utilities) |
| 🧪 Validation log | [`drta_validation_log.md`](../../../distal-renal-tubular-acidosis/drta_validation_log.md) — the raw tool output for every number below |
| 🐍 Reference implementation | [`drta_python_reference.py`](../../../distal-renal-tubular-acidosis/drta_python_reference.py) · [`drta_python_report.py`](../../../distal-renal-tubular-acidosis/drta_python_report.py) — a dependency-free RK4 harness that actually integrates and calibrates the 56 equations |

<a href="../../../distal-renal-tubular-acidosis/drta_qsp_model.svg"><img src="../../../distal-renal-tubular-acidosis/drta_qsp_model.png" width="100%" alt="dRTA QSP map"></a>
