...
[![Model](../../../myocarditis/myo_qsp_model.png)](../../../myocarditis/myo_qsp_model.svg)

## Overview

**Myocarditis** is an inflammatory disease of the myocardium caused primarily by viral infection (coxsackievirus B3, SARS-CoV-2, adenovirus, HHV-6), autoimmune activation, or toxic exposure. It is a leading cause of sudden cardiac death in young adults and a major pathway to dilated cardiomyopathy (DCM).
...
> **Full reference list**: See [`myo_references.md`](../../../myocarditis/myo_references.md) for 60 PubMed-cited references across 14 sections.
