...
<a href="../../../prolactinoma/prl_qsp_model.svg"><img src="../../../prolactinoma/prl_qsp_model.png" width="720" alt="Prolactinoma QSP mechanistic map"></a>

| Deliverable | File | Scale |
|---|---|---|
| 🗺️ Mechanistic map | [`prl_qsp_model.dot`](../../../prolactinoma/prl_qsp_model.dot) · [`.svg`](../../../prolactinoma/prl_qsp_model.svg) · [`.png`](../../../prolactinoma/prl_qsp_model.png) | **236 nodes · 21 clusters · 339 edges** |
| ⚙️ mrgsolve ODE model | [`prl_mrgsolve_model.R`](../../../prolactinoma/prl_mrgsolve_model.R) | **58 ODEs · 179 parameters · 34 scenarios · 15 diagnostic analyses** |
| 📊 Shiny dashboard | [`prl_shiny_app.R`](prl_shiny_app.R) | **11 tabs** |
| 📚 References | [`prl_references.md`](prl_references.md) | **150 PubMed citations (all looked up and verified via NCBI)** |
...
[`prl_references.md`](prl_references.md) — **150
