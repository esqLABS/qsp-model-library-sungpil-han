...
| `sal_mrgsolve_model.R` | mrgsolve model with **28 ODEs, 14 scenarios**. Includes a stepwise parameter-change runner |
| `sal_shiny_app.R` | **11-tab** dashboard (patient · PK · the two multipliers · acid-base · kidney · endpoints · scenario comparison · ventilator experiment · nomogram · EXTRIP · lab panel) |
...
| `sal_references.md` | **83 references**, every PMID confirmed against PubMed |
...
`sal_references.md` — 83 entries, grouped into 18 sections. Every PMID was
