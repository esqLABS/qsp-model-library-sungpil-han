...
<a href="../../../chemotherapy-induced-neutropenia/cin_qsp_model.svg"><img src="../../../chemotherapy-induced-neutropenia/cin_qsp_model.png" width="640" alt="CIN/FN mechanistic map"></a>
...
output is committed as [`cin_numerical_report.txt`](../../../chemotherapy-induced-neutropenia/cin_numerical_report.txt).
...
| File | What it is |
|------|-----------|
| [`cin_qsp_model.dot`](../../../chemotherapy-induced-neutropenia/cin_qsp_model.dot) · [`.svg`](../../../chemotherapy-induced-neutropenia/cin_qsp_model.svg) · [`.png`](../../../chemotherapy-induced-neutropenia/cin_qsp_model.png) | Mechanistic map — **227 nodes, 323 edges, 19 clusters** |
| [`cin_mrgsolve_model.R`](../../../chemotherapy-induced-neutropenia/cin_mrgsolve_model.R) | **53-compartment** mrgsolve model, 8 agents, 13 regimens, `mread()`-ready |
| [`cin_shiny_app.R`](../../../chemotherapy-induced-neutropenia/cin_shiny_app.R) | **9-tab** dashboard, arranged so the ANC is never shown alone |
| [`cin_references.md`](../../../chemotherapy-induced-neutropenia/cin_references.md) | **114 references**, every PMID resolved through the PubMed API |
| [`cin_reference_impl.py`](../../../chemotherapy-induced-neutropenia/cin_reference_impl.py) | Pure-stdlib reference implementation + calibration + 15 analyses |
| [`cin_numerical_report.txt`](../../../chemotherapy-induced-neutropenia/cin_numerical_report.txt) | Committed output — the source of every number here |
