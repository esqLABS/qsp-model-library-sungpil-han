...
when `et_reference_check.py` queried PubMed through NCBI E-utilities. The title, author, journal,
...
```bash
python3 et_reference_check.py            # pass 1: title-based verification
python3 et_reference_check.py --harvest   # pass 2: collection by topic query
python3 et_reference_check.py --emit      # pass 3: generate this file
```
