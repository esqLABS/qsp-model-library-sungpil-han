...
> A quantitative systems pharmacology model in
...
![Tobacco Use Disorder QSP mechanistic map](../../../tobacco-use-disorder/tud_qsp_model.png)
...
See [`tud_references.md`](../../../tobacco-use-disorder/tud_references.md) for the evidence behind every
parameter.
