...
[![Hemophilia B QSP Map](../../../hemophilia-b/hb_qsp_model.png)](../../../hemophilia-b/hb_qsp_model.svg)
...
**File:** [`hb_mrgsolve_model.R`](../../../hemophilia-b/hb_mrgsolve_model.R)
...
**File:** [`hb_shiny_app.R`](../../../hemophilia-b/hb_shiny_app.R) | **Tabs: 8**
...
**File:** [`hb_references.md`](../../../hemophilia-b/hb_references.md)
...
|--------|------|------|
| 🗺️ Mechanistic map | [`hb_qsp_model.dot/.svg/.png`](../../../hemophilia-b/hb_qsp_model.svg) | **125 nodes, 13 clusters** (F9 gene · intrinsic pathway · common pathway · bleeding phenotype · FIX replacement PK · non-replacement rebalancing · AAV gene therapy · inhibitor immunology · biomarkers · clinical endpoints · lifecycle · long-term comorbidity · adjunctive hemostasis) |
| ⚙️ mrgsolve ODE | [`hb_mrgsolve_model.R`](../../../hemophilia-b/hb_mrgsolve_model.R) | **24-compartment ODE** (FIX SHL/EHL 4 compartments · AAV gene therapy 5 compartments · concizumab/marstacimab 4 compartments · fitusiran/AT 4 compartments · inhibitor · ETP · CumBleeds · joint score · QoL · Synovitis), **10 treatment scenarios** |
| 📊 Shiny app | [`hb_shiny_app.R`](../../../hemophilia-b/hb_shiny_app.R) | **8 tabs** (patient profile · FIX PK · non-replacement rebalancing · gene therapy · PD core metrics · bleed risk/arthropathy · scenario comparison · inhibitor/biomarkers), bslib darkly, plotly, built-in ODE simulator |
| 📚 References | [`hb_references.md`](../../../hemophilia-b/hb_references.md) | **71 PubMed citations** (HOPE-B · B-LONG · PROLONG-9FP · pathfinder2 · BASIS · ATLAS-A/B, etc.) |
