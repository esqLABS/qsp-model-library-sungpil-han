...
## =============================================================================
##
##  Quantitative systems pharmacology model of high-altitude illness (AMS · HACE · HAPE)
##
##  The structural claim
##  ---------------------------------------------------------------------------
##  High-altitude illness is not three diseases.  It is what a single inspired oxygen
##  tension (P_IO2) does through three defences with different time constants.
##
##     P_IO2 = F_IO2 x (P_B(h) - 47)              <- the only exogenous variable
##
##     Defence 1 (min -> d) : Ventilation.  P_AO2 = P_IO2 - P_aCO2 x [F_IO2+(1-F_IO2)/R]
##                            Acid-base, not the chemoreceptors, sets the limit.
##     Defence 2 (s)        : Hypoxic pulmonary vasoconstriction (HPV).  It preserves gas
##                            exchange and destroys the capillaries — because it is spatially non-uniform.
##     Defence 3 (s)        : Cerebral vasodilatation.  It preserves cerebral blood flow
##                            and consumes intracranial volume buffering.
##
##  Defence 1 takes days because of renal/CSF bicarbonate; defences 2 and 3 act at once.
##  The whole of high-altitude medicine comes out of this mismatch in timing: until the
##  slow defence arrives the two fast ones run unchecked, and the drugs split exactly four ways —
##  "accelerate defence 1"(acetazolamide), "blunt defence 2"(nifedipine·tadalafil),
##  "pay the price of defence 3"(dexamethasone), "remove the cause"(descent·oxygen·Gamow bag).
##
##  ---------------------------------------------------------------------------
##  50 compartments · 200+ parameters · 23 scenarios
##  Verification: every equation is independently reimplemented in Python/scipy in
##       hai_reference_model.py, and the numbers from the two implementations are compared in hai_reference_output.txt.
##
##  Units: pressure mmHg · flow L/min · time h · metabolic rate mL/min STPD
##       acid-base mEq/L · Hb g/dL · oedema mL
## =============================================================================
