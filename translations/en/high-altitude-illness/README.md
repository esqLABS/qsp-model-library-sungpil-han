...
<p align="center">
  <a href="../../../high-altitude-illness/hai_qsp_model.svg">
    <img src="../../../high-altitude-illness/hai_qsp_model.png" width="880" alt="High-altitude illness QSP mechanistic map">
  </a>
</p>
...
| [`hai_shiny_app.R`](hai_shiny_app.R) | Shiny dashboard (12 tabs) |
| [`hai_references.md`](hai_references.md) | 121 references — every PMID checked against NCBI |
...
| [`hai_reference_output.txt`](../../../high-altitude-illness/hai_reference_output.txt) · [`hai_scenario_results.json`](../../../high-altitude-illness/hai_scenario_results.json) | The computed output behind every number below |
