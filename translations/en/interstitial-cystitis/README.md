...
| File | Description |
|------|------|
| [`ic_bps_qsp_model.dot`](../../../interstitial-cystitis/ic_bps_qsp_model.dot) | Graphviz mechanistic map (140+ nodes, 9 clusters) |
| [`ic_bps_qsp_model.svg`](../../../interstitial-cystitis/ic_bps_qsp_model.svg) | Vector-format map (high resolution) |
| [`ic_bps_qsp_model.png`](../../../interstitial-cystitis/ic_bps_qsp_model.png) | Raster-format map (150 dpi) |
| [`ic_bps_mrgsolve_model.R`](../../../interstitial-cystitis/ic_bps_mrgsolve_model.R) | mrgsolve ODE QSP model (22 compartments, 7 scenarios, VP n=200) |
| [`ic_bps_shiny_app.R`](../../../interstitial-cystitis/ic_bps_shiny_app.R) | Shiny interactive dashboard (8 tabs) |
| [`ic_bps_references.md`](../../../interstitial-cystitis/ic_bps_references.md) | 62 references (17 sections) |
