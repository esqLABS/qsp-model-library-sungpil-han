...
[![LEP QSP mechanistic map](../../../leprosy/lep_qsp_model.png)](../../../leprosy/lep_qsp_model.svg)
...
| File | Contents |
|------|------|
| [`lep_qsp_model.dot`](../../../leprosy/lep_qsp_model.dot) | Mechanistic map source (123 nodes · 17 clusters) |
| [`lep_qsp_model.svg`](../../../leprosy/lep_qsp_model.svg) / [`.png`](../../../leprosy/lep_qsp_model.png) | Rendered output |
| [`lep_mrgsolve_model.R`](lep_mrgsolve_model.R) | 38-ODE mrgsolve model + 17 scenarios |
| [`lep_shiny_app.R`](lep_shiny_app.R) | 10-tab Shiny dashboard |
| [`lep_verify_python.py`](../../../leprosy/lep_verify_python.py) | Independent Python/scipy re-implementation + 54 anchors |
| [`lep_verification_output.txt`](../../../leprosy/lep_verification_output.txt) | Verification run output (54/54 pass) |
| [`lep_references.md`](lep_references.md) | 87 references (all PMIDs confirmed against PubMed) |
