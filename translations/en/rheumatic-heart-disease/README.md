...
| File | Contents |
|---|---|
| [`rhd_qsp_model.dot`](../../../rheumatic-heart-disease/rhd_qsp_model.dot) | Mechanistic map source — **161 nodes, 17 clusters** |
| [`rhd_qsp_model.svg`](../../../rheumatic-heart-disease/rhd_qsp_model.svg) · [`.png`](../../../rheumatic-heart-disease/rhd_qsp_model.png) | Rendered map (150 dpi) |
| [`rhd_mrgsolve_model.R`](../../../rheumatic-heart-disease/rhd_mrgsolve_model.R) | **39 ODEs**, 16 scenarios, mrgsolve |
| [`rhd_shiny_app.R`](../../../rheumatic-heart-disease/rhd_shiny_app.R) | **11-tab** interactive dashboard |
| [`rhd_references.md`](../../../rheumatic-heart-disease/rhd_references.md) | **123 PubMed references** (all verified via API) |
| [`rhd_verify_python.py`](../../../rheumatic-heart-disease/rhd_verify_python.py) | Independent Python/scipy reimplementation + 47 anchors |
| [`rhd_verification_output.txt`](../../../rheumatic-heart-disease/rhd_verification_output.txt) | Verification run output (47/47 passed) |
