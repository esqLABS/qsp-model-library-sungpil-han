...
[![ATTR QSP mechanistic map](attr_qsp_model.png)](../../../transthyretin-amyloidosis/attr_qsp_model.svg)
...
|------|------|------|
| [`attr_qsp_model.dot`](attr_qsp_model.dot) | **116 nodes, 10 clusters** | Graphviz mechanistic map (DOT source) |
| [`attr_qsp_model.svg`](attr_qsp_model.svg) | Vector graphic | Zoomable SVG |
| [`attr_qsp_model.png`](attr_qsp_model.png) | 150 dpi PNG | Raster image for preview |
| [`attr_mrgsolve_model.R`](../../../transthyretin-amyloidosis/attr_mrgsolve_model.R) | **25-compartment ODE, 7 treatment scenarios** | mrgsolve PK/PD model |
| [`attr_shiny_app.R`](../../../transthyretin-amyloidosis/attr_shiny_app.R) | **8-tab dashboard** | Shiny interactive app |
| [`attr_references.md`](attr_references.md) | **60 PubMed citations (10 sections)** | Supporting reference list |
