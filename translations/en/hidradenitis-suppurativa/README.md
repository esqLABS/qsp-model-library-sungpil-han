...
**Hidradenitis Suppurativa (HS)** is a chronic, relapsing, inflammatory
skin disorder affecting apocrine gland-bearing areas (axillae, groin,
inframammary folds, perianal region). Characterized by recurrent painful
nodules, abscesses, and sinus tracts/fistulae, it severely impairs
quality of life. Prevalence ~1–4% globally; predominantly affects women
of reproductive age. The pathophysiology integrates follicular occlusion,
dysbiotic microbiome, innate/adaptive immune dysregulation, hormonal
factors, and progressive fibrosis.
...
- Full bibliography: [`hs_references.md`](../../../hidradenitis-suppurativa/hs_references.md)
