...
[![EH QSP Model](../../../essential-hypertension/eh_qsp_model.png)](../../../essential-hypertension/eh_qsp_model.svg)
...
| File | Description |
|------|------|
| [eh_qsp_model.dot](../../../essential-hypertension/eh_qsp_model.dot) | Graphviz mechanistic map source (approximately 173 nodes / 10 clusters) |
| [eh_qsp_model.svg](../../../essential-hypertension/eh_qsp_model.svg) | SVG vector image (scalable) |
| [eh_qsp_model.png](../../../essential-hypertension/eh_qsp_model.png) | PNG image (150 dpi) |
| [eh_mrgsolve_model.R](eh_mrgsolve_model.R) | mrgsolve ODE model (approximately 22 compartments / 6 treatment scenarios) |
| [eh_shiny_app.R](../../../essential-hypertension/eh_shiny_app.R) | Shiny dashboard |
| [eh_references.md](eh_references.md) | References (approximately 41 articles, PubMed links) |
...
For detailed citations, see [eh_references.md](eh_references.md) (approximately 41 articles).
