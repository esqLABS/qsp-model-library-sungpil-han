...
<p align="center">
  <a href="../../../kidney-transplant-rejection/ktx_qsp_model.svg">
    <img src="../../../kidney-transplant-rejection/ktx_qsp_model.png" width="900" alt="Kidney transplant rejection QSP mechanistic map">
  </a>
</p>
...
| File | Content |
|------|------|
| [`ktx_qsp_model.dot`](../../../kidney-transplant-rejection/ktx_qsp_model.dot) | Mechanistic map source — 20 modules · 243 nodes · 385 edges |
| [`ktx_qsp_model.svg`](../../../kidney-transplant-rejection/ktx_qsp_model.svg) / [`.png`](../../../kidney-transplant-rejection/ktx_qsp_model.png) | Rendered output (`dot -Tsvg` / `dot -Tpng -Gdpi=150`) |
| [`ktx_mrgsolve_model.R`](../../../kidney-transplant-rejection/ktx_mrgsolve_model.R) | **59-ODE** mrgsolve model + 26 scenarios + an automated validation block |
| [`ktx_shiny_app.R`](ktx_shiny_app.R) | 10-tab interactive dashboard (including a U-curve sweep) |
| [`ktx_references.md`](ktx_references.md) | **153 references, actually looked up and verified** on PubMed |
...
Rscript -e 'shiny::runApp("ktx_shiny_app.R")'      # dashboard
```
...
[`ktx_references.md`](ktx_references.md) — 20 topic sections, **153 references**.
