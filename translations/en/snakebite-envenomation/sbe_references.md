...
This list is the evidence for the structural choices and parameters that went into `sbe_qsp_model.dot` (the mechanistic map · 145 nodes · 21 clusters),
`sbe_mrgsolve_model.R` (the 50-ODE model), and `sbe_reference_model.py` (an independent verification
implementation).
