...
| [`ed_mrgsolve_model.R`](../../../erectile-dysfunction/ed_mrgsolve_model.R) | 45-ODE mrgsolve model, PK library for 4 PDE5 inhibitors, 9 patient archetypes, 16 scenarios, virtual population functions, calibration notes |
| [`ed_shiny_app.R`](../../../erectile-dysfunction/ed_shiny_app.R) | 14-tab interactive dashboard |
| [`ed_references.md`](../../../erectile-dysfunction/ed_references.md) | 102 references (every PMID automatically verified via NCBI E-utilities) |
