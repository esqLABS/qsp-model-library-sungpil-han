...
This list is the evidence for the structures, parameters, and clinical anchors used in `dili_qsp_model.dot` (the mechanistic map),
`dili_mrgsolve_model.R` (the ODE model), and `dili_shiny_app.R` (the dashboard).
