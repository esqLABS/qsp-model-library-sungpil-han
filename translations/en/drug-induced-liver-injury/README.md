...
<p align="center">
  ...
  <sub><a href="dili_qsp_model.svg">View the full-resolution SVG</a> · 222 nodes · 330 edges · 15 clusters (14 mechanisms + 1 legend)</sub>
</p>
...
[`dili_reference_check.py`](dili_reference_check.py), and
the full output is in
[`dili_reference_output.txt`](dili_reference_output.txt).
...
| File | Contents |
|---|---|
| [`dili_qsp_model.dot`](dili_qsp_model.dot) | Mechanistic map source (222 nodes · 330 edges · 15 clusters (14 mechanisms + 1 legend)) |
...
python3 dili_reference_check.py        # regenerates dili_reference_output.txt
...
`dili_reference_check.py` and `dili_mrgsolve_model.R` contain **the same equations and the
