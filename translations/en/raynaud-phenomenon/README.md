...
> Parent library → [../README.md](../README.md) · Category: Vascular/Connective Tissue

[![Raynaud QSP Model](raynaud_qsp_model.png)](../../../raynaud-phenomenon/raynaud_qsp_model.svg)
...
| File | Description |
|------|------|
| [raynaud_qsp_model.dot](raynaud_qsp_model.dot) | Graphviz mechanistic map source (100+ nodes / 13 clusters) |
| [raynaud_qsp_model.svg](raynaud_qsp_model.svg) | SVG vector image (scalable) |
| [raynaud_qsp_model.png](raynaud_qsp_model.png) | PNG image (150 dpi) |
| [raynaud_mrgsolve_model.R](../../../raynaud-phenomenon/raynaud_mrgsolve_model.R) | mrgsolve ODE model (18 compartments / 9 scenarios) |
| [raynaud_shiny_app.R](../../../raynaud-phenomenon/raynaud_shiny_app.R) | Shiny dashboard (7 tabs) |
| [raynaud_references.md](raynaud_references.md) | References (62 articles, PubMed links) |
...
For detailed citations, see [raynaud_references.md](raynaud_references.md) (62 articles).
