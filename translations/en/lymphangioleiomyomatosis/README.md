...
**Abbreviation**: LAM
**Directory**: [`lymphangioleiomyomatosis/`](../../../lymphangioleiomyomatosis/)
...
| File | Description |
|------|------|
| [`lam_qsp_model.dot`](../../../lymphangioleiomyomatosis/lam_qsp_model.dot) | Graphviz mechanistic map source |
| [`lam_qsp_model.svg`](../../../lymphangioleiomyomatosis/lam_qsp_model.svg) | Vector mechanistic map |
| [`lam_qsp_model.png`](../../../lymphangioleiomyomatosis/lam_qsp_model.png) | Raster mechanistic map (150 dpi) |
| [`lam_mrgsolve_model.R`](../../../lymphangioleiomyomatosis/lam_mrgsolve_model.R) | 18-compartment ODE PK/PD model |
| [`lam_shiny_app.R`](../../../lymphangioleiomyomatosis/lam_shiny_app.R) | 6-tab interactive Shiny dashboard |
| [`lam_references.md`](../../../lymphangioleiomyomatosis/lam_references.md) | 50 PubMed references |
...
Full reference list, 50 entries: [`lam_references.md`](../../../lymphangioleiomyomatosis/lam_references.md)
