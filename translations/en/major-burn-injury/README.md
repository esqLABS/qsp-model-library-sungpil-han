...
| File | Contents |
|---|---|
| [`mbi_qsp_model.dot`](../../../major-burn-injury/mbi_qsp_model.dot) · [`.svg`](../../../major-burn-injury/mbi_qsp_model.svg) · [`.png`](../../../major-burn-injury/mbi_qsp_model.png) | mechanistic map — 18 clusters · 197 nodes · 287 edges. Treatment nodes are coloured by **which term of the model they touch** |
| [`mbi_mrgsolve_model.R`](../../../major-burn-injury/mbi_mrgsolve_model.R) | mrgsolve ODE model — **56 compartments · 22 scenarios**, surgery and dosing handled through an event table |
| [`mbi_shiny_app.R`](mbi_shiny_app.R) | Shiny dashboard — **12 tabs**, real-time manipulation of patient, protocol, and drugs |
| [`mbi_references.md`](mbi_references.md) | **352 items** — only records returned by an exhaustive NCBI E-utilities lookup are included |
| [`mbi_reference_python.py`](../../../major-burn-injury/mbi_reference_python.py) | a dependency-free Python RK4 re-implementation (reference implementation for validation) |
| [`mbi_reference_output.txt`](../../../major-burn-injury/mbi_reference_output.txt) | the full validation output of the script above |
