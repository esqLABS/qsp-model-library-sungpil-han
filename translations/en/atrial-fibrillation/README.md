...
| File | Description |
|------|------|
| [af_qsp_model.dot](../../../atrial-fibrillation/af_qsp_model.dot) | Graphviz mechanistic map (128+ nodes, 12 clusters) |
| [af_qsp_model.svg](../../../atrial-fibrillation/af_qsp_model.svg) | SVG vector image (scalable) |
| [af_qsp_model.png](../../../atrial-fibrillation/af_qsp_model.png) | PNG raster image (150 dpi) |
| [af_mrgsolve_model.R](../../../atrial-fibrillation/af_mrgsolve_model.R) | mrgsolve ODE model (20+ compartments, 6 scenarios) |
| [af_shiny_app.R](af_shiny_app.R) | Shiny dashboard (6 tabs) |
| [af_references.md](af_references.md) | 46 references (including PubMed links) |
...
See [af_references.md](af_references.md) for the full reference list (46 articles, including PubMed links).
