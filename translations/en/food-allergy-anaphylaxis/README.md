...
**A model that treats the eliciting dose as a single computed value.**

| File | What it is |
|---|---|
| [`fana_qsp_model.dot`](../../../food-allergy-anaphylaxis/fana_qsp_model.dot) · [`.svg`](../../../food-allergy-anaphylaxis/fana_qsp_model.svg) · [`.png`](../../../food-allergy-anaphylaxis/fana_qsp_model.png) | Mechanistic map — 20 modules, 219 labelled nodes |
| [`fana_mrgsolve_model.R`](../../../food-allergy-anaphylaxis/fana_mrgsolve_model.R) | 35-ODE mrgsolve model, 12 scenarios, 16 diagnostics, virtual population |
| [`fana_shiny_app.R`](../../../food-allergy-anaphylaxis/fana_shiny_app.R) | 9-tab interactive dashboard |
| [`fana_references.md`](../../../food-allergy-anaphylaxis/fana_references.md) | 112 references + 5 out-of-scope pointers, every entry with a PubMed link |
...
[`fana_references.md`](../../../food-allergy-anaphylaxis/fana_references.md) points to the right literature
for each.
