...
| File | Description |
|------|------|
| [ahy_qsp_model.dot](ahy_qsp_model.dot) | Graphviz mechanistic map source (15 clusters, 100+ nodes) |
| [ahy_qsp_model.svg](ahy_qsp_model.svg) | SVG vector image (zoomable, high resolution) |
| [ahy_qsp_model.png](ahy_qsp_model.png) | PNG raster image (150 dpi) |
| [ahy_mrgsolve_model.R](ahy_mrgsolve_model.R) | mrgsolve ODE model (19 compartments, 7 scenarios, dose-response analysis) |
| [ahy_shiny_app.R](ahy_shiny_app.R) | Shiny dashboard (6-tab interactive simulator) |
| [ahy_references.md](ahy_references.md) | 45 references (PubMed links, classified by section) |
