...
Each entry indicates which part of the model it underpins.
Each entry notes which part of the model it supports. 102 references.

---

## 1. Definitions · Epidemiology · Clinical Guidelines
...
## 2. Insulin Dose–Response: the Model's Key Asymmetry
...
## 3. Portal Insulin First-Pass Exposure — Why HHS Is Not Ketoacidosis
...
## 4. Ketogenesis: the CPT-1 Gate and Malonyl-CoA
...
## 5. The BHB/AcAc Ratio and Hepatic Redox State
...
## 6. Acid–Base: the Stewart / Strong-Ion-Difference Approach
...
## 7. Post-Treatment Hyperchloraemic Acidosis
...
## 8. The Kidney: Osmotic Diuresis, the Glucose Threshold, and Ammonia Genesis
...
## 10. Potassium, Phosphate, Magnesium
...
## 13. Euglycaemic Ketoacidosis and SGLT2 Inhibitors
...
## 14. Alcoholic Ketoacidosis and Pregnancy
...
## 15. Subcutaneous Insulin Protocols and the Transition
...
## 16. Counter-Regulatory Hormones and Insulin Resistance
...
## 17. Measurement Artefacts the Model Reproduces
...
- **The quantitative mechanism of cerebral oedema.** The osmotic and ischaemic contributions to cerebral oedema are not separately measurable in patients; the model's split between them (KOSMB/COMPL versus KINJ/KVASO) reproduces the *reported risk factors* and the negative fluid-rate trial, but the partition itself is an inference, not a measurement.
- **Individual variation in ketone-handling capacity.** Ketone oxidation Vmax in acutely ill humans is known only from small tracer studies; the saturable/non-saturable split (VMAX_KOX vs KLIN_KOX) is constrained by steady-state concentrations rather than measured directly.
- **The portal insulin ratio.** PORTF is set from first-pass extraction studies in the fasting state; whether the same ratio holds during a hyperglycaemic crisis with hepatic congestion is unknown, and this parameter carries the whole DKA-versus-HHS distinction.
- **The condition number of bicarbonate.** As documented in the model output, the computed bicarbonate is a small residual of large strong-ion terms and is correspondingly sensitive to renal chloride handling. Its predictions should be treated as less reliable than those for the anion gap and β-hydroxybutyrate.
