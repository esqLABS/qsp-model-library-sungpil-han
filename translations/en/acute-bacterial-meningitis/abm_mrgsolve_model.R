...
##  first independently implemented in dependency-free pure Python RK4 (`abm_reference_python.py`)
##  and actually integrated; every number quoted in README.md is the output of that
##  integration, and `abm_reference_output.txt` is the full log of that run.
##
...
##  abm_reference_python.py; only the ones that changed equation structure are carried over here:
##
