...
This file re-implements the 63 ODEs of abm_mrgsolve_model.R as **dependency-free pure
...
left in abm_reference_output.txt.  The two files' parameters and equations correspond 1:1.
...
def main():
    ...
    W("63 ODEs · 26 scenarios · virtual cohort of 10 × 2 · same equations as abm_mrgsolve_model.R")
    W("=" * 112)
    W("")
    ...
    W("1:1 to the equations and parameters of abm_mrgsolve_model.R.  [F1]-[F32] in the file")
