...
[![CKD QSP Model](../../../chronic-kidney-disease/ckd_qsp_model.png)](../../../chronic-kidney-disease/ckd_qsp_model.svg)
...
| File | Description |
|------|------|
| [ckd_qsp_model.dot](../../../chronic-kidney-disease/ckd_qsp_model.dot) | Graphviz mechanistic map source (approximately 484 nodes / 10 clusters) |
| [ckd_qsp_model.svg](../../../chronic-kidney-disease/ckd_qsp_model.svg) | SVG vector image (scalable) |
| [ckd_qsp_model.png](../../../chronic-kidney-disease/ckd_qsp_model.png) | PNG image (150 dpi) |
| [ckd_mrgsolve_model.R](../../../chronic-kidney-disease/ckd_mrgsolve_model.R) | mrgsolve ODE model (approximately 30 compartments / 5 treatment scenarios) |
| [ckd_shiny_app.R](../../../chronic-kidney-disease/ckd_shiny_app.R) | Shiny dashboard |
| [ckd_references.md](ckd_references.md) | References (approximately 37 articles, PubMed links) |
...
For detailed citations, see [ckd_references.md](ckd_references.md) (approximately 37 articles).
