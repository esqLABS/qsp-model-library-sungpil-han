...
[![DR QSP mechanistic map](../../../diabetic-retinopathy/dr_qsp_model.png)](../../../diabetic-retinopathy/dr_qsp_model.svg)
...
| File | Description |
|------|------|
| [`dr_qsp_model.dot`](../../../diabetic-retinopathy/dr_qsp_model.dot) | Graphviz mechanistic map (source) |
| [`dr_qsp_model.svg`](../../../diabetic-retinopathy/dr_qsp_model.svg) | SVG vector image |
| [`dr_qsp_model.png`](../../../diabetic-retinopathy/dr_qsp_model.png) | PNG image (150 dpi) |
| [`dr_mrgsolve_model.R`](dr_mrgsolve_model.R) | mrgsolve ODE model |
| [`dr_shiny_app.R`](dr_shiny_app.R) | Shiny dashboard |
| [`dr_references.md`](dr_references.md) | 57 references |
...
## References
A total of **57** PubMed citations → [`dr_references.md`](dr_references.md)
