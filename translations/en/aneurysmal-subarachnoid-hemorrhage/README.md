...
[`sah_reference_check.py`](../../../aneurysmal-subarachnoid-hemorrhage/sah_reference_check.py)
...
[`sah_reference_check_output.txt`](../../../aneurysmal-subarachnoid-hemorrhage/sah_reference_check_output.txt).
...
| File | Contents |
|------|------|
| [`sah_qsp_model.dot`](sah_qsp_model.dot) | mechanistic map source (22 clusters · 221 nodes · 339 edge statements) |
| [`sah_qsp_model.svg`](sah_qsp_model.svg) / [`.png`](sah_qsp_model.png) | rendered output (150 dpi) |
| [`sah_mrgsolve_model.R`](sah_mrgsolve_model.R) | mrgsolve QSP model — 39 ODEs (8 PK/exposure + 31 disease/haemodynamics/injury), 15 scenarios, 12 analysis functions |
| [`sah_shiny_app.R`](sah_shiny_app.R) | 8-tab Shiny dashboard (reserve gauge · PK · haemoglobin clock · four consumers · perfusion/oxygen · endpoints · scenarios · monitoring) |
| [`sah_references.md`](sah_references.md) | 89 references, every PMID verified via PubMed E-utilities |
| [`sah_reference_check.py`](../../../aneurysmal-subarachnoid-hemorrhage/sah_reference_check.py) | an independent numpy/RK4 transcription. Produces every number above |
| [`sah_reference_check_output.txt`](../../../aneurysmal-subarachnoid-hemorrhage/sah_reference_check_output.txt) | the full output of the script above (committed verbatim) |
