...
| File | Description |
|------|------|
| [epi_qsp_model.dot](epi_qsp_model.dot) | Graphviz mechanistic map source (136 nodes, 10 clusters) |
| [epi_qsp_model.svg](epi_qsp_model.svg) | SVG vector image (zoomable) |
| [epi_qsp_model.png](epi_qsp_model.png) | PNG raster image (150 dpi) |
| [epi_mrgsolve_model.R](epi_mrgsolve_model.R) | mrgsolve ODE model (16 compartments, 10 scenarios) |
| [epi_shiny_app.R](epi_shiny_app.R) | Shiny dashboard (6-tab interactive app) |
| [epi_references.md](epi_references.md) | 62 references (with PubMed links) |
