...
## Epilepsy Quantitative Systems Pharmacology Interactive App
## Version 1.0 | 2026-06-21
##
## Tabs:
##   1. Patient Profile     — Patient setup & seizure classification
##   2. PK Profiles         — AED plasma concentration-time curves
##   3. PD Biomarkers       — GABA · glutamate · Nav blockade · SV2A
##   4. Clinical Endpoints  — Seizure frequency · response rate · seizure-free rate
##   5. Scenario Comparison — Monotherapy vs combination therapy comparison
##   6. Drug Resistance & Risk — P-gp expression · SUDEP risk · TSC/mTOR
################################################################################
...
ui <- dashboardPage(
  skin = "purple",
  dashboardHeader(title = "Epilepsy QSP Model | Epilepsy Quantitative Systems Pharmacology"),
  dashboardSidebar(
    sidebarMenu(
