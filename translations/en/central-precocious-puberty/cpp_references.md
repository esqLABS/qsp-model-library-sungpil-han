...
This document collects **the grounds for every structural assumption and parameter** that went into `cpp_qsp_model.dot`, `cpp_mrgsolve_model.R`, `cpp_shiny_app.R` and
...
Set out quantitatively in the last section of `README.md`. In summary there are three.
