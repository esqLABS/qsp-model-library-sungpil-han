...
[![MFS QSP Mechanistic Map](../../../marfan-syndrome/mfs_qsp_model.png)](../../../marfan-syndrome/mfs_qsp_model.svg)
...
**File:** `mfs_references.md` — 50 total
...
└── mfs_references.md          ← References (50 total)
```
