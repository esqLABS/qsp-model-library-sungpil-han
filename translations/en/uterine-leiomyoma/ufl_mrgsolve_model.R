...
## Uterine Fibroid Quantitative Systems Pharmacology Model
##
...
p_fib <- ggplot(all_scenarios, aes(x = time_wk, y = Fibroid_vol_cm3, color = Scenario)) +
  ...
  labs(title = "Fibroid Volume Over Time",
...
p_E2 <- ggplot(all_scenarios, aes(x = time_wk, y = E2_pgmL, color = Scenario)) +
  ...
  labs(title = "Serum Estradiol (E2) Dynamics",
...
p_MBL <- ggplot(all_scenarios, aes(x = time_wk, y = MBL_cum, color = Scenario)) +
  ...
  labs(title = "Cumulative Menstrual Blood Loss",
...
p_Hgb <- ggplot(all_scenarios, aes(x = time_wk, y = Hgb_gdL, color = Scenario)) +
  ...
  labs(title = "Hemoglobin Response",
...
p_BMD <- ggplot(all_scenarios, aes(x = time_wk, y = BMD_pct, color = Scenario)) +
  ...
  labs(title = "Bone Mineral Density Change",
...
p_LH <- all_scenarios %>%
  ...
  geom_line(size = 1) +
  labs(title = "LH and FSH Dynamics",
...
cat("Uterine fibroid QSP model run complete\n")
cat("============================================================\n")
