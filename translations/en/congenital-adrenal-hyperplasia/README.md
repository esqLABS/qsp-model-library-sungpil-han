...
[![Model](../../../congenital-adrenal-hyperplasia/cah_qsp_model.png)](../../../congenital-adrenal-hyperplasia/cah_qsp_model.svg)
...
### Mechanistic Map
- **File**: [`cah_qsp_model.dot`](../../../congenital-adrenal-hyperplasia/cah_qsp_model.dot) -> [`cah_qsp_model.svg`](../../../congenital-adrenal-hyperplasia/cah_qsp_model.svg) / [`cah_qsp_model.png`](../../../congenital-adrenal-hyperplasia/cah_qsp_model.png)
...
### mrgsolve ODE Model
- **File**: [`cah_mrgsolve_model.R`](../../../congenital-adrenal-hyperplasia/cah_mrgsolve_model.R)
...
**File**: [`cah_shiny_app.R`](cah_shiny_app.R)
...
54 PubMed citations: [`cah_references.md`](cah_references.md)
