...
[![Hemophilia A QSP Map](../../../hemophilia-a/ha_qsp_model.png)](../../../hemophilia-a/ha_qsp_model.svg)
...
**File:** [`ha_mrgsolve_model.R`](../../../hemophilia-a/ha_mrgsolve_model.R)
...
**File:** [`ha_shiny_app.R`](../../../hemophilia-a/ha_shiny_app.R) | **Tabs: 6**
...
**File:** [`ha_references.md`](../../../hemophilia-a/ha_references.md)
...
|--------|------|------|
| 🗺️ Mechanistic map | [`ha_qsp_model.dot/.svg/.png`](../../../hemophilia-a/ha_qsp_model.svg) | **167 nodes, 10 clusters** (vascular injury · extrinsic pathway · FVIII/intrinsic pathway · common pathway · anticoagulant mechanisms · inhibitor immunology · drug PK/PD · bleeding phenotype · arthropathy · clinical endpoints) |
| ⚙️ mrgsolve ODE | [`ha_mrgsolve_model.R`](../../../hemophilia-a/ha_mrgsolve_model.R) | **16-compartment ODE** (FVIII 2 compartments · emicizumab 3 compartments · fitusiran 2 compartments · AT mRNA/protein · inhibitor · ETP · CumBleeds · joint score · QoL · synovitis · FVIII_eff), **7 treatment scenarios** |
| 📊 Shiny app | [`ha_shiny_app.R`](../../../hemophilia-a/ha_shiny_app.R) | **6 tabs** (patient profile · FVIII PK · PD core metrics · bleed risk · scenario comparison · biomarkers), bslib darkly, plotly, built-in ODE simulator |
| 📚 References | [`ha_references.md`](../../../hemophilia-a/ha_references.md) | **55 PubMed citations** (HAVEN 1/3/4 · ATLAS-INH · A-LONG · HOPE-B · Manco-Johnson 2007, etc.) |
