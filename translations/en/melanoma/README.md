...
> BRAF V600E/K mutation → constitutive MEK-ERK activation → cell proliferation · survival
> → combined targeted therapy (BRAFi/MEKi) + immune checkpoint inhibitors (PD-1/CTLA-4)
...
[![Melanoma QSP Mechanistic Map](../../../melanoma/melanoma_qsp_model.png)](../../../melanoma/melanoma_qsp_model.svg)
...
Full reference list: **[melanoma_references.md](../../../melanoma/melanoma_references.md)** (63 PubMed citations)
