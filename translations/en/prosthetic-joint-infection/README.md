...
| File | Contents |
|------|------|
| [`pji_qsp_model.dot`](pji_qsp_model.dot) / [`.svg`](pji_qsp_model.svg) / [`.png`](pji_qsp_model.png) | Mechanistic map (171 nodes · 18 subgraphs) |
| [`pji_mrgsolve_model.R`](pji_mrgsolve_model.R) | 53-ODE mrgsolve model + 21 scenarios + verification functions |
| [`pji_shiny_app.R`](pji_shiny_app.R) | 13-tab interactive dashboard |
| [`pji_references.md`](pji_references.md) | 68 references (every PMID verified) |
...
[View the full SVG](pji_qsp_model.svg)
