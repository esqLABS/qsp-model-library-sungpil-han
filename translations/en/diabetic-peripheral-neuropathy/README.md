...
| File | Description |
|------|------|
| [`dpn_qsp_model.dot`](../../../diabetic-peripheral-neuropathy/dpn_qsp_model.dot) / [`.svg`](../../../diabetic-peripheral-neuropathy/dpn_qsp_model.svg) / [`.png`](../../../diabetic-peripheral-neuropathy/dpn_qsp_model.png) | Graphviz mechanistic map |
| [`dpn_mrgsolve_model.R`](../../../diabetic-peripheral-neuropathy/dpn_mrgsolve_model.R) | mrgsolve QSP ODE model |
| [`dpn_shiny_app.R`](../../../diabetic-peripheral-neuropathy/dpn_shiny_app.R) | Shiny dashboard (8 tabs) |
| [`dpn_references.md`](../../../diabetic-peripheral-neuropathy/dpn_references.md) | 60 PubMed citations |
