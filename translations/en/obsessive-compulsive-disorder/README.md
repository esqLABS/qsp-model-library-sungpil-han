...
[![OCD QSP Mechanistic Map](../../../obsessive-compulsive-disorder/ocd_qsp_model.png)](../../../obsessive-compulsive-disorder/ocd_qsp_model.svg)
...
| `ocd_references.md` | 50 references (including PubMed links) |
| `README.md` | This file |
...
→ Full set of 50 references: [`ocd_references.md`](ocd_references.md)
