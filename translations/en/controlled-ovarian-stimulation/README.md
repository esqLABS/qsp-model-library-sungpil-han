...
<p align="center">
  ...
  <sub><a href="cos_qsp_model.svg">View full-resolution SVG</a> · 169 nodes · 215 edges · 17 clusters (16 mechanisms + 1 legend)</sub>
</p>
...
[`cos_reference_check.py`](cos_reference_check.py),
and the full output is in
[`cos_reference_output.txt`](../../../controlled-ovarian-stimulation/cos_reference_output.txt).
...
| File | Contents |
|------|------|
| [`cos_qsp_model.dot`](cos_qsp_model.dot) / [`.svg`](cos_qsp_model.svg) / [`.png`](cos_qsp_model.png) | Mechanistic map — 169 nodes · 215 edges · 17 clusters |
| [`cos_mrgsolve_model.R`](cos_mrgsolve_model.R) | **65-ODE** mrgsolve model · 22 scenarios · 4 sweeps |
| [`cos_shiny_app.R`](cos_shiny_app.R) | 11-tab Shiny dashboard |
| [`cos_references.md`](cos_references.md) | **87 references** (every PMID individually verified, 48 used directly for parameter calibration) |
| [`cos_reference_check.py`](cos_reference_check.py) | Independent Python/scipy re-implementation of the same equations (for validation) |
| [`cos_reference_output.txt`](../../../controlled-ovarian-stimulation/cos_reference_output.txt) | Full output of the validation script (the source of every number in this README) |
...
python3 cos_reference_check.py           # full
python3 cos_reference_check.py --brief    # summary table only
