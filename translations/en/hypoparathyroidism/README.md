...
| File | Contents |
|------|------|
| [`hypopt_qsp_model.dot`](hypopt_qsp_model.dot) | Mechanistic map source (202 nodes · 276 edges · 16 clusters) |
| [`hypopt_qsp_model.svg`](hypopt_qsp_model.svg) | Vector rendering (zoomable · searchable) |
| [`hypopt_qsp_model.png`](hypopt_qsp_model.png) | Raster rendering (150 dpi) |
| [`hypopt_mrgsolve_model.R`](hypopt_mrgsolve_model.R) | 36-compartment ODE model + 15 scenarios + dose-titration helper |
| [`hypopt_shiny_app.R`](hypopt_shiny_app.R) | 9-tab interactive dashboard |
| [`hypopt_references.md`](hypopt_references.md) | 96 PubMed links + parameter-literature cross-reference table |
...
table, see [`hypopt_references.md`](hypopt_references.md).
