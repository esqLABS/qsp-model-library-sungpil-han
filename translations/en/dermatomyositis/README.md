...
| File | Description |
|------|------|
| [dm_qsp_model.dot](dm_qsp_model.dot) | Graphviz mechanistic map source (~175 nodes / 13 clusters) |
| [dm_qsp_model.svg](dm_qsp_model.svg) | SVG vector image (scalable) |
| [dm_qsp_model.png](dm_qsp_model.png) | PNG image (150 dpi) |
| [dm_mrgsolve_model.R](dm_mrgsolve_model.R) | mrgsolve ODE model (~24 compartments / 5 treatment scenarios) |
| [dm_shiny_app.R](dm_shiny_app.R) | Shiny dashboard |
| [dm_references.md](dm_references.md) | References (~57, with PubMed links) |
...
For detailed citations, see [dm_references.md](dm_references.md) (~57 references).
