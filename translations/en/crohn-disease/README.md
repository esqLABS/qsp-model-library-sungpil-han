...
[![CD QSP Model](../../../crohn-disease/cd_qsp_model.png)](../../../crohn-disease/cd_qsp_model.svg)
...
| File | Description |
|------|------|
| [cd_qsp_model.dot](../../../crohn-disease/cd_qsp_model.dot) | Graphviz mechanistic map source (approximately 392 nodes / 10 clusters) |
| [cd_qsp_model.svg](../../../crohn-disease/cd_qsp_model.svg) | SVG vector image (scalable) |
| [cd_qsp_model.png](../../../crohn-disease/cd_qsp_model.png) | PNG image (150 dpi) |
| [cd_mrgsolve_model.R](../../../crohn-disease/cd_mrgsolve_model.R) | mrgsolve ODE model (approximately 22 compartments / 8 treatment scenarios) |
| [cd_shiny_app.R](../../../crohn-disease/cd_shiny_app.R) | Shiny dashboard |
| [cd_references.md](../../../crohn-disease/cd_references.md) | References (approximately 61 articles, PubMed links) |
...
For detailed citations, see [cd_references.md](../../../crohn-disease/cd_references.md) (approximately 61 articles).
