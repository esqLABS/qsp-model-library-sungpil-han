...
| Deliverable | File |
|---|---|
| 🗺️ Mechanistic map (230 nodes · 22 clusters) | [`cca_qsp_model.dot`](../../../cholangiocarcinoma/cca_qsp_model.dot) · [SVG](../../../cholangiocarcinoma/cca_qsp_model.svg) · [PNG](../../../cholangiocarcinoma/cca_qsp_model.png) |
| ⚙️ mrgsolve model (54 ODEs) | [`cca_mrgsolve_model.R`](../../../cholangiocarcinoma/cca_mrgsolve_model.R) |
| 🐍 Dependency-free reference twin | [`cca_reference_impl.py`](../../../cholangiocarcinoma/cca_reference_impl.py) |
| 📊 Shiny dashboard (13 tabs) | [`cca_shiny_app.R`](cca_shiny_app.R) |
| 📚 References (87 articles, PMID-verified) | [`cca_references.md`](../../../cholangiocarcinoma/cca_references.md) |
