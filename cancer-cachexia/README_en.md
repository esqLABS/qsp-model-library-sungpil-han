...
<a href="cacs_qsp_model_en.svg"><img src="cacs_qsp_model_en.png" width="100%" alt="CACS QSP mechanistic map"></a>
...
| File | Contents |
|---|---|
| [`cacs_qsp_model_en.dot`](cacs_qsp_model_en.dot) | Mechanistic map source — 19 modules · 247 nodes · 457 edges |
| [`cacs_qsp_model_en.svg`](cacs_qsp_model_en.svg) | Zoomable vector map |
| [`cacs_qsp_model_en.png`](cacs_qsp_model_en.png) | Raster map (150 dpi) |
| [`cacs_mrgsolve_model.R`](cacs_mrgsolve_model.R) | **78 ODEs · 307 annotated parameters · 20 scenarios · 11 diagnostics** |
| [`cacs_shiny_app_en.R`](cacs_shiny_app_en.R) | 10-tab interactive dashboard |
| [`cacs_references_en.md`](cacs_references_en.md) | **125 citations, verified live against PubMed** (19 sections) |
...
dot -Tsvg cacs_qsp_model_en.dot -o cacs_qsp_model_en.svg
dot -Tpng -Gdpi=150 cacs_qsp_model_en.dot -o cacs_qsp_model_en.png

# Run all 20 scenarios + 11 diagnostics (about 2 minutes)
Rscript cacs_mrgsolve_model.R

# Interactive dashboard
R -e 'shiny::runApp("cacs_shiny_app_en.R")'
```
