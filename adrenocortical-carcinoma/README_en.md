...
<p align="center">
  <a href="acc_qsp_model_en.svg">
    <img src="acc_qsp_model_en.png" width="880" alt="ACC QSP mechanistic map">
  </a><br>
...
| File | Contents |
|---|---|
| [`acc_qsp_model_en.dot`](acc_qsp_model_en.dot) · [`.svg`](acc_qsp_model_en.svg) · [`.png`](acc_qsp_model_en.png) | Mechanistic map — **258 nodes · 20 clusters** |
| [`acc_mrgsolve_model_en.R`](acc_mrgsolve_model_en.R) | **52 ODE compartments · 148 parameters · 18 scenarios** + virtual population and closed-form verification |
| [`acc_reference_run.R`](acc_reference_run.R) | The script that regenerates every number above |
| [`acc_reference_output.txt`](acc_reference_output.txt) | The actual run output (the source of the tables above) |
| [`acc_shiny_app_en.R`](acc_shiny_app_en.R) | **11-tab** interactive dashboard |
| [`acc_references_en.md`](acc_references_en.md) | **46 verified PubMed citations** + the complete list of estimated parameters |

### Running it

```bash
# render the map
dot -Tsvg acc_qsp_model_en.dot -o acc_qsp_model_en.svg
dot -Tpng -Gdpi=150 acc_qsp_model_en.dot -o acc_qsp_model_en.png

# regenerate all results (about 3-6 min)
Rscript acc_reference_run.R > acc_reference_output.txt

# dashboard
Rscript -e 'shiny::runApp("acc_shiny_app_en.R")'
```
...
in [`acc_references_en.md` §9](acc_references_en.md).
