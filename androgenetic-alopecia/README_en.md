...
| File | Contents |
|------|------|
| [`aga_qsp_model.dot`](aga_qsp_model.dot) · [SVG](aga_qsp_model.svg) · [PNG](aga_qsp_model.png) | Mechanistic map — 162 nodes / 198 edges / 17 clusters |
| [`aga_mrgsolve_model.R`](aga_mrgsolve_model.R) | mrgsolve ODE model — 50 compartments (drug PK 12 + enzymes 8 + endocrine 4 + signalling 4 + systemic markers 5 + follicle 17), 18 scenarios |
| [`aga_shiny_app.R`](aga_shiny_app.R) | Shiny dashboard — 10 tabs |
| [`aga_references_en.md`](aga_references_en.md) | 73 references (every PMID individually verified via PubMed E-utilities) |
