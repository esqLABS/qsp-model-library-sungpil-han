...
| File | Contents |
|------|------|
| [`mhg_qsp_model_en.dot`](mhg_qsp_model_en.dot) | Mechanistic map source — **224 nodes · 268 edges · 22 clusters** |
| [`mhg_qsp_model_en.svg`](mhg_qsp_model_en.svg) | Vector map (scalable) |
| [`mhg_qsp_model_en.png`](mhg_qsp_model_en.png) | Raster map (150 dpi) |
| [`mhg_mrgsolve_model_en.R`](mhg_mrgsolve_model_en.R) | **49 ODE compartments** · 8 T formulations + 5 non-androgen drugs · 14 scenarios · 11 analysis functions |
| [`mhg_shiny_app_en.R`](mhg_shiny_app_en.R) | 10-tab interactive dashboard |
| [`mhg_references_en.md`](mhg_references_en.md) | **78 references** (PubMed links) + "What the model does not reproduce" appendix |

---

## Mechanistic Map

[![MHG QSP map](mhg_qsp_model_en.png)](mhg_qsp_model_en.svg)
...
```r
source("mhg_mrgsolve_model_en.R")
...
```r
setwd("male-hypogonadism"); shiny::runApp("mhg_shiny_app_en.R")
```
...
[appendix in `mhg_references_en.md`](mhg_references_en.md#appendix-what-this-model-does-not-reproduce)
for the full list.
...
```bash
# render the map
dot -Tsvg mhg_qsp_model_en.dot -o mhg_qsp_model_en.svg
dot -Tpng -Gdpi=150 mhg_qsp_model_en.dot -o mhg_qsp_model_en.png

# run the model
Rscript -e 'source("mhg_mrgsolve_model_en.R"); MHG_run_all()'
```
