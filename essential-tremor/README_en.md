...
<a href="et_qsp_model_en.svg"><img src="et_qsp_model_en.png" width="560" alt="ET QSP map"></a>

| Deliverable | File | Scale |
|---|---|---|
| Mechanistic map | [`et_qsp_model_en.dot`](et_qsp_model_en.dot) · [SVG](et_qsp_model_en.svg) · [PNG](et_qsp_model_en.png) | 201 nodes · 272 edges · 18 clusters |
| mrgsolve ODE model | [`et_mrgsolve_model_en.R`](et_mrgsolve_model_en.R) | 48 ODEs · 25 scenarios |
| Independent verification implementation | [`et_verify.py`](et_verify.py) · [output](et_verify_output.txt) | Pure Python RK4, no dependencies |
| Shiny dashboard | [`et_shiny_app_en.R`](et_shiny_app_en.R) | 10 tabs |
| References | [`et_references_en.md`](et_references_en.md) · [verification script](et_reference_check_en.py) | 126 papers, every PMID verified |
...
```bash
# render the map
dot -Tsvg et_qsp_model_en.dot -o et_qsp_model_en.svg
dot -Tpng -Gdpi=150 et_qsp_model_en.dot -o et_qsp_model_en.png
...
python3 et_reference_check_en.py --verify
python3 et_reference_check_en.py --harvest
python3 et_reference_check_en.py --emit
```

```r
# the mrgsolve model + the 25 scenarios
source("et_mrgsolve_model_en.R")

# Shiny dashboard (10 tabs)
shiny::runApp("et_shiny_app_en.R")
```
