...
| File | Description |
|------|------|
| [op_qsp_model.dot](op_qsp_model.dot) | Graphviz mechanistic map source (approximately 189 nodes / 10 clusters) |
| [op_qsp_model.svg](op_qsp_model.svg) | SVG vector image (scalable) |
| [op_qsp_model.png](op_qsp_model.png) | PNG image (150 dpi) |
| [op_mrgsolve_model.R](op_mrgsolve_model.R) | mrgsolve ODE model (approximately 22 compartments / 6 treatment scenarios) |
| [op_shiny_app_en.R](op_shiny_app_en.R) | Shiny dashboard |
| [op_references.md](op_references.md) | References (approximately 54 articles, PubMed links) |
...
For detailed citations, see [op_references.md](op_references.md) (approximately 54 articles).
