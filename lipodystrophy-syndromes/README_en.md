...
| Deliverable | File |
|---|---|
| Mechanistic map (192 nodes · 290 edges · 22 clusters) | [`lipo_qsp_model.dot`](lipo_qsp_model.dot) · [SVG](lipo_qsp_model.svg) · [PNG](lipo_qsp_model.png) |
| mrgsolve model (53 ODEs · 28 scenarios · 7 falsification tests) | [`lipo_mrgsolve_model.R`](lipo_mrgsolve_model.R) |
| Shiny dashboard (12 tabs) | [`lipo_shiny_app.R`](lipo_shiny_app.R) |
| Validation run output (actual execution log from mrgsolve 2.0.1) | [`lipo_validation_output.txt`](lipo_validation_output.txt) |
| References (121 PMIDs, all fully verified) | [`lipo_references.md`](lipo_references.md) |
...
Full validation log (actually run under mrgsolve 2.0.1): [`lipo_validation_output.txt`](lipo_validation_output.txt)
...
[`lipo_references.md`](lipo_references.md) — **all 121 PMIDs fully
