...
| Deliverable | File |
|---|---|
| 🗺️ Mechanistic map (252 nodes · 22 clusters) | [`ie_qsp_model.dot`](ie_qsp_model.dot) · [SVG](ie_qsp_model.svg) · [PNG](ie_qsp_model.png) |
| ⚙️ mrgsolve ODE model (55 compartments · 208 parameters · 16 scenarios · 16 diagnostic functions) | [`ie_mrgsolve_model.R`](ie_mrgsolve_model.R) |
| 📊 Shiny dashboard (9 tabs) | [`ie_shiny_app.R`](ie_shiny_app.R) |
| 📚 References (149 items) | [`ie_references_en.md`](ie_references_en.md) |
