...
##  Visceral leishmaniasis QSP model (mrgsolve, 73 ODEs)
##
...
##  README_en.md are that integration's output, and `vl_reference_output.txt` is
...
## =============================================================================
##  Reproduce every number quoted in README_en.md
## =============================================================================
