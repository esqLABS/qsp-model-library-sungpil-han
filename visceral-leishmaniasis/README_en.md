...
| File | Contents |
|------|------|
| [`vl_qsp_model_en.dot`](vl_qsp_model_en.dot) | Mechanistic map source — **164 nodes · 18 clusters · 220 edges** |
| [`vl_qsp_model.svg`](vl_qsp_model.svg) | Zoomable vector map |
| [`vl_qsp_model.png`](vl_qsp_model.png) | 150 dpi raster (22087 × 4393 px) |
| [`vl_mrgsolve_model_en.R`](vl_mrgsolve_model_en.R) | 73-ODE mrgsolve model + 20 scenarios + 10 analysis functions |
| [`vl_shiny_app_en.R`](vl_shiny_app_en.R) | 10-tab interactive dashboard |
| [`vl_reference_model.py`](vl_reference_model.py) | Independent Python implementation (for verification, see below) |
| [`vl_reference_output.txt`](vl_reference_output.txt) | Run log of that implementation — the source of every number in this README |
| [`vl_population_results.json`](vl_population_results.json) | Population simulation results for 16 arms (machine-readable) |
| [`vl_references_en.md`](vl_references_en.md) | **223 references** looked up directly in PubMed, in 17 sections |
...
`vl_mrgsolve_model_en.R` and `vl_reference_model.py` are identical term for term,
...
Sys.setenv(VL_RUN_ALL = "1"); source("vl_mrgsolve_model_en.R")

# interactive dashboard (10 tabs)
shiny::runApp("vl_shiny_app_en.R")
```
...
dot -Tsvg vl_qsp_model_en.dot -o vl_qsp_model.svg
dot -Tpng -Gdpi=150 vl_qsp_model_en.dot -o vl_qsp_model.png
```
