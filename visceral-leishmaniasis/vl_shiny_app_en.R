...
##  Visceral Leishmaniasis QSP Model — Interactive Dashboard
##
##  Ten tabs, each built around one thing the model claims:
##    1  Patient Profile    Patient profile — set up the patient, see the disease
##    2  Pharmacokinetics           PK — plasma and INTRAMACROPHAGE concentrations
##    3  The Two Integrals     The two integrals — spleen kill vs free-plasma toxicity
##    4  Parasite Burden      Parasite burden, by organ and by population
##    5  Host Immunity        Host immunity — the priming vs IL-10 race
##    6  Clinical Endpoints      Clinical endpoints — spleen, Hb, platelets, albumin
##    7  Toxicity             Toxicity ledger by organ system
##    8  Scenario Comparison    Scenario comparison across all 20 regimens
##    9  Separatrix           The separatrix — cure threshold vs CD4
##   10  Biomarkers       Biomarkers and the serology trap
##
##  Run with:  shiny::runApp("vl_shiny_app.R")
##  Requires vl_mrgsolve_model_en.R in the same directory.
## =============================================================================
...
## -----------------------------------------------------------------------------
ui <- fluidPage(
  titlePanel(paste("Visceral Leishmaniasis QSP Model —",
