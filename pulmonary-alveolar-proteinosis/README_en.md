...
|---|---|---|
| Mechanistic map | [`pap_qsp_model.dot`](pap_qsp_model.dot) · [SVG](pap_qsp_model.svg) · [PNG](pap_qsp_model.png) | 212 nodes · 25 clusters · 298 edges |
| mrgsolve ODE model | [`pap_mrgsolve_model.R`](pap_mrgsolve_model.R) | 59 ODEs · 36 scenarios · 17 diagnostics |
| Shiny dashboard | [`pap_shiny_app.R`](pap_shiny_app.R) | 10 tabs |
| References | [`pap_references.md`](pap_references.md) | 158 entries (every PMID verified) |
