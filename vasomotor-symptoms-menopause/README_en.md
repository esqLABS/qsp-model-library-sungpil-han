# Vasomotor Symptoms of Menopause (VMS) — QSP Model
...
| Deliverable | File |
|---|---|
| 🗺️ Mechanistic map (DOT) | [`vms_qsp_model_en.dot`](vms_qsp_model_en.dot) |
| 🖼️ Map (SVG)             | [`vms_qsp_model_en.svg`](vms_qsp_model_en.svg) |
| 🖼️ Map (PNG, 150 dpi)    | [`vms_qsp_model_en.png`](vms_qsp_model_en.png) |
| ⚙️ mrgsolve ODE model     | [`vms_mrgsolve_model_en.R`](vms_mrgsolve_model_en.R) |
| 📊 Shiny dashboard        | [`vms_shiny_app.R`](vms_shiny_app.R) |
| 📚 References             | [`vms_references_en.md`](vms_references_en.md) |
...
* **Drug PK (5 drug classes, 17 compartments)** — fezolinetant, elinzanetant,
  ...
  PK anchors in `vms_references_en.md`).
...
dot -Tsvg vms_qsp_model_en.dot -o vms_qsp_model_en.svg
dot -Tpng -Gdpi=150 vms_qsp_model_en.dot -o vms_qsp_model_en.png
```
...
install.packages(c("mrgsolve","dplyr","tidyr","ggplot2","shiny",
                   "shinydashboard","DT"))
library(mrgsolve)
mod <- mread_cache("vms_mrgsolve_model_en.R")
